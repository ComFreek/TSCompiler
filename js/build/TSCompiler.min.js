...
1;e.RequiredPropertyIsMissing=2;e.IncompatibleSignatures=4;e.SourceSignatureHasTooManyParameters=3;e.IncompatibleReturnTypes=16;e.IncompatiblePropertyTypes=32;e.IncompatibleParameterTypes=64;e=a.CodeGenTarget||(a.CodeGenTarget={});e._map=[];e.ES3=0;e.ES5=1;var e=a.CodeGenTarget,h=a.ModuleGenTarget||(a.ModuleGenTarget={});h._map=[];h.Synchronous=0;h.Asynchronous=1;h.Local=2;h=a.ModuleGenTarget;a.codeGenTarget=e.ES3;a.moduleGenTarget=h.Synchronous;a.optimizeModuleCodeGen=!0;a.flagsToString=function(a,
j){for(var g="",d=1;-2147483648>d;d<<=1)if(0!=(j&d))for(var l in a)if(a[l]==d){0<g.length&&(g+="|");g+=l;break}return g}})(TypeScript||(TypeScript={}));
...
(function(a){var e;e=function(){this.constructor=this.isPrototypeOf=this.propertyIsEnumerable=this.hasOwnProperty=this.valueOf=this.toLocaleString=this.toString=this.prototype=void 0};a.BlockIntrinsics=e;var h=function(){this.itemCount=0;this.table=new e};h.prototype.getAllKeys=function(){var a=[],b;for(b in this.table)void 0!=this.table[b]&&(a[a.length]=b);return a};h.prototype.add=function(a,b){if(void 0!=this.table[a])return!1;this.table[a]=b;this.itemCount++;return!0};h.prototype.addOrUpdate=
function(a,b){if(void 0!=this.table[a])return this.table[a]=b,!1;this.table[a]=b;this.itemCount++;return!0};h.prototype.map=function(a,b){for(var d in this.table)void 0!=this.table[d]&&a(d,this.table[d],b)};h.prototype.every=function(a,b){for(var d in this.table)if(void 0!=this.table[d]&&!a(d,this.table[d],b))return!1;return!0};h.prototype.some=function(a,b){for(var d in this.table)if(void 0!=this.table[d]&&a(d,this.table[d],b))return!0;return!1};h.prototype.count=function(){return this.itemCount};
...
h;a.numberHashFn=function(a){a=a^61^a>>>16;a+=a<<3;a=668265261*(a^a>>>4);return a^=a>>>15};a.combineHashes=function(a,b){return b^(a>>5)+a};var b;b=function(a,b){this.key=a;this.data=b};a.HashEntry=b;h=function(a,b,d){this.size=a;this.hashFn=b;this.equalsFn=d;this.itemCount=0;this.table=[];for(a=0;a<this.size;a++)this.table[a]=null};h.prototype.add=function(a,g){var d,l=new b(a,g),c=this.hashFn(a),c=c%this.size;for(d=this.table[c];null!=d;d=d.next)if(this.equalsFn(a,d.key))return!1;l.next=this.table[c];
this.table[c]=l;this.itemCount++;return!0};h.prototype.remove=function(a){var b,d=this.hashFn(a),d=d%this.size,l=null,c=null;for(b=this.table[d];null!=b;b=b.next){if(this.equalsFn(a,b.key)){l=b.data;this.itemCount--;c?c.next=b.next:this.table[d]=b.next;break}c=b}return l};h.prototype.count=function(){return this.itemCount};h.prototype.lookup=function(a){var b;b=this.hashFn(a);b%=this.size;for(b=this.table[b];null!=b;b=b.next)if(this.equalsFn(a,b.key))return b.data;return null};a.HashTable=h})(TypeScript||
(TypeScript={}));var __extends=this.__extends||function(a,e){function h(){this.constructor=a}h.prototype=e.prototype;a.prototype=new h};
...
break;case a.NodeType.Comma:c.emitJavascript(this.operand1,a.TokenID.Comma,!1);c.emitState.inObjectLiteral?c.writeLineToOutput(", "):c.writeToOutput(",");c.emitJavascript(this.operand2,a.TokenID.Comma,!1);break;case a.NodeType.Is:throw Error("should be de-sugared during type check");default:throw Error("please implement in derived class");}c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};a.BinaryExpression=h;h=function(a,c,d,f){e.call(this,a);this.operand1=c;this.operand2=d;
this.operand3=f;this.nty=a};__extends(h,e);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.typeCheck=function(a){return a.typeCheckQMark(this)};h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);c.emitJavascript(this.operand1,a.TokenID.QMark,!1);c.writeToOutput(" ? ");c.emitJavascript(this.operand2,a.TokenID.QMark,!1);c.writeToOutput(" : ");c.emitJavascript(this.operand3,a.TokenID.QMark,!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,
!1)};a.TrinaryExpression=h;h=function(c){e.call(this,a.NodeType.NumberLit);this.value=c;this.isNegativeZero=!1};__extends(h,e);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.typeCheck=function(a){this.type=a.doubleType;return this};h.prototype.treeViewLabel=function(){return"num: "+this.value};h.prototype.emit=function(a){a.emitParensAndCommentsInPlace(this,!0);a.recordSourceMappingStart(this);this.isNegativeZero&&a.writeToOutput("-");a.writeToOutput(this.value.toString());a.recordSourceMappingEnd(this);
a.emitParensAndCommentsInPlace(this,!1)};h.prototype.printLabel=function(){return Math.floor(this.value)!=this.value?this.value.toFixed(2).toString():this.value.toString()};a.NumberLiteral=h;h=function(c){e.call(this,a.NodeType.Regex);this.regex=c};__extends(h,e);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.typeCheck=function(a){this.type=a.regexType;return this};h.prototype.emit=function(a){a.emitParensAndCommentsInPlace(this,!0);a.recordSourceMappingStart(this);a.writeToOutput(this.regex.toString());
a.recordSourceMappingEnd(this);a.emitParensAndCommentsInPlace(this,!1)};a.RegexLiteral=h;h=function(c){e.call(this,a.NodeType.QString);this.text=c};__extends(h,e);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.emit=function(a){a.emitParensAndCommentsInPlace(this,!0);a.recordSourceMappingStart(this);a.emitStringLiteral(this.text);a.recordSourceMappingEnd(this);a.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){this.type=a.stringType;return this};h.prototype.treeViewLabel=
function(){return"st: "+this.text};h.prototype.printLabel=function(){return this.text};a.StringLiteral=h;h=function(c,d){e.call(this,a.NodeType.Import);this.id=c;this.alias=d;this.varFlags=a.VarFlags.None;this.isDynamicImport=!1};__extends(h,e);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.emit=function(c,d,f,i){i&&c.emitImportDecl(this);if(!this.isDynamicImport||this.id.sym&&!this.id.sym.onlyReferencedAsTypeRef)d=c.modAliasId,f=c.firstModAlias,c.recordSourceMappingStart(this),
c.emitParensAndCommentsInPlace(this,!0),c.writeToOutput("var "+this.id.text+" = "),c.modAliasId=this.id.text,c.firstModAlias=this.firstAliasedModToString(),c.emitJavascript(this.alias,a.TokenID.Tilde,!1,i),this.isDynamicImport||c.writeToOutput(";"),c.emitParensAndCommentsInPlace(this,!1),c.recordSourceMappingEnd(this),c.modAliasId=d,c.firstModAlias=f};h.prototype.typeCheck=function(a){return a.typeCheckImportDecl(this)};h.prototype.getAliasName=function(c){"undefined"===typeof c&&(c=this.alias);return c.nodeType==
a.NodeType.Name?c.text:this.getAliasName(c.operand1)+"."+this.getAliasName(c.operand2)};h.prototype.firstAliasedModToString=function(){return this.alias.nodeType==a.NodeType.Name?this.alias.text:this.alias.operand1.text};a.ImportDecl=h;var g=function(c,d,f){e.call(this,d);this.id=c;this.nestingLevel=f;this.typeExpr=this.init=null;this.varFlags=a.VarFlags.None;this.sym=null};__extends(g,e);g.prototype.isStatementOrExpression=function(){return!0};g.prototype.isPrivate=function(){return a.hasFlag(this.varFlags,
a.VarFlags.Private)};g.prototype.isPublic=function(){return a.hasFlag(this.varFlags,a.VarFlags.Public)};g.prototype.isProperty=function(){return a.hasFlag(this.varFlags,a.VarFlags.Property)};g.prototype.typeCheck=function(a){return a.typeCheckBoundDecl(this)};g.prototype.printLabel=function(){return this.treeViewLabel()};a.BoundDecl=g;h=function(c,d){g.call(this,c,a.NodeType.VarDecl,d)};__extends(h,g);h.prototype.isAmbient=function(){return a.hasFlag(this.varFlags,a.VarFlags.Ambient)};h.prototype.isExported=
function(){return a.hasFlag(this.varFlags,a.VarFlags.Exported)};h.prototype.isStatic=function(){return a.hasFlag(this.varFlags,a.VarFlags.Static)};h.prototype.emit=function(a,c,d,f){a.emitJavascriptVarDecl(this,c,f)};h.prototype.treeViewLabel=function(){return"var "+this.id.text};a.VarDecl=h;h=function(c){g.call(this,c,a.NodeType.ArgDecl,0);this.isOptional=!1;this.parameterPropertySym=null};__extends(h,g);h.prototype.isOptionalArg=function(){return this.isOptional||this.init};h.prototype.treeViewLabel=
function(){return"arg: "+this.id.text};h.prototype.emit=function(a,c,d,f){a.emitParensAndCommentsInPlace(this,!0);a.recordSourceMappingStart(this);a.writeToOutput(this.id.text);f&&a.emitArgDecl(this);a.recordSourceMappingEnd(this);a.emitParensAndCommentsInPlace(this,!1)};a.ArgDecl=h;var d=0,l=function(c,d,f,i,l,b,j,g){e.call(this,g);this.name=c;this.bod=d;this.isConstructor=f;this.args=i;this.vars=l;this.scopes=b;this.statics=j;this.hint=null;this.fncFlags=a.FncFlags.None;this.returnTypeAnnotation=
...
l.prototype.emit=function(a,c,d,f){a.emitJavascriptFunction(this,f)};l.prototype.getNameText=function(){return this.name?this.name.text:this.hint};l.prototype.isMethod=function(){return(this.fncFlags&a.FncFlags.Method)!=a.FncFlags.None};l.prototype.isCallMember=function(){return a.hasFlag(this.fncFlags,a.FncFlags.CallMember)};l.prototype.isConstructMember=function(){return a.hasFlag(this.fncFlags,a.FncFlags.ConstructMember)};l.prototype.isIndexerMember=function(){return a.hasFlag(this.fncFlags,a.FncFlags.IndexerMember)};
...
function(){this.fncFlags=a.FncFlags.None};l.prototype.isSignature=function(){return(this.fncFlags&a.FncFlags.Signature)!=a.FncFlags.None};l.prototype.hasStaticDeclarations=function(){return!this.isConstructor&&(0<this.statics.members.length||0<this.innerStaticFuncs.length)};a.FuncDecl=l;h=function(a,c,d){this.filename=a;this.lineMap=c;this.unitIndex=d};a.LocationInfo=h;a.unknownLocationInfo=new h("unknown",null,-1);h=function(c,d){l.call(this,new j("script"),null,!1,null,c,d,null,a.NodeType.Script);
this.locationInfo=null;this.hasBeenTypeChecked=this.isDeclareFile=this.isResident=this.requiresInherits=this.requiresGlobal=!1;this.topLevelMod=null;this.rightCurlyCount=this.leftCurlyCount=0;this.vars=c;this.scopes=d};__extends(h,l);h.prototype.typeCheck=function(a){return a.typeCheckScript(this)};h.prototype.treeViewLabel=function(){return"Script"};h.prototype.emitRequired=function(){if(!this.isDeclareFile&&!this.isResident&&this.bod)for(var c=0,d=this.bod.members.length;c<d;c++){var f=this.bod.members[c];
if(f.nodeType==a.NodeType.Module){if(!a.hasFlag(f.modFlags,a.ModuleFlags.ShouldEmitModuleDecl|a.ModuleFlags.Ambient))return!0}else if(f.nodeType==a.NodeType.Class){if(!a.hasFlag(f.varFlags,a.VarFlags.Ambient))return!0}else if(f.nodeType==a.NodeType.VarDecl){if(!a.hasFlag(f.varFlags,a.VarFlags.Ambient))return!0}else if(f.nodeType==a.NodeType.FuncDecl){if(!f.isSignature())return!0}else if(f.nodeType!=a.NodeType.Interface&&f.nodeType!=a.NodeType.Empty)return!0}return!1};h.prototype.emit=function(c,d,
f,i){this.emitRequired()&&(c.emitParensAndCommentsInPlace(this,!0),c.recordSourceMappingStart(this),c.emitPrologue(this.requiresInherits),d=i?c.setDeclContainingAST(this):null,c.emitJavascriptList(this.bod,null,a.TokenID.SColon,!0,!1,!1,i),i&&c.setDeclContainingAST(d),c.recordSourceMappingEnd(this),c.emitParensAndCommentsInPlace(this,!1))};a.Script=h;var c=function(a,c,d){e.call(this,a);this.name=c;this.members=d;this.nty=a};__extends(c,e);a.Record=c;h=function(k,d,f,i){c.call(this,a.NodeType.Module,
k,d);this.modFlags=a.ModuleFlags.ShouldEmitModuleDecl;this.alias=null;this.rightCurlyCount=this.leftCurlyCount=0;this.amdDependencies=[];this.members=d;this.vars=f;this.name=k;this.scopes=i;this.prettyName=this.name.text};__extends(h,c);h.prototype.isExported=function(){return a.hasFlag(this.modFlags,a.ModuleFlags.Exported)};h.prototype.isAmbient=function(){return a.hasFlag(this.modFlags,a.ModuleFlags.Ambient)};h.prototype.isEnum=function(){return a.hasFlag(this.modFlags,a.ModuleFlags.IsEnum)};h.prototype.recordNonInterface=
function(){this.modFlags&=~a.ModuleFlags.ShouldEmitModuleDecl};h.prototype.typeCheck=function(a){return a.typeCheckModule(this)};h.prototype.emit=function(c,d,f,i){a.hasFlag(this.modFlags,a.ModuleFlags.ShouldEmitModuleDecl)?i&&c.emitModuleSignature(this):(c.emitParensAndCommentsInPlace(this,!0),c.emitJavascriptModule(this,i),c.emitParensAndCommentsInPlace(this,!1))};a.ModuleDecl=h;var i=function(a,d,f,i,l){c.call(this,a,d,l);this.extendsList=f;this.implementsList=i;this.name=d;this.members=l};__extends(i,
c);a.NamedType=i;h=function(c,d,f,l){i.call(this,a.NodeType.Class,c,f,l,d);this.varFlags=a.VarFlags.None;this.rightCurlyCount=this.leftCurlyCount=0;this.knownMemberNames={};this.constructorDecl=null;this.constructorNestingLevel=0;this.allMemberDefinitions=new b;this.name=c;this.baseClass=f;this.implementsList=l;this.definitionMembers=d};__extends(h,i);h.prototype.isExported=function(){return a.hasFlag(this.varFlags,a.VarFlags.Exported)};h.prototype.isAmbient=function(){return a.hasFlag(this.varFlags,
a.VarFlags.Ambient)};h.prototype.typeCheck=function(a){return a.typeCheckClass(this)};h.prototype.emit=function(a,c,d,f){a.emitJavascriptClass(this,f)};a.ClassDecl=h;h=function(c,d,f,l,b,j){i.call(this,c,d,b,j,f);this.args=l;this.varFlags=a.VarFlags.None;this.isOverload=!1;this.rightCurlyCount=this.leftCurlyCount=0;this.nty=c;this.name=d;this.extendsList=b;this.implementsList=j;this.members=f};__extends(h,i);h.prototype.isExported=function(){return a.hasFlag(this.varFlags,a.VarFlags.Exported)};h.prototype.isAmbient=
function(){return a.hasFlag(this.varFlags,a.VarFlags.Ambient)};h.prototype.typeCheck=function(c){if(this.nty==a.NodeType.Interface)return c.typeCheckInterface(this);throw Error("please implement type check for node type"+this.nty);};h.prototype.emit=function(c,d,f,i){if(this.nty==a.NodeType.Interface)i&&c.emitInterfaceDeclaration(this);else throw Error("please implement emit for node type"+this.nty);};a.TypeDecl=h;var f=function(c){e.call(this,c);this.flags|=a.ASTFlags.IsStatement};__extends(f,e);
f.prototype.isLoop=function(){return!1};f.prototype.isCompoundStatement=function(){return this.isLoop()};f.prototype.typeCheck=function(a){this.type=a.voidType;return this};a.Statement=f;h=function(c,d){f.call(this,a.NodeType.LabeledStatement);this.labels=c;this.stmt=d};__extends(h,f);h.prototype.emit=function(a,c,d,f){a.emitParensAndCommentsInPlace(this,!0);a.recordSourceMappingStart(this);if(this.labels)for(var i=this.labels.members.length,l=0;l<i;l++)this.labels.members[l].emit(a,c,d,f);this.stmt.emit(a,
c,!0,f);a.recordSourceMappingEnd(this);a.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){a.typeCheck(this.labels);this.stmt=this.stmt.typeCheck(a);return this};h.prototype.addToControlFlow=function(c){var d=c.current,f=new a.BasicBlock;c.current=f;d.addSuccessor(f)};a.LabeledStatement=h;h=function(c,d){f.call(this,a.NodeType.Block);this.stmts=c;this.visible=d};__extends(h,f);h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);
this.visible&&(c.writeLineToOutput(" {"),c.increaseIndent());var d=c.setInObjectLiteral(!1);this.stmts&&c.emitJavascriptList(this.stmts,null,a.TokenID.SColon,!0,!1,!1);this.visible&&(c.decreaseIndent(),c.emitIndent(),c.writeToOutput("}"));c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.addToControlFlow=function(c){var d=new a.BasicBlock;c.pushStatement(this,c.current,d);this.stmts&&c.walk(this.stmts,this);c.walker.options.goChildren=!1;c.popStatement();
0<d.predecessors.length&&(c.current.addSuccessor(d),c.current=d)};h.prototype.typeCheck=function(a){a.checker.styleSettings.emptyBlocks||(null===this.stmts||0==this.stmts.members.length)&&a.checker.errorReporter.styleError(this,"empty block");a.typeCheck(this.stmts);return this};a.Block=h;h=function(a){f.call(this,a);this.resolvedTarget=this.target=null;this.nty=a};__extends(h,f);h.prototype.hasExplicitTarget=function(){return this.target};h.prototype.setResolvedTarget=function(c,d){if(d.isLoop())return this.resolvedTarget=
...
!0);c.recordSourceMappingStart(this);var d=c.setInObjectLiteral(!1);c.writeToOutput("while(");c.emitJavascript(this.cond,a.TokenID.WHILE,!1);c.writeToOutput(")");c.emitJavascriptStatements(this.body,!1,!1);c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){return a.typeCheckWhile(this)};h.prototype.addToControlFlow=function(c){var d=c.current,f=new a.BasicBlock,i=new a.BasicBlock;d.addSuccessor(f);c.current=f;c.addContent(this.cond);
d=c.current;this.body&&(c.current=new a.BasicBlock,d.addSuccessor(c.current),c.pushStatement(this,f,i),c.walk(this.body,this),c.popStatement());c.noContinuation||c.current.addSuccessor(f);c.current=i;d.addSuccessor(i);c.noContinuation=!1;c.walker.options.goChildren=!1};a.WhileStatement=h;h=function(){f.call(this,a.NodeType.DoWhile);this.cond=this.whileAST=this.body=null};__extends(h,f);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.isLoop=function(){return!0};h.prototype.emit=
function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);var d=c.setInObjectLiteral(!1);c.writeToOutput("do");c.emitJavascriptStatements(this.body,!0,!1);c.recordSourceMappingStart(this.whileAST);c.writeToOutput("while");c.recordSourceMappingEnd(this.whileAST);c.writeToOutput("(");c.emitJavascript(this.cond,a.TokenID.RParen,!1);c.writeToOutput(")");c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){return a.typeCheckDoWhile(this)};
h.prototype.addToControlFlow=function(c){var d=c.current,f=new a.BasicBlock,i=new a.BasicBlock;d.addSuccessor(f);c.current=f;this.body&&(c.pushStatement(this,f,i),c.walk(this.body,this),c.popStatement());c.noContinuation?c.addUnreachable(this.cond):(d=c.current,d.addSuccessor(f),c.addContent(this.cond),c.current=i,d.addSuccessor(i));c.walker.options.goChildren=!1};a.DoWhileStatement=h;h=function(c){f.call(this,a.NodeType.If);this.cond=c;this.elseBod=null};__extends(h,f);h.prototype.isStatementOrExpression=
function(){return!0};h.prototype.isCompoundStatement=function(){return!0};h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);var d=c.setInObjectLiteral(!1);c.writeToOutput("if(");c.emitJavascript(this.cond,a.TokenID.IF,!1);c.writeToOutput(")");c.emitJavascriptStatements(this.thenBod,!0,!1);this.elseBod&&(c.writeToOutput(" else"),c.emitJavascriptStatements(this.elseBod,!0,!0));c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,
!1)};h.prototype.typeCheck=function(a){return a.typeCheckIf(this)};h.prototype.addToControlFlow=function(c){this.cond.addToControlFlow(c);var d=new a.BasicBlock,f=c.current;c.pushStatement(this,f,d);var i=!1;c.current=new a.BasicBlock;f.addSuccessor(c.current);c.walk(this.thenBod,this);c.noContinuation||(i=!0,c.current.addSuccessor(d));this.elseBod?(c.current=new a.BasicBlock,c.noContinuation=!1,f.addSuccessor(c.current),c.walk(this.elseBod,this),c.noContinuation?i&&(c.noContinuation=!1):(i=!0,c.current.addSuccessor(d))):
(f.addSuccessor(d),c.noContinuation=!1,i=!0);c.popStatement();0<d.predecessors.length&&(c.noContinuation=!1,i=!0);i&&(c.current=d);c.walker.options.goChildren=!1};a.IfStatement=h;h=function(){f.call(this,a.NodeType.Return);this.returnExpression=null};__extends(h,f);h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);var d=c.setInObjectLiteral(!1);this.returnExpression?(c.writeToOutput("return "),c.emitJavascript(this.returnExpression,a.TokenID.SColon,
!1)):c.writeToOutput("return;");c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.addToControlFlow=function(a){f.prototype.addToControlFlow.call(this,a);a.returnStmt()};h.prototype.typeCheck=function(a){return a.typeCheckReturn(this)};a.ReturnStatement=h;h=function(){e.call(this,a.NodeType.EndCode)};__extends(h,e);a.EndCode=h;h=function(c,d){f.call(this,a.NodeType.ForIn);this.lval=c;this.obj=d;this.lval&&this.lval.nodeType==a.NodeType.VarDecl&&
...
this.val=c;this.defaultCase=null};__extends(h,f);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.isCompoundStatement=function(){return!0};h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);var d=c.setInObjectLiteral(!1);c.writeToOutput("switch(");c.emitJavascript(this.val,a.TokenID.ID,!1);c.writeLineToOutput(") {");c.increaseIndent();for(var f=this.caseList.members.length,i=0;i<f;i++)c.emitJavascript(this.caseList.members[i],
a.TokenID.CASE,!0),c.writeLineToOutput("");c.decreaseIndent();c.emitIndent();c.writeToOutput("}");c.setInObjectLiteral(d);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){var c=this.caseList.members.length;this.val=a.typeCheck(this.val);for(var d=0;d<c;d++)this.caseList.members[d]=a.typeCheck(this.caseList.members[d]);this.defaultCase=a.typeCheck(this.defaultCase);this.type=a.voidType;return this};h.prototype.addToControlFlow=function(c){var d=
c.current;c.addContent(this.val);var f=new a.BasicBlock,i=new a.BasicBlock;d.addSuccessor(f);c.pushSwitch(f);c.current=f;c.pushStatement(this,f,i);c.walk(this.caseList,this);c.popSwitch();c.popStatement();null==this.defaultCase&&d.addSuccessor(i);0<i.predecessors.length?(c.noContinuation=!1,c.current=i):c.noContinuation=!0;c.walker.options.goChildren=!1};a.SwitchStatement=h;h=function(){f.call(this,a.NodeType.Case);this.expr=null};__extends(h,f);h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,
!0);c.recordSourceMappingStart(this);this.expr?(c.writeToOutput("case "),c.emitJavascript(this.expr,a.TokenID.ID,!1)):c.writeToOutput("default");c.writeToOutput(":");c.emitJavascriptStatements(this.body,!1,!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){this.expr=a.typeCheck(this.expr);a.typeCheck(this.body);this.type=a.voidType;return this};h.prototype.addToControlFlow=function(c){var d=new a.BasicBlock,f=c.currentSwitch[c.currentSwitch.length-
1];if(this.expr){var i=new a.BasicBlock;c.current=i;f.addSuccessor(i);c.addContent(this.expr);i.addSuccessor(d)}else f.addSuccessor(d);c.current=d;this.body&&c.walk(this.body,this);c.noContinuation=!1;c.walker.options.goChildren=!1};a.CaseStatement=h;h=function(c,d){e.call(this,a.NodeType.TypeRef);this.term=c;this.arrayCount=d};__extends(h,e);h.prototype.emit=function(){throw Error("should not emit a type ref");};h.prototype.typeCheck=function(c){var d=c.inTypeRefTypeCheck;c.inTypeRefTypeCheck=!0;
var f=a.getTypeLink(this,c.checker,!0);c.checker.resolveTypeLink(c.scope,f,!1);c.checkForVoidConstructor(f.type,this);this.type=f.type;this.term&&(this.term.type=this.type);c.inTypeRefTypeCheck=d;return this};a.TypeReference=h;h=function(c,d){f.call(this,a.NodeType.TryFinally);this.tryNode=c;this.finallyNode=d};__extends(h,f);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.isCompoundStatement=function(){return!0};h.prototype.emit=function(c){c.recordSourceMappingStart(this);c.emitJavascript(this.tryNode,
a.TokenID.TRY,!1);c.emitJavascript(this.finallyNode,a.TokenID.FINALLY,!1);c.recordSourceMappingEnd(this)};h.prototype.typeCheck=function(a){this.tryNode=a.typeCheck(this.tryNode);this.finallyNode=a.typeCheck(this.finallyNode);this.type=a.voidType;return this};h.prototype.addToControlFlow=function(c){var d=new a.BasicBlock;c.walk(this.tryNode,this);var f=new a.BasicBlock;c.current&&c.current.addSuccessor(f);c.current=f;c.pushStatement(this,null,d);c.walk(this.finallyNode,this);!c.noContinuation&&c.current&&
c.current.addSuccessor(d);0<d.predecessors.length?c.current=d:c.noContinuation=!0;c.popStatement();c.walker.options.goChildren=!1};a.TryFinally=h;h=function(c,d){f.call(this,a.NodeType.TryCatch);this.tryNode=c;this.catchNode=d};__extends(h,f);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.isCompoundStatement=function(){return!0};h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);c.emitJavascript(this.tryNode,a.TokenID.TRY,!1);
c.emitJavascript(this.catchNode,a.TokenID.CATCH,!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.addToControlFlow=function(c){var d=c.current,f=new a.BasicBlock;d.addSuccessor(f);c.current=f;f=new a.BasicBlock;c.pushStatement(this,null,f);c.walk(this.tryNode,this);c.noContinuation||c.current&&c.current.addSuccessor(f);c.current=new a.BasicBlock;d.addSuccessor(c.current);c.walk(this.catchNode,this);c.popStatement();c.noContinuation||c.current&&c.current.addSuccessor(f);
c.current=f;c.walker.options.goChildren=!1};h.prototype.typeCheck=function(a){this.tryNode=a.typeCheck(this.tryNode);this.catchNode=a.typeCheck(this.catchNode);this.type=a.voidType;return this};a.TryCatch=h;h=function(c){f.call(this,a.NodeType.Try);this.body=c};__extends(h,f);h.prototype.isStatementOrExpression=function(){return!0};h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);c.writeToOutput("try ");c.emitJavascript(this.body,a.TokenID.TRY,
!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.typeCheck=function(a){this.body=a.typeCheck(this.body);return this};h.prototype.addToControlFlow=function(a){this.body&&a.walk(this.body,this);a.walker.options.goChildren=!1;a.noContinuation=!1};a.Try=h;h=function(c,d){f.call(this,a.NodeType.Catch);this.param=c;this.body=d;this.containedScope=null;this.param&&(this.param.varFlags|=a.VarFlags.AutoInit)};__extends(h,f);h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,
!0);c.recordSourceMappingStart(this);c.writeToOutput(" catch (");c.emitJavascript(this.param,a.TokenID.LParen,!1);c.writeToOutput(")");c.emitJavascript(this.body,a.TokenID.CATCH,!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.addToControlFlow=function(c){if(this.param){c.addContent(this.param);var d=new a.BasicBlock;c.current.addSuccessor(d);c.current=d}this.body&&c.walk(this.body,this);c.noContinuation=!1;c.walker.options.goChildren=!1};h.prototype.typeCheck=
function(c){var d=c.scope;c.scope=this.containedScope;this.param=c.typeCheck(this.param);var f=new a.ValueLocation,i=new a.VariableSymbol(this.param.id.text,this.param.minChar,c.checker.locationInfo.unitIndex,f);f.symbol=i;f.typeLink=new a.TypeLink;f.typeLink.type=c.anyType;i=c.thisFnc;f.symbol.container=i&&i.type?i.type.symbol:null;this.param.sym=f.symbol;c.scope.enter(f.symbol.container,this.param,f.symbol,c.checker.errorReporter,!1,!1,!1);this.body=c.typeCheck(this.body);c.checker.inProvisionalTypecheckMode()&&
(c.scope.getTable().secondaryTable.table[f.symbol.name]=void 0);this.type=c.voidType;c.scope=d;return this};a.Catch=h;h=function(c){f.call(this,a.NodeType.Finally);this.body=c};__extends(h,f);h.prototype.emit=function(c){c.emitParensAndCommentsInPlace(this,!0);c.recordSourceMappingStart(this);c.writeToOutput("finally");c.emitJavascript(this.body,a.TokenID.FINALLY,!1);c.recordSourceMappingEnd(this);c.emitParensAndCommentsInPlace(this,!1)};h.prototype.addToControlFlow=function(a){this.body&&a.walk(this.body,
this);a.walker.options.goChildren=!1;a.noContinuation=!1};h.prototype.typeCheck=function(a){this.body=a.typeCheck(this.body);return this};a.Finally=h;h=function(c,d,f){e.call(this,a.NodeType.Comment);this.content=c;this.isBlockComment=d;this.endsLine=f;this.text=null};__extends(h,e);h.prototype.getText=function(){if(null==this.text)if(this.isBlockComment){this.text=this.content.split("\n");for(var a=0;a<this.text.length;a++)this.text[a]=this.text[a].replace(/^\s+|\s+$/g,"")}else this.text=[this.content.replace(/^\s+|\s+$/g,
...
(function(a){var e=function(){this.goNextSibling=this.goChildren=!0;this.reverseSiblings=!1};e.prototype.stopWalk=function(a){"undefined"===typeof a&&(a=!0);this.goChildren=!a;this.goNextSibling=!a};a.AstWalkOptions=e;var h=function(a,d,f,l,b){this.childrenWalkers=a;this.pre=d;this.post=f;this.options=l;this.state=b};h.prototype.walk=function(a,d){var f=this.pre(a,d,this);void 0===f&&(f=a);if(this.options.goChildren){var l=this.options.goNextSibling;this.options.goNextSibling=!0;this.childrenWalkers[a.nodeType](a,
d,this);this.options.goNextSibling=l}else this.options.goChildren=!0;return this.post?(l=this.post(f,d,this),void 0===l&&(l=f),l):f};var b=function(){this.childrenWalkers=[];this.initChildrenWalkers()};b.prototype.walk=function(a,d,f,l,b){return this.getWalker(d,f,l,b).walk(a,null)};b.prototype.getWalker=function(a,d,f,l){return this.getSlowWalker(a,d,f,l)};b.prototype.getSlowWalker=function(a,d,f,l){f||(f=new e);return new h(this.childrenWalkers,a,d,f,l)};b.prototype.initChildrenWalkers=function(){this.childrenWalkers[a.NodeType.None]=
...
g.walkNone;this.childrenWalkers[a.NodeType.Comment]=g.walkNone;this.childrenWalkers[a.NodeType.Debugger]=g.walkNone;for(var c in a.NodeType._map)if(void 0===this.childrenWalkers[c])throw Error("initWalkers function is not up to date with enum content!");};a.AstWalkerFactory=b;var j;a.getAstWalkerFactory=function(){j||(j=new b);return j};var g,d=g||(g={}),l=function(a,d,f){a.name=f.walk(a.name,a);f.options.goNextSibling&&a.members&&(a.members=f.walk(a.members,a))};d.walkNone=function(){};d.walkListChildren=
function(a,d,f){d=a.members.length;if(f.options.reverseSiblings)for(var l=d-1;0<=l;l--)f.options.goNextSibling&&(a.members[l]=f.walk(a.members[l],a));else for(l=0;l<d;l++)f.options.goNextSibling&&(a.members[l]=f.walk(a.members[l],a))};d.walkUnaryExpressionChildren=function(a,d,f){a.castTerm&&(a.castTerm=f.walk(a.castTerm,a));a.operand&&(a.operand=f.walk(a.operand,a))};d.walkBinaryExpressionChildren=function(a,d,f){f.options.reverseSiblings?(a.operand2&&(a.operand2=f.walk(a.operand2,a)),a.operand1&&
f.options.goNextSibling&&(a.operand1=f.walk(a.operand1,a))):(a.operand1&&(a.operand1=f.walk(a.operand1,a)),a.operand2&&f.options.goNextSibling&&(a.operand2=f.walk(a.operand2,a)))};d.walkTypeReferenceChildren=function(a,d,f){a.term&&(a.term=f.walk(a.term,a))};d.walkCallExpressionChildren=function(a,d,f){f.options.reverseSiblings||(a.target=f.walk(a.target,a));a.args&&f.options.goNextSibling&&(a.args=f.walk(a.args,a));f.options.reverseSiblings&&f.options.goNextSibling&&(a.target=f.walk(a.target,a))};
d.walkTrinaryExpressionChildren=function(a,d,f){a.operand1&&(a.operand1=f.walk(a.operand1,a));a.operand2&&f.options.goNextSibling&&(a.operand2=f.walk(a.operand2,a));a.operand3&&f.options.goNextSibling&&(a.operand3=f.walk(a.operand3,a))};d.walkFuncDeclChildren=function(a,d,f){a.name&&(a.name=f.walk(a.name,a));a.args&&(0<a.args.members.length&&f.options.goNextSibling)&&(a.args=f.walk(a.args,a));a.returnTypeAnnotation&&f.options.goNextSibling&&(a.returnTypeAnnotation=f.walk(a.returnTypeAnnotation,a));
a.bod&&(0<a.bod.members.length&&f.options.goNextSibling)&&(a.bod=f.walk(a.bod,a))};d.walkBoundDeclChildren=function(a,d,f){a.id&&(a.id=f.walk(a.id,a));a.init&&(a.init=f.walk(a.init,a));a.typeExpr&&f.options.goNextSibling&&(a.typeExpr=f.walk(a.typeExpr,a))};d.walkReturnStatementChildren=function(a,d,f){a.returnExpression&&(a.returnExpression=f.walk(a.returnExpression,a))};d.walkForStatementChildren=function(a,d,f){a.init&&(a.init=f.walk(a.init,a));a.cond&&f.options.goNextSibling&&(a.cond=f.walk(a.cond,
a));a.incr&&f.options.goNextSibling&&(a.incr=f.walk(a.incr,a));a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkForInStatementChildren=function(a,d,f){a.lval=f.walk(a.lval,a);f.options.goNextSibling&&(a.obj=f.walk(a.obj,a));a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkIfStatementChildren=function(a,d,f){a.cond=f.walk(a.cond,a);a.thenBod&&f.options.goNextSibling&&(a.thenBod=f.walk(a.thenBod,a));a.elseBod&&f.options.goNextSibling&&(a.elseBod=f.walk(a.elseBod,a))};
d.walkWhileStatementChildren=function(a,d,f){a.cond=f.walk(a.cond,a);a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkDoWhileStatementChildren=function(a,d,f){a.cond=f.walk(a.cond,a);a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkBlockChildren=function(a,d,f){a.stmts&&(a.stmts=f.walk(a.stmts,a))};d.walkCaseStatementChildren=function(a,d,f){a.expr&&(a.expr=f.walk(a.expr,a));a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkSwitchStatementChildren=
function(a,d,f){a.val&&(a.val=f.walk(a.val,a));a.caseList&&f.options.goNextSibling&&(a.caseList=f.walk(a.caseList,a))};d.walkTryChildren=function(a,d,f){a.body&&(a.body=f.walk(a.body,a))};d.walkTryCatchChildren=function(a,d,f){a.tryNode&&(a.tryNode=f.walk(a.tryNode,a));a.catchNode&&f.options.goNextSibling&&(a.catchNode=f.walk(a.catchNode,a))};d.walkTryFinallyChildren=function(a,d,f){a.tryNode&&(a.tryNode=f.walk(a.tryNode,a));a.finallyNode&&f.options.goNextSibling&&(a.finallyNode=f.walk(a.finallyNode,
a))};d.walkFinallyChildren=function(a,d,f){a.body&&(a.body=f.walk(a.body,a))};d.walkCatchChildren=function(a,d,f){a.param&&(a.param=f.walk(a.param,a));a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkRecordChildren=l;d.walkNamedTypeChildren=function(a,d,f){l(a,d,f)};d.walkClassDeclChildren=function(a,d,f){l(a,d,f);f.options.goNextSibling&&a.baseClass&&(a.baseClass=f.walk(a.baseClass,a));f.options.goNextSibling&&a.implementsList&&(a.implementsList=f.walk(a.implementsList,a))};d.walkScriptChildren=
function(a,d,f){a.bod&&(a.bod=f.walk(a.bod,a))};d.walkTypeDeclChildren=function(a,d,f){l(a,d,f);f.options.goNextSibling&&a.extendsList&&(a.extendsList=f.walk(a.extendsList,a));f.options.goNextSibling&&a.implementsList&&(a.implementsList=f.walk(a.implementsList,a))};d.walkModuleDeclChildren=function(a,d,f){l(a,d,f);f.options.goNextSibling&&a.alias&&(a.alias=f.walk(a.alias,a))};d.walkImportDeclChildren=function(a,d,f){a.id&&(a.id=f.walk(a.id,a));a.alias&&(a.alias=f.walk(a.alias,a))};d.walkWithStatementChildren=
function(a,d,f){a.expr&&(a.expr=f.walk(a.expr,a));a.body&&f.options.goNextSibling&&(a.body=f.walk(a.body,a))};d.walkLabelChildren=function(){};d.walkLabeledStatementChildren=function(a,d,f){a.labels=f.walk(a.labels,a);f.options.goNextSibling&&(a.stmt=f.walk(a.stmt,a))}})(TypeScript||(TypeScript={}));
(function(a){function e(a){return null===a||0===a.length?null:a[a.length-1]}function h(a,d){return a>=d?a:d}function b(a){return null===a||-1===a.minChar||-1===a.limChar?!1:!0}a.lastOf=e;a.max=h;a.min=function(a,d){return a<=d?a:d};var j=function(){this.asts=[];this.top=-1};j.reverseIndexOf=function(a,d){return null===a||a.length<=d?null:a[a.length-d-1]};j.prototype.clone=function(){var a=new j;a.asts=this.asts.map(function(a){return a});a.top=this.top;return a};j.prototype.pop=function(){var a=this.ast();
...
1].args===this.asts[this.top-0]};j.prototype.isSynthesizedBlock=function(){return 1<=this.count()&&this.asts[this.top-0].nodeType===a.NodeType.Block&&!1===this.asts[this.top-0].visible};a.AstPath=j;a.isValidAstNode=b;var g;g=function(){this.path=new a.AstPath};a.AstPathContext=g;var d=a.GetAstPathOptions||(a.GetAstPathOptions={});d._map=[];d.Default=0;d.EdgeInclusive=1;d.DontPruneSearchBasedOnPosition=2;var l=a.GetAstPathOptions;a.getAstPathToPosition=function(c,d,f){"undefined"===typeof f&&(f=l.Default);
var k=function(a){if(a&&0<a.length)for(var c=0;c<a.length;c++){var f=a[c].minChar,l=a[c].limChar;a[c].isBlockComment||l++;d>=f&&d<l&&j.path.push(a[c])}},j=new g;a.getAstWalkerFactory().walk(c,function(n,g,e){if(b(n)){var h=a.hasFlag(f,l.EdgeInclusive)||n.nodeType===a.NodeType.Name||d===c.limChar,g=n.minChar,h=n.limChar+(h?1:0);if(d>=g&&d<h){var p=j.path.ast();(null==p||n.minChar>=p.minChar&&n.limChar<=p.limChar)&&j.path.push(n)}d<h&&k(n.preComments);d>=g&&k(n.postComments);a.hasFlag(f,l.DontPruneSearchBasedOnPosition)||
(e.options.goChildren=g<=d&&d<=h)}return n},null,null,j);return j.path};a.getTokenizationOffset=function(c,d){var f=0;a.getAstWalkerFactory().walk(c,function(c,l,b){if(a.isValidAstNode(c)&&(c.minChar<=d&&(f=h(f,c.minChar)),c.minChar>d||c.limChar<f))b.options.goChildren=!1;return c});return f};a.walkAST=function(c,d){var f=new j;a.getAstWalkerFactory().walk(c,function(a,c,f){c=f.state;c.push(a);d(c,f);return a},function(a,c,d){d.state.pop();return a},null,f)}})(TypeScript||(TypeScript={}));
...
j=this.addPadding(j,80," ",!1);j=j+"=> "+this.addLineColumn(a,b.limChar);j=this.addPadding(j,102," ",!1);j=j.concat("["+this.addPadding(b.minChar.toString(),1," ",!0)+", "+this.addPadding(b.limChar.toString(),1," ",!0)+"]");j=this.addPadding(j,115," ",!1);j=j.concat("sym="+b.sym);j=this.addPadding(j,135," ",!1);j=j.concat("type="+(null===b.type?"null":b.type.getTypeName()));this.logger.log(j)};e.prototype.logComments=function(a,b,j){if(null!=b)for(var g=0;g<b.length;g++)this.logNode(a,b[g],j)};e.prototype.logLinemap=
function(a){for(var b="[",j=0;j<a.length;j++)0<j&&(b+=","),b+=a[j];this.logger.log("linemap: "+(b+"]"))};e.prototype.addPadding=function(a,b,j,g){for(var d=g?"":a,l=a.length;l<b;l++)d+=j;return d+(g?a:"")};e.prototype.addLineColumn=function(e,b){var j={line:-1,col:-1};a.getSourceLineColFromMap(j,b,e.locationInfo.lineMap);-1!==j.col&&j.col++;return"("+j.line+", "+j.col+")"};a.AstLogger=e})(TypeScript||(TypeScript={}));
(function(a){var e=function(a){this.checker=a};e.prototype.resolveBaseTypeLinks=function(a,b){var j=null;if(a)for(var j=[],g=0,d=a.length;g<d;g++){var l=a[g];this.checker.resolvingBases=!0;this.checker.resolveTypeLink(b,l,!0);this.checker.resolvingBases=!1;j[g]=l.type.isClass()?l.type.instanceType:l.type}return j};e.prototype.resolveBases=function(a,b){b.extendsList=this.resolveBaseTypeLinks(b.extendsTypeLinks,a);for(var j=0,g=b.extendsList.length,d=b.isClassInstance();j<g;j++){var l=b.extendsList[j].isClassInstance();
b.extendsList[j]!=this.checker.anyType&&(d?l||this.checker.errorReporter.simpleErrorFromSym(b.symbol,"A export class may only extend other classes, "+b.extendsList[j].symbol.fullName()+" is an interface."):l&&this.checker.errorReporter.simpleErrorFromSym(b.symbol,"An interface may only extend other interfaces, "+b.extendsList[j].symbol.fullName()+" is a class."))}b.implementsList=this.resolveBaseTypeLinks(b.implementsTypeLinks,a);if(b.implementsList){j=0;for(g=b.implementsList.length;j<g;j++)l=b.implementsList[j],
l.isClassInstance()&&d&&this.checker.errorReporter.simpleErrorFromSym(b.symbol,"A class may only implement an interface; "+l.symbol.fullName()+" is a class.")}};e.prototype.resolveSignatureGroup=function(a,b,j){for(var g=!a.hasImplementation,d=0,l=a.signatures.length;d<l;d++){var c=a.signatures[d];j?c.returnType.type=j:this.checker.resolveTypeLink(b,c.returnType,g);for(var i=c.parameters.length,f=0;f<i;f++)this.bindSymbol(b,c.parameters[f]);c.hasVariableArgList&&(c=c.parameters[i-1],c.argsOffset=
i-1,c.getType().isArray()||(this.checker.errorReporter.simpleErrorFromSym(c,"... parameter must have array type"),c.parameter.typeLink.type=this.checker.makeArrayType(c.parameter.typeLink.type)))}};e.prototype.bindType=function(e,b,j){j&&this.bindType(e,j,null);if(b.hasMembers()){var g=b.members,d=b.ambientMembers,l=b.getAllEnclosedTypes(),c=b.getAllAmbientEnclosedTypes(),i=new a.SymbolTableScope(g,d,l,c,b.symbol),f=new a.SymbolAggregateScope(b.symbol),k=this.checker.currentModDecl,w=this.checker.inBind;
f.addParentScope(i);f.addParentScope(e);b.isModuleType()&&(this.checker.currentModDecl=b.symbol.declAST,this.checker.inBind=!0);g&&this.bind(f,b.members.allMembers);l&&this.bind(f,l.allMembers);d&&this.bind(f,d.allMembers);c&&this.bind(f,c.allMembers);this.checker.currentModDecl=k;this.checker.inBind=w}b.extendsTypeLinks&&this.resolveBases(e,b);b.construct&&this.resolveSignatureGroup(b.construct,e,j);b.call&&this.resolveSignatureGroup(b.call,e,null);b.index&&this.resolveSignatureGroup(b.index,e,null);
...
this.checker.locationInfo.filename,function(a){return e.find(a,!1,!0)});g&&(b.type=g.getType())}if(b.type&&b.type!=this.checker.gloModType&&(this.bindType(e,b.type,b.instanceType),b.type.isModuleType()))for(g=0;g<b.expansions.length;g++)this.bindType(e,b.expansions[g],b.instanceType);break;case a.SymbolKind.Field:this.checker.resolveTypeLink(e,b.field.typeLink,!1);break;case a.SymbolKind.Parameter:this.checker.resolveTypeLink(e,b.parameter.typeLink,!0)}this.checker.locationInfo=j}b.bound=!0};e.prototype.bind=
function(a,b){b.map(function(b,g,d){d.bindSymbol(a,g)},this)};a.Binder=e})(TypeScript||(TypeScript={}));
(function(a){var e=function(){};e.encodedValues="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";e.encode=function(a){if(64>a)return e.encodedValues.charAt(a);throw TypeError(a+": not a 64 based value");};e.decodeChar=function(a){if(1===a.length)return e.encodedValues.indexOf(a);throw TypeError('"'+a+'" must have length 1');};var h=function(){};h.encode=function(a){var a=0>a?(-a<<1)+1:a<<1,j="";do{var g=a&31,a=a>>5;0<a&&(g|=32);j+=e.encode(g)}while(0<a);return j};h.decode=function(a){for(var j=
0,g=!1,d=0,l=0;l<a.length;l++){var c=e.decodeChar(a[l]);0===l?(1===(c&1)&&(g=!0),j=c>>1&15):j|=(c&31)<<d;d+=0==l?4:5;if(32!==(c&32))return{value:g?-j:j,rest:a.substr(l+1)}}throw Error('Base64 value "'+a+'" finished with a continuation bit');};a.Base64VLQFormat=h})(TypeScript||(TypeScript={}));
(function(a){a.SourceMapping=function(){this.firstChild=this.parent=-1};var e=function(e,b,j,g){this.jsFile=j;this.sourceMapOut=g;this.sourceMappings=[];this.currentMapping=-1;this.jsFileName=a.getPrettyName(b,!1,!0);this.tsFileName=a.getPrettyName(e,!1,!0)};e.MapFileExtension=".map";e.CanEmitMapping=function(a,b){if(-1!==b.firstChild){var j=a[b.firstChild];if(j.emittedStartLine===b.emittedStartLine&&j.emittedStartColumn===b.emittedStartColumn)return!1}return!0};e.EmitSourceMapping=function(h){var b=
h[0];b.jsFile.WriteLine("//@ sourceMappingURL="+b.jsFileName+e.MapFileExtension);for(var j=b.sourceMapOut,g="",d=[],l=0,c=0,i=0,f=0,k=0,w=!1,n=0;n<h.length;n++)if(b=h[n],b.sourceMappings){var m=d.length;d.push(b.tsFileName);for(var u=b.sourceMappings,q=0,p=u.length;q<p;q++){var r=u[q];if(e.CanEmitMapping(u,r)){if(c!==r.emittedStartLine)for(;c<r.emittedStartLine;)l=0,g+=";",c++;else w&&(g+=",");g+=a.Base64VLQFormat.encode(r.emittedStartColumn-l);l=r.emittedStartColumn;g+=a.Base64VLQFormat.encode(m-
k);k=m;g+=a.Base64VLQFormat.encode(r.sourceStartLine-1-f);f=r.sourceStartLine-1;g+=a.Base64VLQFormat.encode(r.sourceStartColumn-i);i=r.sourceStartColumn;w=!0}}}""!=g&&(j.Write("{"),j.Write('"version":3,'),j.Write('"file":"'+b.jsFileName+'",'),j.Write('"sources":["'+d.join('","')+'"],'),j.Write('"names":[],'),j.Write('"mappings":"'+g),j.Write('"'),j.Write("}"));j.Close()};a.SourceMapper=e})(TypeScript||(TypeScript={}));
(function(a){var e=a.EmitContainer||(a.EmitContainer={});e._map=[];e._map[0]="Prog";e.Prog=0;e._map[1]="Module";e.Module=1;e._map[2]="DynamicModule";e.DynamicModule=2;e._map[3]="Class";e.Class=3;e._map[4]="Constructor";e.Constructor=4;e._map[5]="Function";e.Function=5;e._map[6]="Args";e.Args=6;e._map[7]="Interface";e.Interface=7;var h=a.EmitContainer,b;b=function(){this.line=this.column=this.indentAmt=0;this.inObjectLiteral=this.pretty=!1;this.container=h.Prog};a.EmitState=b;e=function(a,g,d){this.checker=
a;this.outfile=g;this.emitOptions=d;this.prologueEmitted=!1;this.indentStep=4;this.thisFnc=this.thisClassNode=null;this.moduleDeclList=[];this.moduleName="";this.emitState=new b;this.indentStrings=[];this.ambientModule=!1;this.firstModAlias=this.modAliasId=null;this.allSourceMappers=[];this.sourceMapper=null;this.declDottedModuleName=!1;this.declIndentDelta=0;this.declContainingAST=this.declFile=null};e.prototype.canWriteDeclFile=function(){return null!=this.declFile};e.prototype.setSourceMappings=
...
e.prototype.emitObjectLiteral=function(b){this.writeLineToOutput("{");this.increaseIndent();var g=this.setInObjectLiteral(!0);this.emitJavascriptList(b,",",a.TokenID.Comma,!0,!1,!1);this.setInObjectLiteral(g);this.decreaseIndent();this.emitIndent();this.writeToOutput("}")};e.prototype.emitArrayLiteral=function(b){this.writeToOutput("[");b&&(this.writeLineToOutput(""),this.increaseIndent(),this.emitJavascriptList(b,", ",a.TokenID.Comma,!0,!1,!1),this.decreaseIndent(),this.emitIndent());this.writeToOutput("]")};
e.prototype.emitNew=function(b,g){this.recordSourceMappingStart(b);this.writeToOutput("new ");b.nodeType==a.NodeType.TypeRef?this.writeToOutput("Array()"):(this.emitJavascript(b,a.TokenID.Tilde,!1),this.writeToOutput("("),this.emitJavascriptList(g,", ",a.TokenID.Comma,!1,!1,!1),this.writeToOutput(")"));this.recordSourceMappingEnd(b)};e.prototype.tryEmitConstant=function(b){if(!this.emitOptions.propagateConstants)return!1;if((b=b.operand2)&&b.sym&&b.sym.isVariable()&&a.hasFlag(b.sym.flags,a.SymbolFlags.Constant)&&
b.sym.declAST){var g=b.sym.declAST;if(g.init&&g.init.nodeType==a.NodeType.NumberLit)return this.writeToOutput(g.init.value.toString()),b=" /* "+b.text,this.writeToOutput(b+" */ "),!0}return!1};e.prototype.emitCall=function(b,g,d){this.emitSuperCall(b)||(a.hasFlag(b.flags,a.ASTFlags.ClassBaseConstructorCall)?(this.decreaseIndent(),this.decreaseIndent(),g=new a.ASTList,g.members[0]=b,this.emitConstructorCalls(g,this.thisClassNode),this.increaseIndent(),this.increaseIndent()):(g.nodeType==a.NodeType.FuncDecl&&
!g.isParenthesized&&this.writeToOutput("("),this.emitJavascript(g,a.TokenID.LParen,!1),g.nodeType==a.NodeType.FuncDecl&&!g.isParenthesized&&this.writeToOutput(")"),this.writeToOutput("("),this.emitJavascriptList(d,", ",a.TokenID.Comma,!1,!1,!1),this.writeToOutput(")")))};e.prototype.defaultValue=function(a){return a==this.checker.anyType?"undefined":a==this.checker.numberType?"0":a==this.checker.stringType?'""':a==this.checker.booleanType?"false":"null"};e.prototype.emitConstructorCalls=function(b,
g){if(null!=b){var d=b.members.length;this.recordSourceMappingStart(g);for(var l=0;l<d;l++){var c=b.members[l],i=null,i=c.nodeType==a.NodeType.Call?c.target.type.symbol:c.type.symbol;i.declModule!=g.type.symbol.declModule&&i.fullName();if(c.nodeType==a.NodeType.Call){this.emitIndent();this.writeToOutput("_super.call(this");if((c=c.args)&&0<c.members.length)this.writeToOutput(", "),this.emitJavascriptList(c,", ",a.TokenID.Comma,!1,!1,!1);this.writeToOutput(")")}else c.type&&c.type.isClassInstance()&&
(this.emitIndent(),this.writeToOutput(g.name.text+"._super.constructor"),this.writeToOutput(".call(this)"))}this.recordSourceMappingEnd(g)}};e.prototype.emitInnerFunction=function(b,g,d,l,c,i,f,k){"undefined"===typeof f&&(f=!1);"undefined"===typeof k&&(k=this.emitState.container);var e=b.isConstructor&&a.hasFlag(b.fncFlags,a.FncFlags.ClassMethod)&&(a.hasFlag(this.thisClassNode.type.instanceType.typeFlags,a.TypeFlags.HasBaseType)&&!a.hasFlag(this.thisClassNode.type.instanceType.typeFlags,a.TypeFlags.HasBaseTypeOfObject))&&
a.hasFlag(this.thisClassNode.varFlags,a.VarFlags.ClassSuperMustBeFirstCallInConstructor);this.emitParensAndCommentsInPlace(b,!0);this.recordSourceMappingStart(b);(!b.isAccessor()||!b.accessorSymbol.isObjectLitField)&&this.writeToOutput("function ");g&&(g=b.getNameText())&&!b.isAccessor()&&this.writeToOutput(g);this.writeToOutput("(");f&&(f=this.emitFuncSignatureIdentifier(b,!1,k));var n=0,k=0,m,u=[];if(b.args){g=this.setContainer(h.Args);n=b.args.members.length;b.variableArgList&&n--;for(k=0;k<n;k++)m=
b.args.members[k],m.init&&u.push(m),this.emitJavascript(m,a.TokenID.LParen,!1,f),k<n-1&&(this.writeToOutput(", "),f&&this.declFile.Write(", "));this.setContainer(g)}this.writeLineToOutput(") {");g=null;f&&(this.emitFuncSignatureVariableArg(b),b.hasStaticDeclarations()&&(g=this.setDeclContainingAST(b)));this.increaseIndent();for(k=0;k<u.length;k++)m=u[k],this.emitIndent(),this.recordSourceMappingStart(m),this.writeToOutput("if (typeof "+m.id.text+' === "undefined") { '),this.recordSourceMappingStart(m.id),
this.writeToOutput(m.id.text),this.recordSourceMappingEnd(m.id),this.writeToOutput(" = "),this.emitJavascript(m.init,a.TokenID.LParen,!1),this.writeLineToOutput("; }"),this.recordSourceMappingEnd(m);if(b.isConstructor&&!e){if(b.args){n=b.args.members.length;for(k=0;k<n;k++)m=b.args.members[k],(m.varFlags&a.VarFlags.Property)!=a.VarFlags.None&&(this.emitIndent(),this.recordSourceMappingStart(m),this.recordSourceMappingStart(m.id),this.writeToOutput("this."+m.id.text),this.recordSourceMappingEnd(m.id),
this.writeToOutput(" = "),this.recordSourceMappingStart(m.id),this.writeToOutput(m.id.text),this.recordSourceMappingEnd(m.id),this.writeLineToOutput(";"),this.recordSourceMappingEnd(m))}a.hasFlag(b.fncFlags,a.FncFlags.ClassMethod)||this.emitConstructorCalls(l,i)}c&&(this.emitIndent(),this.writeLineToOutput("var _this = this;"));b.variableArgList&&(n=b.args.members.length,k=b.args.members[n-1],this.emitIndent(),this.recordSourceMappingStart(k),this.writeToOutput("var "),this.recordSourceMappingStart(k.id),
this.writeToOutput(k.id.text),this.recordSourceMappingEnd(k.id),this.writeLineToOutput(" = [];"),this.recordSourceMappingEnd(k),this.emitIndent(),this.writeLineToOutput("for (var _i = 0; _i < (arguments.length - "+(n-1)+"); _i++) {"),this.increaseIndent(),this.emitIndent(),this.writeLineToOutput(k.id.text+"[_i] = arguments[_i + "+(n-1)+"];"),this.decreaseIndent(),this.emitIndent(),this.writeLineToOutput("}"));if(b.isConstructor&&a.hasFlag(b.fncFlags,a.FncFlags.ClassMethod)&&!e){l=this.thisClassNode.members.members.length;
...
this.writeLineToOutput("");if(b.hasStaticDeclarations()){this.writeLineToOutput("");this.emitIndent();e=b.getNameText();this.writeLineToOutput("(function ("+e+") {");this.increaseIndent();l=0;l=b.innerStaticFuncs.length;for(k=0;k<l;k++)c=b.innerStaticFuncs[k],c.isOverload?f&&this.emitFuncSignature(c):(this.emitIndent(),c.isAccessor()?this.emitPropertyAccessor(c,b.name.text,!1,f):(this.writeToOutput(e+"."+c.name.text+" = "),this.emitInnerFunction(c,c.name&&!c.name.isMissing(),!1,null,c.hasSelfReference(),
null,f)));if(b.statics){this.recordSourceMappingStart(b.statics);l=b.statics.members.length;for(k=0;k<l;k++)this.emitIndent(),this.writeToOutput(e),this.emitJavascript(b.statics.members[k],a.TokenID.Tilde,!1,f),this.writeLineToOutput("");this.recordSourceMappingEnd(b.statics)}this.decreaseIndent();this.emitIndent();this.writeLineToOutput("})("+(d&&this.thisClassNode?this.thisClassNode.name.text+".prototype.":"")+e+");");f&&(this.setDeclContainingAST(g),this.emitIndentToDeclFile(),this.declFile.WriteLine("}"))}this.recordSourceMappingEnd(b);
this.emitParensAndCommentsInPlace(b,!1)};e.prototype.emitArgDecl=function(a){this.declFile.Write(a.id.text);a.isOptionalArg()&&this.declFile.Write("?");(a.typeExpr||a.type!=this.checker.anyType)&&this.canEmitTypeAnnotationSignature(a.type)&&this.declFile.Write(": "+this.getTypeSignature(a.type))};e.prototype.emitFuncSignatureIdentifier=function(b,g,d){"undefined"===typeof g&&(g=!1);"undefined"===typeof d&&(d=this.emitState.container);if(!g&&!b.isOverload)if(b.isConstructor){if(1<b.type.construct.signatures.length)return!1}else if(1<
b.type.call.signatures.length)return!1;if(!this.canEmitSignature(a.ToDeclFlags(b.fncFlags),d))return!1;b.isConstructor?(this.emitIndentToDeclFile(),this.declFile.Write("constructor ")):(d=b.getNameText(),g?(this.emitIndentToDeclFile(),b.isConstructMember()?this.declFile.Write("new"):!b.isCallMember()&&!b.isIndexerMember()&&(this.declFile.Write(d),a.hasFlag(b.name.flags,a.ASTFlags.OptionalName)&&this.declFile.Write("? "))):(this.emitDeclFlags(a.ToDeclFlags(b.fncFlags),"function"),this.declFile.Write(d)));
...
function(b){var g=b.accessorSymbol;this.emitDeclFlags(a.ToDeclFlags(g.flags),"var");this.declFile.WriteLine(b.name.text+" : "+this.getTypeSignature(g.getType())+";")};e.prototype.emitDeclFlags=function(b,g){this.emitIndentToDeclFile();var d="";a.hasFlag(b,a.DeclFlags.GetAccessor)?d="get ":a.hasFlag(b,a.DeclFlags.SetAccessor)&&(d="set ");a.hasFlag(b,a.DeclFlags.Exported)&&this.declFile.Write("export ");a.hasFlag(b,a.DeclFlags.LocalStatic)||a.hasFlag(b,a.DeclFlags.Static)?this.declFile.Write("static "+
d):a.hasFlag(b,a.DeclFlags.Private)?this.declFile.Write("private "+d):a.hasFlag(b,a.DeclFlags.Public)?this.declFile.Write("public "+d):""==d?this.declFile.Write(g+" "):this.declFile.Write(d)};e.prototype.canEmitTypeAnnotationSignature=function(b,g){"undefined"===typeof g&&(g=a.DeclFlags.None);if(null==b)return!1;if(b.primitiveTypeClass==a.Primitive.None&&b.symbol&&void 0!=b.symbol.container&&b.symbol.container!=this.checker.gloMod){if(a.hasFlag(g,a.DeclFlags.Private))return!1;if(a.hasFlag(b.symbol.container.flags,
...
this.writeToOutput(this.defaultValue(b.type)));g!=a.TokenID.FOR&&g!=a.TokenID.LParen&&this.writeToOutputTrimmable(";");this.recordSourceMappingEnd(b);this.emitParensAndCommentsInPlace(b,!1)}d&&this.emitVarSignature(b)};e.prototype.declEnclosed=function(a){if(null==a)return!0;for(var b=0,d=this.moduleDeclList.length;b<d;b++)if(this.moduleDeclList[b]==a)return!0;return!1};e.prototype.emitJavascriptName=function(b,g){var d=b.sym;this.emitParensAndCommentsInPlace(b,!0);this.recordSourceMappingStart(b);
if(!b.isMissing()){if(g&&this.emitState.container!=h.Args&&d)if(d.container&&d.container.name!=a.globalId)if(a.hasFlag(d.flags,a.SymbolFlags.Static)&&a.hasFlag(d.flags,a.SymbolFlags.Property))d.declModule&&a.hasFlag(d.declModule.modFlags,a.ModuleFlags.IsDynamic)?this.writeToOutput("exports."):this.writeToOutput(d.container.name+".");else if(d.kind()==a.SymbolKind.Field)if(a.hasFlag(d.flags,a.SymbolFlags.ModuleMember)){if(d.container!=this.checker.gloMod&&(a.hasFlag(d.flags,a.SymbolFlags.Property)||
...
this.emitParensAndCommentsInPlace(b,!1)};e.prototype.emitJavascriptStatements=function(b,g){if(b)if(b.nodeType!=a.NodeType.Block){var d=b&&(b.nodeType!=a.NodeType.List||0<b.members.length);if(g||d)d=b.nodeType==a.NodeType.Block||b.nodeType==a.NodeType.List&&1==b.members.length&&b.members[0].nodeType==a.NodeType.Block,this.recordSourceMappingStart(b),d||(this.writeLineToOutput(" {"),this.increaseIndent()),this.emitJavascriptList(b,null,a.TokenID.SColon,!0,!1,!1),d||(this.writeLineToOutput(""),this.decreaseIndent(),
this.emitIndent(),this.writeToOutput("}")),this.recordSourceMappingEnd(b)}else this.emitJavascript(b,a.TokenID.SColon,!0);else g&&this.writeToOutput("{ }")};e.prototype.emitBareJavascriptStatements=function(b,g){b.nodeType!=a.NodeType.Block?b.nodeType==a.NodeType.List?2==b.members.length&&b.members[0].nodeType==a.NodeType.Block&&b.members[1].nodeType==a.NodeType.EndCode?(this.emitJavascript(b.members[0],a.TokenID.SColon,!0),this.writeLineToOutput("")):this.emitJavascriptList(b,null,a.TokenID.SColon,
!0,!1,g):this.emitJavascript(b,a.TokenID.SColon,!0):this.emitJavascript(b,a.TokenID.SColon,!0)};e.prototype.recordSourceMappingStart=function(b){if(this.sourceMapper&&b){var g={line:-1,col:-1},d=new a.SourceMapping(b);d.emittedStartColumn=this.emitState.column;d.emittedStartLine=this.emitState.line;a.getSourceLineColFromMap(g,b.minChar,this.checker.locationInfo.lineMap);d.sourceStartColumn=g.col;d.sourceStartLine=g.line;a.getSourceLineColFromMap(g,b.limChar,this.checker.locationInfo.lineMap);d.sourceEndColumn=
g.col;d.sourceEndLine=g.line;d.parent=this.sourceMapper.currentMapping;this.sourceMapper.currentMapping=this.sourceMapper.sourceMappings.length;this.sourceMapper.sourceMappings.push(d);0<=d.parent&&(b=this.sourceMapper.sourceMappings[d.parent],-1==b.firstChild&&(b.firstChild=this.sourceMapper.currentMapping))}};e.prototype.recordSourceMappingEnd=function(a){this.sourceMapper&&a&&(a=this.sourceMapper.sourceMappings[this.sourceMapper.currentMapping],a.emittedEndColumn=this.emitState.column,a.emittedEndLine=
this.emitState.line,this.sourceMapper.currentMapping=a.parent)};e.prototype.emitSourceMappings=function(){a.SourceMapper.EmitSourceMapping(this.allSourceMappers)};e.prototype.emitJavascriptList=function(b,g,d,l,c,i,f){if(null!=b)if(b.nodeType!=a.NodeType.List)this.emitJavascript(b,d,l,f);else if(0!=b.members.length){this.emitParensAndCommentsInPlace(b,!0);for(var k=b.members.length,e=0;e<k;e++){if(1==e&&i){var n=this.thisClassNode.constructorDecl;if(n&&n.args)for(var m=n.args.members.length,h=0;h<
m;h++){var q=n.args.members[h];(q.varFlags&a.VarFlags.Property)!=a.VarFlags.None&&(this.emitIndent(),this.recordSourceMappingStart(q),this.recordSourceMappingStart(q.id),this.writeToOutput("this."+q.id.text),this.recordSourceMappingEnd(q.id),this.writeToOutput(" = "),this.recordSourceMappingStart(q.id),this.writeToOutput(q.id.text),this.recordSourceMappingEnd(q.id),this.writeLineToOutput(";"),this.recordSourceMappingEnd(q))}n=this.thisClassNode.members.members.length;for(m=0;m<n;m++)this.thisClassNode.members.members[m].nodeType==
a.NodeType.VarDecl&&(h=this.thisClassNode.members.members[m],!a.hasFlag(h.varFlags,a.VarFlags.Static)&&h.init&&(this.emitIndent(),this.emitJavascriptVarDecl(h,a.TokenID.Tilde),this.writeLineToOutput("")))}n=b.members[e];m=n.nodeType==a.NodeType.FuncDecl&&a.hasFlag(n.fncFlags,a.FncFlags.Static)||n.nodeType==a.NodeType.VarDecl&&a.hasFlag(n.varFlags,a.VarFlags.Static);if(!(c?!m:m))this.emitJavascript(n,d,l,f),g&&e<k-1?l?this.writeLineToOutput(g):this.writeToOutput(g):l&&(n.nodeType!=a.NodeType.Interface&&
!(n.nodeType==a.NodeType.VarDecl&&(n.varFlags&a.VarFlags.Ambient)==a.VarFlags.Ambient&&null==n.init)&&n.nodeType!=a.NodeType.EndCode&&n.nodeType!=a.NodeType.FuncDecl)&&this.writeLineToOutput("")}this.emitParensAndCommentsInPlace(b,!1)}};e.prototype.emitJavascript=function(b,g,d,l){"undefined"===typeof l&&(l=!1);null!=b&&(d&&0<this.emitState.indentAmt&&b.nodeType!=a.NodeType.List&&b.nodeType!=a.NodeType.Block&&b.nodeType!=a.NodeType.Interface&&(!(b.nodeType==a.NodeType.VarDecl&&(b.varFlags&a.VarFlags.Ambient)==
a.VarFlags.Ambient&&null==b.init)&&b.nodeType!=a.NodeType.EndCode&&(b.nodeType!=a.NodeType.FuncDecl||this.emitState.container!=h.Constructor))&&this.emitIndent(),b.emit(this,g,d,l),g==a.TokenID.SColon&&b.nodeType<a.NodeType.GeneralNode&&this.writeToOutput(";"))};e.prototype.emitPropertyAccessor=function(a,b,d,l){if(!a.accessorSymbol.hasBeenEmitted){var c=a.accessorSymbol;this.emitIndent();this.recordSourceMappingStart(a);this.writeLineToOutput("Object.defineProperty("+b+(d?'.prototype, "':', "')+
...
labels:b})};g.prototype.popStmt=function(){return this.stmtStack.pop()};g.prototype.resolveJumpTarget=function(d){for(var b=this.stmtStack.length-1;0<=b;b--){var c=this.stmtStack[b];if(d.target){if(c.labels&&0<c.labels.members.length)for(var i=0,f=c.labels.members.length;i<f;i++)if(c.labels.members[i].id.text==d.target){d.setResolvedTarget(this,c.stmt);return}}else{if(c.stmt.isLoop()){d.setResolvedTarget(this,c.stmt);return}if(c.stmt.nodeType==a.NodeType.Switch&&d.nodeType==a.NodeType.Break){d.setResolvedTarget(this,
...
1]};g.prototype.parseComment=function(d){if(d){var b=new a.Comment(d.value,d.isBlock,d.endsLine);b.minChar=d.startPos;b.limChar=d.startPos+d.value.length;!d.isBlock&&3<d.value.length&&"///"==d.value.substring(0,3)&&(d=a.getAdditionalDependencyPath(d.value))&&this.amdDependencies.push(d);return b}return null};g.prototype.parseCommentsInner=function(a){if(a){for(var b=[],c=0;c<a.length;c++)b.push(this.parseComment(a[c]));return b}return null};g.prototype.parseComments=function(){var a=this.scanner.getComments();
return this.parseCommentsInner(a)};g.prototype.parseCommentsForLine=function(a){a=this.scanner.getCommentsForLine(a);return this.parseCommentsInner(a)};g.prototype.combineComments=function(a,b){return null==a?b:null==b?a:a.concat(b)};g.prototype.parseEnumDecl=function(d){var b=this.scanner.leftCurlyCount,c=this.scanner.rightCurlyCount,i=null;this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)?(i=new a.Identifier(this.tok.getText()),i.minChar=this.scanner.startPos,i.limChar=
this.scanner.pos,this.tok=this.scanner.scan()):(this.reportParseError("Enum declaration requires identifier"),this.errorRecovery&&(i=new a.MissingIdentifier,i.minChar=this.scanner.startPos,i.limChar=this.scanner.startPos,i.flags|=a.ASTFlags.Error));var f=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",d|a.ErrorRecoverySet.ID);this.pushDeclLists();var k=new a.ASTList;k.minChar=f;f=new a.VarDecl(new a.Identifier("_map"),0);f.varFlags|=a.VarFlags.Exported;f.varFlags|=a.VarFlags.Private;
f.varFlags|=a.VarFlags.Property|a.VarFlags.Public;f.init=new a.UnaryExpression(a.NodeType.ArrayLit,null);k.append(f);for(f=null;;){var e=this.scanner.startPos,n,g=null,j=null,q=null,p=null;if(this.tok.tokenId==a.TokenID.ID||a.convertTokToIDName(this.tok))g=new a.Identifier(this.tok.getText()),g.minChar=this.scanner.startPos,g.limChar=this.scanner.pos;else if(this.tok.tokenId==a.TokenID.RCurly)break;else this.reportParseError("Expected identifer of enum member"),this.errorRecovery&&(g=new a.MissingIdentifier,
g.minChar=this.scanner.startPos,g.limChar=this.scanner.startPos,g.flags|=a.ASTFlags.Error);n=this.scanner.pos;q=this.parseComments();this.tok=this.scanner.scan();p=this.parseComments();if(this.tok.tokenId==a.TokenID.Asg)this.tok=this.scanner.scan(),f=j=this.parseExpr(d,a.OperatorPrecedence.Cma,!0,h.NoTypes),n=j.limChar;else{var f=j=null==f?new a.NumberLiteral(0):new a.NumberLiteral(f.value+1),r=new a.BinaryExpression(a.NodeType.Asg,new a.BinaryExpression(a.NodeType.Index,new a.Identifier("_map"),
j),new a.StringLiteral('"'+g.text+'"'));k.append(r)}g=new a.VarDecl(g,this.nestingLevel);g.minChar=e;g.limChar=n;g.init=j;g.typeExpr=new a.TypeReference(this.createRef(i.text,-1),0);g.varFlags|=a.VarFlags.Readonly|a.VarFlags.Property;j.nodeType==a.NodeType.NumberLit&&(g.varFlags|=a.VarFlags.Constant);g.preComments=q;k.append(g);g.postComments=p;g.varFlags|=a.VarFlags.Exported;if(this.tok.tokenId==a.TokenID.Comma&&(this.tok=this.scanner.scan(),g.postComments=this.combineComments(g.postComments,this.parseCommentsForLine(this.scanner.prevLine)),
this.tok.tokenId==a.TokenID.ID||a.convertTokToIDName(this.tok)))continue;break}this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);k.limChar=this.scanner.lastTokenLimChar();d=new a.ModuleDecl(i,k,this.topVarList(),this.topScopeList());d.modFlags|=a.ModuleFlags.IsEnum;this.popDeclLists();d.leftCurlyCount=this.scanner.leftCurlyCount-b;d.rightCurlyCount=this.scanner.rightCurlyCount-c;return d};g.prototype.parseDottedName=function(d){this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,
this.strictMode)){var b=new a.Identifier(this.tok.getText());b.preComments=this.parseComments();d[d.length]=b;b.minChar=this.scanner.startPos;b.limChar=this.scanner.pos;this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.Dot&&this.parseDottedName(d)}else this.reportParseError("need identifier after '.'")};g.prototype.isValidImportPath=function(d){d=a.stripQuotes(d);return!d||-1!=d.indexOf(":")||-1!=d.indexOf("\\")||"/"==d.charAt(0)?!1:!0};g.prototype.parseImportDecl=function(d,b){var c=null,
i=null,c=null,f=this.scanner.startPos,k=!1;this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)?c=new a.Identifier(this.tok.getText()):(this.reportParseError("Expected identifer after 'import'"),c=new a.MissingIdentifier);c.minChar=this.scanner.startPos;c.limChar=this.scanner.pos;this.tok=this.scanner.scan();this.chkCurTok(a.TokenID.Asg,"Expected =",d|a.ErrorRecoverySet.ID);var g=this.parseComments(),n;if(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,
this.strictMode))if(this.tok.tokenId==a.TokenID.MODULE){if(n=this.scanner.pos,this.tok=this.scanner.scan(),this.tok.tokenId==a.TokenID.LParen){this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.QString||this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode))this.tok.tokenId==a.TokenID.QString?(this.topLevel&&(this.hasTopLevelImportOrExport=!0),i=this.tok.getText(),this.isValidImportPath(i)||this.reportParseError("Invalid import path"),i=new a.Identifier(i),i.minChar=this.scanner.startPos,
i.limChar=this.scanner.pos,k=!0,this.tok=this.scanner.scan()):i=this.parseExpr(d|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.Asg,!0,h.NoTypes),i.preComments=g;n=this.scanner.pos;this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.ID);i&&(i.postComments=this.parseComments());this.tok.tokenId==a.TokenID.SColon&&(n=this.scanner.pos,this.tok=this.scanner.scan())}}else i=this.parseExpr(d|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.Asg,!0,h.NoTypes),n=this.scanner.pos;else this.reportParseError("Expected module name"),
i=new a.MissingIdentifier,i.minChar=this.scanner.startPos,i.limChar=this.scanner.startPos,i.flags|=a.ASTFlags.Error,n=i.limChar;c=new a.ImportDecl(c,i);c.isDynamicImport=k;a.hasFlag(b,a.Modifiers.Exported)&&(c.varFlags|=a.VarFlags.Exported);c.minChar=f;c.limChar=n;return c};g.prototype.parseModuleDecl=function(d,b){var c=this.scanner.leftCurlyCount,i=this.scanner.rightCurlyCount,f=this.ambientModule,k=this.topLevel;this.topLevel=!1;if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Ambient))this.ambientModule=
!0;this.tok=this.scanner.scan();var g=null,n=null;this.pushDeclLists();var e=this.parseComments(),h=this.scanner.startPos,j=!1;this.tok.tokenId==a.TokenID.ID||this.tok.tokenId==a.TokenID.QString||a.convertTokToID(this.tok,this.strictMode)?(g=this.tok.getText(),this.tok.tokenId==a.TokenID.QString&&(j=!0,this.ambientModule||this.reportParseError("Only ambient dynamic modules may have string literal names")),g=new a.Identifier(g),g.minChar=this.scanner.startPos,g.limChar=this.scanner.pos,this.tok=this.scanner.scan()):
this.tok.tokenId==a.TokenID.LCurly&&(this.reportParseError("Module name missing"),g=new a.Identifier(""),g.minChar=h,g.limChar=h);this.tok.tokenId==a.TokenID.Dot&&(n=[],this.parseDottedName(n));null==g&&(g=new a.MissingIdentifier);var p=new a.ASTList,r=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",d|a.ErrorRecoverySet.ID);this.parseStmtList(d|a.ErrorRecoverySet.RCurly,p,!0,!0,a.AllowedElements.ModuleMembers,b);p.minChar=r;p.limChar=this.scanner.pos;this.chkCurTok(a.TokenID.RCurly,
"Expected '}'",d);r=this.scanner.pos;if(n&&0<n.length){var s=n.length,t=n[s-1],t=new a.ModuleDecl(t,p,this.topVarList(),this.topScopeList());if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Ambient))t.modFlags|=a.ModuleFlags.Ambient;t.modFlags|=a.ModuleFlags.Exported;t.minChar=h;t.limChar=r;this.popDeclLists();for(s-=2;0<=s;s--){p=new a.ASTList;p.append(t);t=n[s];t=new a.ModuleDecl(t,p,new a.ASTList,new a.ASTList);p.minChar=t.minChar=h;p.limChar=t.limChar=r;if(this.parsingDeclareFile||a.hasFlag(b,
a.Modifiers.Ambient))t.modFlags|=a.ModuleFlags.Ambient;t.modFlags|=a.ModuleFlags.Exported}p=new a.ASTList;p.append(t);p.minChar=h;p.limChar=r;n=new a.ModuleDecl(g,p,new a.ASTList,new a.ASTList)}else n=new a.ModuleDecl(g,p,this.topVarList(),this.topScopeList()),this.popDeclLists();if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Ambient))n.modFlags|=a.ModuleFlags.Ambient;a.hasFlag(b,a.Modifiers.Exported)&&(n.modFlags|=a.ModuleFlags.Exported);j&&(n.modFlags|=a.ModuleFlags.IsDynamic);n.preComments=
e;n.postComments=this.parseComments();this.ambientModule=f;this.topLevel=k;n.leftCurlyCount=this.scanner.leftCurlyCount-c;n.rightCurlyCount=this.scanner.rightCurlyCount-i;return n};g.prototype.parseTypeReferenceTail=function(d,b,c){c=new a.TypeReference(c,0);for(c.minChar=b;this.tok.tokenId==a.TokenID.LBrack;)this.tok=this.scanner.scan(),c.arrayCount++,this.chkCurTok(a.TokenID.RBrack,"Expected ']'",d|a.ErrorRecoverySet.LBrack);c.limChar=this.scanner.lastTokenLimChar();return c};g.prototype.parseNamedType=
function(d,b,c,i){this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.Dot){this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)){var f=new a.Identifier(this.tok.getText());f.minChar=this.scanner.startPos;f.limChar=this.scanner.pos;var k=new a.BinaryExpression(a.NodeType.Dot,c,f);k.minChar=c.minChar;k.limChar=f.limChar;return this.parseNamedType(d,b,k,i)}this.reportParseError("need identifier after '.'");if(this.errorRecovery)return c.flags|=
a.ASTFlags.DotLHS,c.limChar=this.scanner.lastTokenLimChar(),c;f=new a.MissingIdentifier;f.minChar=this.scanner.pos;f.limChar=this.scanner.pos;k=new a.BinaryExpression(a.NodeType.Dot,c,f);k.flags|=a.ASTFlags.Error;k.minChar=c.minChar;k.limChar=f.limChar;return this.parseNamedType(d,b,k,i)}return i?this.parseTypeReferenceTail(d,b,c):c};g.prototype.parseTypeReference=function(d,b){var c=this.scanner.startPos,i=!1;switch(this.tok.tokenId){case a.TokenID.VOID:b||this.reportParseError("void not a valid type in this context");
case a.TokenID.NUMBER:case a.TokenID.BOOL:case a.TokenID.ANY:case a.TokenID.STRING:return i=new a.Identifier(a.tokenTable[this.tok.tokenId].text),i.minChar=c,i.limChar=this.scanner.pos,this.tok=this.scanner.scan(),this.parseTypeReferenceTail(d,c,i);case a.TokenID.ID:return i=this.createRef(this.tok.getText(),c),i.limChar=this.scanner.pos,this.parseNamedType(d,c,i,!0);case a.TokenID.LCurly:this.tok=this.scanner.scan();i=new a.ASTList;i.minChar=c;var f=this.inInterfaceDecl;this.inInterfaceDecl=!0;this.parseInterfaceMembers(d|
a.ErrorRecoverySet.RCurly,i);this.inInterfaceDecl=f;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);f=new a.TypeDecl(a.NodeType.Interface,this.anonId,i,null,null,null);f.minChar=c;f.limChar=i.limChar;return this.parseTypeReferenceTail(d,c,f);case a.TokenID.NEW:this.tok=this.scanner.scan(),this.tok.tokenId!=a.TokenID.LParen?this.reportParseError("Expected '('"):i=!0;case a.TokenID.LParen:var k=new a.ASTList,f=this.parseFormalParameterList(d|a.ErrorRecoverySet.RParen,k,!1,!0,!1,!1,!1,null);this.chkCurTok(a.TokenID.Arrow,
"Expected '=>'",d);var g=this.parseTypeReference(d,!0),k=new a.FuncDecl(null,null,!1,k,null,null,null,a.NodeType.FuncDecl);k.returnTypeAnnotation=g;k.variableArgList=f;k.fncFlags|=a.FncFlags.Signature;i&&(k.fncFlags|=a.FncFlags.ConstructMember,k.hint="_construct",k.classDecl=null);k.minChar=c;return this.parseTypeReferenceTail(d,c,k);default:return this.reportParseError("Expected type name"),c=new a.TypeReference(null,0),c.flags|=a.ASTFlags.Error,c.minChar=this.scanner.pos,c.limChar=this.scanner.pos,
c}};g.prototype.parseFunctionStatements=function(d,l,c,i,f,k,g,n,e){this.pushDeclLists();var j=this.stmtStack;this.resetStmtStack();var q=null,p=!1,r=!1;if(!n){var q=new a.ASTList,s=this.scanner.startPos;this.tok.tokenId==a.TokenID.Arrow&&(i&&this.reportParseError("'=>' may not be used for class methods"),p=!0,this.tok=this.scanner.scan());p&&this.tok.tokenId!=a.TokenID.LCurly?(k=this.parseExpr(d|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.Asg,!0,h.NoTypes),e=new a.ReturnStatement,e.returnExpression=
k,q.minChar=s,q.append(e)):(this.state=b.StartStmtList,this.chkCurTok(a.TokenID.LCurly,"Expected '{'",d|a.ErrorRecoverySet.StmtStart),i=this.inFnc,r=p,this.inFnc=!0,this.parseStmtList(d|a.ErrorRecoverySet.RCurly|a.ErrorRecoverySet.StmtStart,q,!0,!1,k,e),q.minChar=s,q.limChar=this.scanner.pos,this.inFnc=i,s=new a.EndCode,s.minChar=q.limChar,s.limChar=s.minChar,q.append(s))}l=new a.FuncDecl(l,q,c,f,this.topVarList(),this.topScopeList(),this.topStaticsList(),a.NodeType.FuncDecl);this.popDeclLists();
this.topScopeList().append(l);c=this.scanner.pos;n?this.chkCurTok(a.TokenID.SColon,"Expected ';'",d):!p||r?(this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d),r&&(l.fncFlags|=a.FncFlags.IsFatArrowFunction)):(l.fncFlags|=a.FncFlags.IsFatArrowFunction,this.tok.tokenId==a.TokenID.SColon&&(this.tok=this.scanner.scan()));l.minChar=g;l.limChar=c;n||(l.fncFlags|=a.FncFlags.Definition);this.stmtStack=j;return l};g.prototype.transformAnonymousArgsIntoFormals=function(d,b){var c=this,i=function(b){if(b.nodeType==
...
(i(b.operand1),i(b.operand2)):i(b))};g.prototype.parseFormalParameterList=function(d,b,c,i,f,k,g,n){b.minChar=this.scanner.startPos;f?this.tok=this.scanner.scan():n||this.chkCurTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.RParen);var e=!1,j=!0,q=!1,p=!1,r=!1;n&&(this.transformAnonymousArgsIntoFormals(b,n),p=!0);for(;;){var s=!1,t=a.VarFlags.None,v=this.scanner.startPos;this.inferPropertiesFromThisAssignment&&this.tok.tokenId==a.TokenID.THIS&&(c||this.reportParseError("Instance property declarations using 'this' may only be used in class constructors"),
...
a.VarFlags.ClassSuperMustBeFirstCallInConstructor));t!=a.VarFlags.None?(c||this.reportParseError("only constructor parameters can be properties"),this.tok=this.scanner.scan(),this.inferPropertiesFromThisAssignment&&this.tok.tokenId==a.TokenID.THIS&&(c||this.reportParseError("Instance property declarations using 'this' may only be used in class constructors"),this.tok=this.scanner.scan(),this.tok=this.scanner.scan())):this.tok.tokenId==a.TokenID.Ellipsis&&(e=!0,this.tok=this.scanner.scan());var A=
null;if(!p&&this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode))A=new a.Identifier(this.tok.getText()),A.minChar=this.scanner.startPos,A.limChar=this.scanner.pos;if(p||A){var s=!0,C=null,x=null;p&&b.members.length?(x=b.members[b.members.length-1],x.isOptional&&(r=q=!0)):(x=new a.ArgDecl(A),k&&this.reportParseError("Property getters may not take any arguments"),g&&!j&&this.reportParseError("Property setters may only take one argument"),x.minChar=v,x.preComments=this.parseComments(),
this.tok=this.scanner.scan());this.tok.tokenId==a.TokenID.QMark&&(q=x.isOptional=!0,this.tok=this.scanner.scan());this.tok.tokenId==a.TokenID.Colon&&(this.tok=this.scanner.scan(),C=this.parseTypeReference(d,!1),n&&(r=!0));this.tok.tokenId==a.TokenID.Asg&&(i&&this.reportParseError("Arguments in signatures may not have default values"),q=!0,this.tok=this.scanner.scan(),x.init=this.parseExpr(a.ErrorRecoverySet.Comma|d,a.OperatorPrecedence.Cma,!1,h.NoTypes));q&&(!x.isOptionalArg()&&!e)&&this.reportParseError("Optional parameters may only be followed by other optional parameters");
e&&x.isOptionalArg()&&this.reportParseError("Varargs may not be optional or have default parameters");x.postComments=this.parseComments();x.typeExpr=C;x.limChar=this.scanner.lastTokenLimChar();x.varFlags|=t;p?p=!1:b.append(x)}j=!1;if(this.tok.tokenId==a.TokenID.Comma)s&&!e?this.tok=this.scanner.scan():(this.reportParseError("Unexpected ',' in argument list"),this.errorRecovery&&(this.tok=this.scanner.scan()));else break}f?this.chkCurTok(a.TokenID.RBrack,"Expected ']'",d|a.ErrorRecoverySet.LCurly|
a.ErrorRecoverySet.SColon):(!n||r)&&this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.LCurly|a.ErrorRecoverySet.SColon);b.limChar=this.scanner.lastTokenLimChar();return e};g.prototype.parseFncDecl=function(d,l,c,i,f,k,g,n,e,h){var j=this.scanner.leftCurlyCount,p=this.scanner.rightCurlyCount,r=this.parsingClassConstructorDefinition;this.parsingClassConstructorDefinition=!1;var s=null,t=this.scanner.startPos,v=this.scanner.pos,A=this.nestingLevel;this.nestingLevel=0;!this.style_funcInLoop&&
this.inLoop()&&this.reportParseStyleError("function declaration in loop");if(!i&&!g&&!k&&!h)if(this.tok=this.scanner.scan(),this.state=b.StartFncDecl,this.tok.tokenId!=a.TokenID.ID&&!a.convertTokToID(this.tok,this.strictMode)){if(l)return this.reportParseError("Function declaration must include identifier"),this.nestingLevel=A,new a.IncompleteAST(t,this.scanner.pos)}else s=new a.Identifier(this.tok.getText()),s.minChar=this.scanner.startPos,s.limChar=this.scanner.pos,this.tok=this.scanner.scan();
else f&&(s=f);this.state=b.FncDeclName;var C=new a.ASTList,t=f=!1,x=a.hasFlag(e,a.Modifiers.Getter),D=a.hasFlag(e,a.Modifiers.Setter);if(this.tok.tokenId==a.TokenID.LParen||k&&this.tok.tokenId==a.TokenID.LBrack||h&&h.preProcessedLambdaArgs)f=this.parseFormalParameterList(d,C,!1,c,k,x,D,h?h.preProcessedLambdaArgs:null);this.state=b.FncDeclArgs;h=null;this.tok.tokenId==a.TokenID.Colon&&(this.tok=this.scanner.scan(),a.hasFlag(e,a.Modifiers.Setter)&&this.reportParseError("Property setters may not declare a return type"),
h=this.parseTypeReference(d,!0));k&&0==C.members.length&&this.reportParseError("Index signatures require a parameter type to be specified");this.state=b.FncDeclReturnType;if(l&&!this.parsingDeclareFile&&!n&&(!i||!this.ambientModule&&!this.ambientClass&&!this.inInterfaceDecl)&&this.tok.tokenId==a.TokenID.SColon)c=t=!0;l=this.inFncDecl;this.inFncDecl=!0;d=this.parseFunctionStatements(d|a.ErrorRecoverySet.RCurly,s,!1,i,C,a.AllowedElements.FunctionBody,v,c,a.Modifiers.None);this.inFncDecl=l;d.variableArgList=
f;d.isOverload=t;c||(d.fncFlags|=a.FncFlags.Definition);g&&(d.fncFlags|=a.FncFlags.Static);c&&(d.fncFlags|=a.FncFlags.Signature);k&&(d.fncFlags|=a.FncFlags.IndexerMember);d.returnTypeAnnotation=h;i&&(d.fncFlags|=a.FncFlags.Method,d.fncFlags|=a.FncFlags.ClassPropertyMethodExported);d.leftCurlyCount=this.scanner.leftCurlyCount-j;d.rightCurlyCount=this.scanner.rightCurlyCount-p;this.nestingLevel=A;this.parsingClassConstructorDefinition=r;return d};g.prototype.convertToTypeReference=function(d){var b;
switch(d.nodeType){case a.NodeType.TypeRef:return d;case a.NodeType.Name:return b=new a.TypeReference(d,0),b.minChar=d.minChar,b.limChar=d.limChar,b;case a.NodeType.Index:return(b=this.convertToTypeReference(d.operand1))?(b.arrayCount++,b.minChar=d.minChar,b.limChar=d.limChar,b):new a.AST(a.NodeType.Error)}return null};g.prototype.parseArgList=function(d){var b=new a.ASTList;b.minChar=this.scanner.startPos;this.tok=this.scanner.scan();if(this.tok.tokenId!==a.TokenID.RParen)for(;;){if(65535<b.members.length){this.reportParseError("max number of args exceeded");
break}var c=this.parseExpr(a.ErrorRecoverySet.Comma|d,a.OperatorPrecedence.Cma,!1,h.NoTypes);b.append(c);if(this.tok.tokenId!=a.TokenID.Comma)break;this.tok=this.scanner.scan()}b.limChar=this.scanner.pos;return b};g.prototype.parseBaseList=function(d,b,c,i,f){for(var k=!0,g=d;;){k&&(this.tok.tokenId==a.TokenID.IMPLEMENTS&&(i&&this.reportParseError("interfaces can not implement other types"),g=b),this.tok=this.scanner.scan(),k=!1);var n=null;if(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,
this.strictMode)){var e=this.scanner.startPos,n=new a.Identifier(this.tok.getText());n.minChar=e;n.limChar=this.scanner.pos;n=this.parseNamedType(c|a.ErrorRecoverySet.LCurly,e,n,!1)}else this.reportParseError("Expected base name"),this.errorRecovery&&(n=new a.MissingIdentifier,n.minChar=this.scanner.pos,n.limChar=this.scanner.pos,n.flags|=a.ASTFlags.Error);this.tok.tokenId==a.TokenID.LParen&&(f&&this.reportParseError("Base classes may only be initialized via a 'super' call within the constructor body"),
e=this.parseArgList(c|a.ErrorRecoverySet.RParen),n=new a.CallExpression(a.NodeType.Call,n,e),this.tok=this.scanner.scan(),n.limChar=this.scanner.pos);g.append(n);!i&&(g==d&&1<d.members.length)&&this.reportParseError("A class may only extend one other class");if(this.tok.tokenId==a.TokenID.Comma)this.tok=this.scanner.scan();else if(this.tok.tokenId==a.TokenID.EXTENDS||this.tok.tokenId==a.TokenID.IMPLEMENTS)g=d,k=!0;else break}};g.prototype.parseClassDecl=function(d,b,c){var b=this.scanner.leftCurlyCount,
i=this.scanner.rightCurlyCount;(c&a.Modifiers.Readonly)!=a.Modifiers.None&&this.reportParseError("const modifier is implicit for class");if(this.parsingDeclareFile||this.ambientModule)c|=a.Modifiers.Ambient,c|=a.Modifiers.Exported;var f=this.ambientClass;this.ambientClass=this.parsingDeclareFile||(c&a.Modifiers.Ambient)!=a.Modifiers.None;this.tok=this.scanner.scan();var k=null;this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)?(k=new a.Identifier(this.tok.getText()),k.minChar=
this.scanner.startPos,k.limChar=this.scanner.pos,this.tok=this.scanner.scan()):(this.reportParseError("class missing name"),this.errorRecovery&&(k=new a.MissingIdentifier,k.minChar=this.scanner.pos,k.limChar=this.scanner.pos,k.flags|=a.ASTFlags.Error));var g=null,n=null;if(this.tok.tokenId==a.TokenID.EXTENDS||this.tok.tokenId==a.TokenID.IMPLEMENTS)g=new a.ASTList,n=new a.ASTList,this.parseBaseList(g,n,d,!1,!0);this.currentClassDefinition=k=new a.ClassDecl(k,new a.ASTList,g,n);this.parseClassElements(k,
d,c);if(this.ambientModule||this.parsingDeclareFile||a.hasFlag(c,a.Modifiers.Exported))k.varFlags|=a.VarFlags.Exported;if(this.ambientModule||a.hasFlag(c,a.Modifiers.Ambient))k.varFlags|=a.VarFlags.Ambient;k.varFlags|=a.VarFlags.Class;this.ambientClass=f;k.leftCurlyCount=this.scanner.leftCurlyCount-b;k.rightCurlyCount=this.scanner.rightCurlyCount-i;return k};g.prototype.parseClassElements=function(d,b,c){var i=c,f=!1,d=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",b);this.nestingLevel++;
for(var k=this.scanner.startPos,g=!1;!(this.tok.tokenId==a.TokenID.RCurly||this.tok.tokenId==a.TokenID.EOF);){var n=!0,e=a.Modifiers.Public|a.Modifiers.Private;this.tok.tokenId==a.TokenID.GET?(i&a.Modifiers.Getter&&this.reportParseError("Duplicate 'get' declaration in class body"),i&a.Modifiers.Setter&&this.reportParseError("Getter already marked as a setter"),i|=a.Modifiers.Getter):this.tok.tokenId==a.TokenID.SET?(i&a.Modifiers.Setter&&this.reportParseError("Duplicate 'set' declaration in class body"),
i&a.Modifiers.Getter&&this.reportParseError("Setter already marked as a getter"),i|=a.Modifiers.Setter):this.tok.tokenId==a.TokenID.PRIVATE?(i&e&&this.reportParseError("Multiple modifiers may not be applied to class members"),i|=a.Modifiers.Private):this.tok.tokenId==a.TokenID.PUBLIC?(i&e&&this.reportParseError("Multiple modifiers may not be applied to class members"),i|=a.Modifiers.Public):this.tok.tokenId==a.TokenID.STATIC?(i&a.Modifiers.Static&&this.reportParseError("Multiple modifiers may not be applied to class members"),
i|=a.Modifiers.Static):this.tok.tokenId==a.TokenID.CONSTRUCTOR?(i!=c&&this.reportParseError("Constructors may not have modifiers"),this.parseClassConstructorDeclaration(k,b,i),n=!1,f=!0):g||this.tok.tokenId==a.TokenID.ID||a.convertTokToIDName(this.tok)?(f=g?i&a.Modifiers.Getter?"get":"set":this.tok.getText(),f=new a.Identifier(f),f.minChar=this.scanner.startPos,f.limChar=this.scanner.pos,g?(i^=i&a.Modifiers.Getter?a.Modifiers.Getter:a.Modifiers.Setter,g=!1):this.tok=this.scanner.scan(),this.tok.tokenId==
a.TokenID.LParen?(this.parseClassMemberFunctionDeclaration(f,k,b,i),n=!1):((i&a.Modifiers.Getter||i&a.Modifiers.Setter)&&this.reportParseError("Property accessors must be functions"),f=this.parseClassMemberVariableDeclaration(f,k,!1,b,i),f.init&&f.init.nodeType==a.NodeType.FuncDecl?this.tok.tokenId==a.TokenID.RCurly&&(n=!1):f.init&&f.init.nodeType==a.NodeType.ObjectLit&&this.tok.tokenId!=a.TokenID.SColon?(n=!1,f.init.flags|=a.ASTFlags.AutomaticSemicolon):this.tok.tokenId!=a.TokenID.SColon&&(this.reportParseError("Expected ';'"),
n=!1)),f=!0):this.tok.tokenId==a.TokenID.SUPER?this.reportParseError("Base class initializers must be the first statement in a class definition"):!g&&(i&a.Modifiers.Getter||i&a.Modifiers.Setter)&&this.tok.tokenId==a.TokenID.LParen||this.tok.tokenId==a.TokenID.Asg?(g=!0,n=!1):this.tok.tokenId!=a.TokenID.SColon&&(this.reportParseError("Unexpected '"+this.tok.getText()+"' in class definition"),f=!0);n&&(this.tok=this.scanner.scan());f&&(i=c,k=this.scanner.startPos,f=!1)}b=this.scanner.pos;this.tok.tokenId==
a.TokenID.RCurly&&(this.currentClassDefinition.definitionMembers.members.length||(this.currentClassDefinition.preComments=this.parseComments()),this.tok=this.scanner.scan());this.nestingLevel--;this.currentClassDefinition.members.minChar=d;this.currentClassDefinition.members.limChar=b;this.currentClassDefinition.limChar=b;this.currentClassDefinition=null};g.prototype.parseClassConstructorDeclaration=function(d,b,c){this.parsingClassConstructorDefinition=!0;var i=this.parsingDeclareFile||a.hasFlag(c,
a.Modifiers.Ambient),f=new a.ASTList,k=!1,g=this.parseComments();this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.LParen&&(k=this.parseFormalParameterList(b,f,!0,i,!1,!1,!1,null));var n=i||this.tok.tokenId==a.TokenID.SColon;if(n)for(var e=0;e<f.members.length;e++)a.hasFlag(f.members[e].varFlags,a.VarFlags.Property)&&this.reportParseError("Overload or ambient signatures may not specify parameter properties");n||(this.currentClassDefinition.constructorNestingLevel=this.nestingLevel+1);d=this.parseFunctionStatements(b|
a.ErrorRecoverySet.RCurly,this.currentClassDefinition.name,!0,!1,f,a.AllowedElements.ClassMembers,d,n,c);d.preComments=g;n&&!i&&(d.isOverload=!0);d.variableArgList=k;this.currentClassDecl=null;d.returnTypeAnnotation=this.convertToTypeReference(this.currentClassDefinition.name);d.classDecl=this.currentClassDefinition;i&&(d.fncFlags|=a.FncFlags.Ambient);n&&(d.fncFlags|=a.FncFlags.Signature);if(this.ambientModule||a.hasFlag(c,a.Modifiers.Exported))d.fncFlags|=a.FncFlags.Exported;this.currentClassDefinition.constructorDecl&&
!i&&(!this.currentClassDefinition.constructorDecl.isSignature()&&!d.isSignature())&&this.reportParseError("Duplicate constructor definition");if(i||!d.isSignature())this.currentClassDefinition.constructorDecl=d;d.fncFlags|=a.FncFlags.ClassMethod;this.currentClassDefinition.definitionMembers.members[this.currentClassDefinition.definitionMembers.members.length]=d;this.parsingClassConstructorDefinition=!1;d.postComments=this.parseComments();return d};g.prototype.parseClassMemberVariableDeclaration=function(d,
b,c,i,f){var k=new a.VarDecl(d,this.nestingLevel);k.minChar=b;b=!1;k.preComments=this.parseComments();this.tok.tokenId==a.TokenID.Colon&&(this.tok=this.scanner.scan(),k.typeExpr=this.parseTypeReference(i|a.ErrorRecoverySet.Asg|a.ErrorRecoverySet.Comma,!1));if(this.tok.tokenId==a.TokenID.Asg){if(this.parsingDeclareFile||a.hasFlag(f,a.Modifiers.Ambient))if(this.reportParseError("context does not permit variable initializer"),this.errorRecovery)return this.skip(i),k.flags|=a.ASTFlags.Error,k.limChar=
this.scanner.lastTokenLimChar(),k;this.tok=this.scanner.scan();k.init=this.parseExpr(a.ErrorRecoverySet.Comma|i,a.OperatorPrecedence.Cma,!0,h.NoTypes);k.limChar=k.init.limChar;this.currentClassDefinition.varFlags|=a.VarFlags.ClassSuperMustBeFirstCallInConstructor}else k.limChar=this.scanner.pos;f&a.Modifiers.Static&&(k.varFlags|=a.VarFlags.Static,b=!0);k.varFlags=(f&a.Modifiers.Private)!=a.Modifiers.None?k.varFlags|a.VarFlags.Private:k.varFlags|a.VarFlags.Public;k.varFlags|=a.VarFlags.Property;c&&
(k.varFlags|=a.VarFlags.ClassConstructorProperty);!c&&!b&&(k.varFlags|=a.VarFlags.ClassBodyProperty);this.currentClassDefinition.knownMemberNames[d.text]=!0;c||(this.currentClassDefinition.definitionMembers.members[this.currentClassDefinition.definitionMembers.members.length]=k);this.currentClassDefinition.allMemberDefinitions.members[this.currentClassDefinition.allMemberDefinitions.members.length]=k;k.postComments=this.parseComments();return k};g.prototype.parseClassMemberFunctionDeclaration=function(d,
b,c,i){var f=a.hasFlag(i,a.Modifiers.Getter)||a.hasFlag(i,a.Modifiers.Setter),k=a.hasFlag(i,a.Modifiers.Static),g=this.ambientModule||a.hasFlag(i,a.Modifiers.Ambient),c=c|a.ErrorRecoverySet.RParen,n=this.parseComments();f&&i&a.Modifiers.Ambient&&this.reportParseError("Property accessors may not be declared in ambient classes");c=this.parseFncDecl(c,!0,g,!0,d,!1,k,g,i,null);if(c.nodeType==a.NodeType.Error)return c;c.preComments=n;c.minChar=b;null!==c.bod&&(c.limChar=c.bod.limChar);c.fncFlags=i&a.Modifiers.Private?
...
!0;this.currentClassDefinition.definitionMembers.members[this.currentClassDefinition.definitionMembers.members.length]=c;c.postComments=this.parseComments();return c};g.prototype.parseInterfaceMember=function(d){var b=this.scanner.startPos,c=this.parsePropertyDecl(d,a.Modifiers.Public,!0,!1);c.nodeType==a.NodeType.VarDecl&&this.chkCurTok(a.TokenID.SColon,"Expected ';'",d);c&&(c.minChar=b);return c};g.prototype.parseInterfaceMembers=function(d,b){for(;;){switch(this.tok.tokenId){case a.TokenID.RCurly:case a.TokenID.EOF:b.limChar=
this.scanner.pos;return}var c=this.parseInterfaceMember(d|a.ErrorRecoverySet.TypeScriptS);c&&b.append(c)}};g.prototype.parseInterfaceDecl=function(d,b){var c=this.scanner.leftCurlyCount,i=this.scanner.rightCurlyCount;this.tok=this.scanner.scan();var f=null;this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)?(f=new a.Identifier(this.tok.getText()),f.minChar=this.scanner.startPos,f.limChar=this.scanner.pos,this.tok=this.scanner.scan()):(this.reportParseError("interface missing name"),
this.errorRecovery&&(f=new a.MissingIdentifier,f.minChar=this.scanner.pos,f.limChar=this.scanner.pos,f.flags|=a.ASTFlags.Error));var k=null;this.tok.tokenId==a.TokenID.EXTENDS&&(k=new a.ASTList,k.minChar=this.scanner.startPos,this.parseBaseList(k,null,d,!0,!1));var g=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",d|a.ErrorRecoverySet.TypeScriptS);var n=new a.ASTList;n.minChar=g;g=this.inInterfaceDecl;this.inInterfaceDecl=!0;this.parseInterfaceMembers(d|a.ErrorRecoverySet.RCurly,
n);this.inInterfaceDecl=g;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);f=new a.TypeDecl(a.NodeType.Interface,f,n,null,k,null);a.hasFlag(b,a.Modifiers.Private)&&(f.varFlags|=a.VarFlags.Private);a.hasFlag(b,a.Modifiers.Public)&&(f.varFlags|=a.VarFlags.Public);if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Exported))f.varFlags|=a.VarFlags.Exported;f.leftCurlyCount=this.scanner.leftCurlyCount-c;f.rightCurlyCount=this.scanner.rightCurlyCount-i;return f};g.prototype.makeVarDecl=function(d,b){var c=
new a.VarDecl(d,b),i=this.topVarList();i&&i.append(c);return c};g.prototype.parsePropertyDecl=function(d,b,c,i){var f=null,k=this.scanner.startPos,g=k,n=!1,e=!1,j=null!=this.prevIDTok,q=a.hasFlag(b,a.Modifiers.Getter)||a.hasFlag(b,a.Modifiers.Setter);if(this.parsingDeclareFile||this.ambientModule||a.hasFlag(b,a.Modifiers.Ambient))c=!0;if(this.tok.tokenId==a.TokenID.LParen&&!j)!c&&!i&&(this.reportParseError("Expected identifier in property declaration"),this.errorRecovery&&(this.skip(d),f=new a.MissingIdentifier));
else if(this.tok.tokenId==a.TokenID.NEW)c&&(this.tok=this.scanner.scan(),this.tok.tokenId==a.TokenID.LParen&&(n=!0)),n||(c||(this.tok=this.scanner.scan()),f=new a.Identifier("new"),f.minChar=this.scanner.pos-3,g=f.limChar=this.scanner.pos);else if(this.tok.tokenId==a.TokenID.LBrack&&c)e=!0,f=new a.Identifier("__item");else if(this.tok.tokenId!=a.TokenID.ID&&!a.convertTokToIDName(this.tok)&&!j){if(this.reportParseError("Expected identifier in property declaration"),this.errorRecovery)return b=this.scanner.startPos,
i=this.scanner.pos,this.skip(d&~a.ErrorRecoverySet.Comma),this.scanner.pos==i&&(this.tok=this.scanner.scan()),d=new a.VarDecl(new a.MissingIdentifier,this.nestingLevel),d.flags|=a.ASTFlags.Error,d.minChar=b,d.limChar=this.scanner.lastTokenLimChar(),d}else j?(f=new a.Identifier(this.prevIDTok.getText()),f.minChar=this.scanner.lastTokenLimChar()-3,f.limChar=this.scanner.lastTokenLimChar(),g=f.limChar,a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("Property accessors are only available when targeting ES5 or greater"),
this.tok.getText()==f.text&&this.tok!=this.prevIDTok&&(this.tok=this.scanner.scan()),this.prevIDTok=null):(f=new a.Identifier(this.tok.getText()),f.minChar=this.scanner.startPos,g=f.limChar=this.scanner.pos,this.tok=this.scanner.scan());this.tok.tokenId==a.TokenID.QMark&&(this.inInterfaceDecl&&f?f.flags|=a.ASTFlags.OptionalName:this.reportParseError("Optional properties may only be declared on interface or object types"),this.tok=this.scanner.scan());if(this.tok.tokenId==a.TokenID.LParen||e&&this.tok.tokenId==
a.TokenID.LBrack){j=d|a.ErrorRecoverySet.RParen;e&&(j=d|a.ErrorRecoverySet.RBrack);d=this.parseFncDecl(j,!0,c,!this.inFncDecl,f,e,i,this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Ambient),b,null);if(d.nodeType==a.NodeType.Error)return d;d.name&&(d.name.minChar=k,d.name.limChar=g);(b&a.Modifiers.Public)!=a.Modifiers.None&&(d.fncFlags|=a.FncFlags.Public);(b&a.Modifiers.Private)!=a.Modifiers.None&&(d.fncFlags|=a.FncFlags.Private);i&&(d.fncFlags|=a.FncFlags.Static);if(this.parsingDeclareFile||a.hasFlag(b,
a.Modifiers.Ambient))d.fncFlags|=a.FncFlags.Ambient;q&&(a.hasFlag(b,a.Modifiers.Getter)?(d.fncFlags|=a.FncFlags.GetAccessor,d.hint="get"+d.name.text):(d.fncFlags|=a.FncFlags.SetAccessor,d.hint="set"+d.name.text),d.fncFlags|=a.FncFlags.IsFunctionExpression,b&a.Modifiers.Ambient&&this.reportParseError("Property accessors may not be declared in ambient types"));null==f&&(n?(d.fncFlags|=a.FncFlags.ConstructMember,d.hint="_construct",d.classDecl=this.currentClassDecl):(d.hint="_call",d.fncFlags|=a.FncFlags.CallMember));
return d}f=new a.VarDecl(f,this.nestingLevel);f.minChar=k;this.tok.tokenId==a.TokenID.Colon&&(this.tok=this.scanner.scan(),f.typeExpr=this.parseTypeReference(d|a.ErrorRecoverySet.Asg|a.ErrorRecoverySet.Comma,!1));if(this.tok.tokenId==a.TokenID.Asg){if(c&&(this.reportParseError("context does not permit variable initializer"),this.errorRecovery))return this.skip(d),f.flags|=a.ASTFlags.Error,f.limChar=this.scanner.lastTokenLimChar(),f;this.tok=this.scanner.scan();f.init=this.parseExpr(a.ErrorRecoverySet.Comma|
d,a.OperatorPrecedence.Cma,!0,h.NoTypes);f.limChar=f.init.limChar;f.init.nodeType==a.NodeType.FuncDecl?(d=f.init,d.hint=f.id.text,d.boundToProperty=f):q&&this.reportParseError("Accessors may only be functions")}else f.limChar=this.scanner.pos;(b&a.Modifiers.Readonly)!=a.Modifiers.None&&(f.varFlags|=a.VarFlags.Readonly);i&&(f.varFlags|=a.VarFlags.Static);(b&a.Modifiers.Public)!=a.Modifiers.None&&(f.varFlags|=a.VarFlags.Public);(b&a.Modifiers.Private)!=a.Modifiers.None&&(f.varFlags|=a.VarFlags.Private);
f.varFlags|=a.VarFlags.Property;return f};g.prototype.parseVarDecl=function(d,b,c,i,f){var k=a.hasFlag(b,a.Modifiers.Readonly),g=this.scanner.startPos;this.tok=this.scanner.scan();for(var n=null,e=null,j=!1,q=this.parseComments();;){if(this.tok.tokenId!=a.TokenID.ID&&!a.convertTokToID(this.tok,this.strictMode)&&(this.reportParseError("Expected identifier in variable declaration"),this.errorRecovery))return n=new a.VarDecl(new a.MissingIdentifier,this.nestingLevel),n.minChar=g,this.skip(d),n.flags|=
a.ASTFlags.Error,n.limChar=this.scanner.lastTokenLimChar(),n;n=this.tok.getText();this.strictMode&&"eval"==n&&this.reportParseError("can not name a variable eval in strict mode");n=this.makeVarDecl(new a.Identifier(n),this.nestingLevel);n.id.minChar=this.scanner.startPos;n.id.limChar=this.scanner.pos;n.preComments=q;f&&(n.varFlags|=a.VarFlags.Static);a.hasFlag(b,a.Modifiers.Readonly)&&(n.varFlags|=a.VarFlags.Readonly);if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Ambient))n.varFlags|=a.VarFlags.Ambient;
if(this.parsingDeclareFile||a.hasFlag(b,a.Modifiers.Exported))n.varFlags|=a.VarFlags.Exported;n.minChar=g;e&&e.append(n);this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.Colon&&(this.tok=this.scanner.scan(),g=this.inFncDecl,this.inFncDecl=!1,n.typeExpr=this.parseTypeReference(d|a.ErrorRecoverySet.Asg|a.ErrorRecoverySet.Comma,!1),this.inFncDecl=g);if(this.tok.tokenId==a.TokenID.Asg){if(i&&(this.reportParseError("context does not permit variable initializer"),this.errorRecovery))return this.skip(d),
n.flags|=a.ASTFlags.Error,n;this.tok=this.scanner.scan();n.init=this.parseExpr(a.ErrorRecoverySet.Comma|d,a.OperatorPrecedence.Cma,c,h.NoTypes);n.limChar=n.init.limChar;n.init.nodeType==a.NodeType.FuncDecl&&(n.init.hint=n.id.text)}else k&&this.reportParseError("const declaration requires initializer"),n.limChar=this.scanner.pos;n.postComments=this.parseCommentsForLine(this.scanner.line);if(this.tok.tokenId!=a.TokenID.Comma)return e?(e.limChar=n.limChar,e):n;j||(e=new a.ASTList,e.minChar=n.minChar,
e.append(n),j=!0);this.tok=this.scanner.scan();g=this.scanner.startPos}};g.prototype.parseMemberList=function(d){var b=new a.ASTList;if(this.tok.tokenId==a.TokenID.RCurly)return b;for(var c=null,i=null,f=null,k=null,g=this.scanner.startPos,e=!1,m=!1,f=null,j=0,q=0;;){var p=!1;this.tok.tokenId==a.TokenID.GET||this.tok.tokenId==a.TokenID.SET?(e=this.tok.tokenId==a.TokenID.SET,f=this.tok,j=this.scanner.startPos,q=this.scanner.pos,this.tok=this.scanner.scan(),this.tok.tokenId==a.TokenID.ID||a.convertTokToIDName(this.tok)?
(c=e?"set":"get",c+=this.tok.getText(),i=new a.Identifier(this.tok.getText()),i.minChar=this.scanner.startPos,p=!0,a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("Property accessors are only available when targeting ES5 or greater")):this.tok.tokenId!=a.TokenID.Colon?this.reportParseError("Expected identifier, string or number as accessor name"):(m=!0,i=new a.Identifier(f.getText()),i.minChar=j,i.limChar=q)):this.tok.tokenId==a.TokenID.ID||a.convertTokToIDName(this.tok)?(c=this.tok.getText(),
...
i.minChar=this.scanner.startPos,i.flags|=a.ASTFlags.Error,this.skip(d|a.ErrorRecoverySet.Comma),i.limChar=this.scanner.lastTokenLimChar()));m?m=!1:this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.QMark&&(i.flags|=a.ASTFlags.OptionalName,this.tok=this.scanner.scan());if(p)k=new a.ASTList,this.parseFormalParameterList(d|a.ErrorRecoverySet.RParen,k,!1,!0,!1,!e,e,null),f=this.parseFunctionStatements(d|a.ErrorRecoverySet.RCurly,i,!1,!0,k,a.AllowedElements.FunctionDecls,this.scanner.startPos,!1,
a.Modifiers.None),e&&f.returnTypeAnnotation&&this.reportParseError("Property setters may not declare a return type"),f.fncFlags|=e?a.FncFlags.SetAccessor:a.FncFlags.GetAccessor,f.fncFlags|=a.FncFlags.IsFunctionExpression,f.hint=c,k=new a.BinaryExpression(a.NodeType.Member,i,f),k.minChar=i.minChar,f.nodeType==a.NodeType.FuncDecl&&(f.hint=c);else if(this.tok.tokenId==a.TokenID.Colon)this.tok=this.scanner.scan(),f=this.parseExpr(a.ErrorRecoverySet.Comma|d,a.OperatorPrecedence.Cma,!0,h.NoTypes),f.nodeType==
a.NodeType.TypeRef&&this.reportParseError("Expected 'new' on array declaration in member definition"),k=new a.BinaryExpression(a.NodeType.Member,i,f),k.minChar=i.minChar,f.nodeType==a.NodeType.FuncDecl&&(f.hint=c);else if(this.reportParseError("Expected ':' in member definition"),this.errorRecovery)return this.skip(d),b.flags|=a.ASTFlags.Error,b.minChar=g,b.limChar=this.scanner.lastTokenLimChar(),b;c=null;b.append(k);k.limChar=this.scanner.lastTokenLimChar();if(this.tok.tokenId!=a.TokenID.Comma)break;
else this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.RCurly)break}k&&(b.limChar=k.limChar);b.minChar=g;return b};g.prototype.parseArrayList=function(d){var b=null;if(this.tok.tokenId==a.TokenID.RBrack)return b;b=new a.ASTList;b.minChar=this.scanner.startPos;for(var c;;){c=this.tok.tokenId==a.TokenID.Comma||this.tok.tokenId==a.TokenID.RBrack?new a.AST(a.NodeType.EmptyExpr):this.parseExpr(a.ErrorRecoverySet.Comma|d,a.OperatorPrecedence.Cma,!0,h.NoTypes);b.append(c);if(this.tok.tokenId!=
a.TokenID.Comma)break;this.tok=this.scanner.scan()}b.limChar=this.scanner.lastTokenLimChar();return b};g.prototype.parseArrayLiteral=function(d){var b=null;return b=new a.UnaryExpression(a.NodeType.ArrayLit,this.parseArrayList(d))};g.prototype.parseTerm=function(d,b,c,i){var f=null,k=!1,g=!1,e=this.scanner.startPos,m=this.scanner.pos,j=!1;switch(this.tok.tokenId){case a.TokenID.NUMBER:case a.TokenID.BOOL:case a.TokenID.ANY:case a.TokenID.STRING:k=new a.Identifier(a.tokenTable[this.tok.tokenId].text);
f=a.hasFlag(c,h.Primitive)?new a.TypeReference(k,0):k;k=!0;f.minChar=e;this.tok=this.scanner.scan();m=this.scanner.lastTokenLimChar();break;case a.TokenID.THIS:f=new a.AST(a.NodeType.This);f.minChar=e;this.tok=this.scanner.scan();m=this.scanner.lastTokenLimChar();break;case a.TokenID.SUPER:f=new a.AST(a.NodeType.Super);f.minChar=e;this.tok=this.scanner.scan();m=this.scanner.lastTokenLimChar();break;case a.TokenID.TRUE:f=new a.AST(a.NodeType.True);this.tok=this.scanner.scan();f.minChar=e;break;case a.TokenID.FALSE:f=
new a.AST(a.NodeType.False);this.tok=this.scanner.scan();f.minChar=e;break;case a.TokenID.NULL:f=new a.AST(a.NodeType.Null);this.tok=this.scanner.scan();f.minChar=e;break;case a.TokenID.NEW:e=this.scanner.pos;this.tok=this.scanner.scan();f=new a.CallExpression(a.NodeType.New,this.parseTerm(d,!1,h.AllSimpleTypes,i),null);f.minChar=e;m=this.scanner.lastTokenLimChar();g=!0;break;case a.TokenID.FUNCTION:e=this.scanner.pos,f=this.parseFncDecl(d,!1,!1,!1,null,!1,!1,!1,a.Modifiers.None,null),f.fncFlags|=
a.FncFlags.IsFunctionExpression,f.minChar=e,m=this.scanner.lastTokenLimChar(),f.limChar=m}if(null==f&&(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)))k=this.tok.getText(),f=this.createRef(k,e),k=!0,f.minChar=e,this.tok=this.scanner.scan(),this.tok.tokenId==a.TokenID.QMark?f.flags|=a.ASTFlags.PossibleOptionalParameter:this.tok.tokenId==a.TokenID.Arrow&&(j=!0),m=this.scanner.lastTokenLimChar();i&&this.chkCurTok(a.TokenID.GT,"Expected '>'",d);if(null==f)switch(this.tok.tokenId){case a.TokenID.LParen:e=
this.scanner.pos;j=this.scanner.previousToken().tokenId;this.tok=this.scanner.scan();(j=j==a.TokenID.LParen||j==a.TokenID.Comma||j==a.TokenID.EQ||j==a.TokenID.Colon)&&this.tok.tokenId==a.TokenID.RParen?(j=!0,this.tok=this.scanner.scan()):(f=this.parseExpr(d|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes),m=this.scanner.lastTokenLimChar(),j=j&&(f.nodeType==a.NodeType.Name||f.nodeType==a.NodeType.Comma)&&(this.tok.tokenId==a.TokenID.Colon||this.tok.tokenId==a.TokenID.QMark));f&&!j&&
(this.chkCurTok(a.TokenID.RParen,"Expected ')'",d),f.isParenthesized=!0);break;case a.TokenID.NumberLit:m=this.tok;this.tok=this.scanner.scan();f=new a.NumberLiteral(m.value);f.minChar=e;m=this.scanner.lastTokenLimChar();break;case a.TokenID.QString:f=new a.StringLiteral(this.tok.getText());this.tok=this.scanner.scan();f.minChar=e;m=this.scanner.lastTokenLimChar();break;case a.TokenID.Regex:f=new a.RegexLiteral(this.tok.regex);this.tok=this.scanner.scan();f.minChar=e;m=this.scanner.lastTokenLimChar();
break;case a.TokenID.LBrack:e=this.scanner.startPos;this.tok=this.scanner.scan();f=this.parseArrayLiteral(a.ErrorRecoverySet.RBrack|d);f.minChar=e;m=this.scanner.pos;this.chkCurTok(a.TokenID.RBrack,"Expected ']'",d);break;case a.TokenID.LCurly:e=this.scanner.startPos;this.tok=this.scanner.scan();i=this.parseMemberList(a.ErrorRecoverySet.RCurly|d);this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);f=new a.UnaryExpression(a.NodeType.ObjectLit,i);f.minChar=e;m=this.scanner.lastTokenLimChar();i.minChar=
e;i.limChar=m;break;case a.TokenID.LT:e=this.scanner.startPos;this.tok=this.scanner.scan();i=this.parseTypeReference(a.ErrorRecoverySet.BinOp,!1);this.chkCurTok(a.TokenID.GT,"Expected '>'",d);f=new a.UnaryExpression(a.NodeType.TypeAssertion,this.parseExpr(d,a.OperatorPrecedence.Uni,!1,h.NoTypes));f.castTerm=i;break;default:if(this.prevExpr&&a.hasFlag(this.prevExpr.flags,a.ASTFlags.PossibleOptionalParameter))j=!0,f=this.prevExpr;else if(this.reportParseError("Check format of expression term"),this.errorRecovery){f=
new a.MissingIdentifier;f.minChar=e;f.flags|=a.ASTFlags.Error;this.skip(d|a.ErrorRecoverySet.Postfix);if(this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode))f.text=this.tok.getText(),this.tok=this.scanner.scan();m=this.scanner.lastTokenLimChar()}}j&&(this.tok.tokenId==a.TokenID.Arrow||this.tok.tokenId==a.TokenID.Colon||this.tok.tokenId==a.TokenID.Comma||this.tok.tokenId==a.TokenID.RParen?(f=this.parseFncDecl(d,!1,!1,!1,null,!1,!1,!1,a.Modifiers.None,{preProcessedLambdaArgs:f}),
f.fncFlags|=a.FncFlags.IsFunctionExpression,f.fncFlags|=a.FncFlags.IsFatArrowFunction,f.minChar=e,m=this.scanner.lastTokenLimChar(),f.limChar=m):f&&(f.isParenthesized=!0));k&&c!=h.NoTypes&&(c|=h.ArraySuffix);return(d=this.parsePostfixOperators(d,f,b,g,c,e,m))?(k&&d.nodeType==a.NodeType.Index&&null==d.operand2&&(d=this.convertToTypeReference(d)),d.minChar=e,d.limChar=a.max(d.limChar,this.scanner.lastTokenLimChar()),d):new a.AST(a.NodeType.Error)};g.prototype.parseExpr=function(d,b,c,i){var f=null,
k=a.lookupToken(this.tok.tokenId),e=!0,g=null,m=this.scanner.startPos,j=this.parseComments(),q=!1;if(void 0!=k&&k.unopNodeType!=a.NodeType.None)e=!1,this.tok=this.scanner.scan(),i=this.parseExpr(a.ErrorRecoverySet.BinOp|d,k.unopPrecedence,c,h.NoTypes),k.unopNodeType==a.NodeType.Pos&&i.nodeType==a.NodeType.NumberLit?f=i:k.unopNodeType==a.NodeType.Neg&&i.nodeType==a.NodeType.NumberLit?(i.value=-i.value,0==i.value&&(i.isNegativeZero=!0),f=i):(f=new a.UnaryExpression(k.unopNodeType,i),f.limChar=i.limChar),
f.minChar=m;else{f=this.parseTerm(a.ErrorRecoverySet.BinOp|a.ErrorRecoverySet.AddOp|d,!0,i,!1);if(f.nodeType==a.NodeType.Name)g=f.text;else if(f.nodeType==a.NodeType.Dot){k=!1;if(this.inferPropertiesFromThisAssignment&&((this.tok.tokenId==a.TokenID.Colon||this.tok.tokenId==a.TokenID.Asg)&&this.parsingClassConstructorDefinition&&this.nestingLevel==this.currentClassDefinition.constructorNestingLevel&&f.operand1.nodeType==a.NodeType.This)&&f.operand2.nodeType==a.NodeType.Name)i=f.operand2,this.currentClassDefinition.knownMemberNames[i.text]||
(f=this.parseClassMemberVariableDeclaration(i,f.minChar,!0,d,a.Modifiers.Public),k=!0);if(!k){for(k=f;k.nodeType==a.NodeType.Dot;)k=k.operand2;k.nodeType==a.NodeType.Name&&(g=k.text)}}if(!this.scanner.lastTokenHadNewline()&&(this.tok.tokenId==a.TokenID.Inc||this.tok.tokenId==a.TokenID.Dec))e=!1,k=f,f=new a.UnaryExpression(this.tok.tokenId==a.TokenID.Inc?a.NodeType.IncPost:a.NodeType.DecPost,k),f.limChar=this.scanner.pos,f.minChar=k.minChar,this.tok=this.scanner.scan()}for(;;){k=a.lookupToken(this.tok.tokenId);
if(void 0==k||k.binopNodeType==a.NodeType.None)break;if(!c&&k.binopNodeType==a.NodeType.In)break;if(k.binopPrecedence==a.OperatorPrecedence.Asg){if(k.binopPrecedence<b)break;e||this.reportParseError("illegal assignment")}else if(k.binopPrecedence<=b)break;this.tok=this.scanner.scan();e=!1;k.binopNodeType==a.NodeType.QMark?(this.prevExpr=f,k=this.parseExpr(d|a.ErrorRecoverySet.Colon,a.OperatorPrecedence.Asg,c,h.NoTypes),this.prevExpr=null,k.nodeType==a.NodeType.FuncDecl&&a.hasFlag(k.fncFlags,a.FncFlags.IsFatArrowFunction)?
(f=k,q=!0):(this.chkCurTok(a.TokenID.Colon,"Expected :",d|a.ErrorRecoverySet.ExprStart),f=new a.TrinaryExpression(a.NodeType.QMark,f,k,this.parseExpr(d|a.ErrorRecoverySet.BinOp,a.OperatorPrecedence.Asg,c,h.NoTypes)))):(k=new a.BinaryExpression(k.binopNodeType,f,this.parseExpr(d|a.ErrorRecoverySet.BinOp,k.binopPrecedence,c,h.NoTypes)),k.operand2.nodeType==a.NodeType.FuncDecl&&(k.operand2.hint=g),k.minChar=f.minChar,k.limChar=this.scanner.lastTokenLimChar(),g=null,f=k)}e&&(f.flags|=a.ASTFlags.Writeable);
q||(f.minChar=m,f.limChar=a.max(f.limChar,this.scanner.lastTokenLimChar()),f.preComments=j,f.postComments=this.parseCommentsForLine(this.scanner.line));return f};g.prototype.parsePostfixOperators=function(d,b,c,i,f,k,e){b||(b=new a.AST(a.NodeType.EmptyExpr),b.isParenthesized=!0);b.minChar=k;for(b.limChar=e;;)switch(this.tok.tokenId){case a.TokenID.LParen:if(i)b.args=this.parseArgList(d),i=!1;else{if(!c)return b;b=new a.CallExpression(a.NodeType.Call,b,this.parseArgList(d));b.minChar=k}b.limChar=this.scanner.pos;
this.chkCurTok(a.TokenID.RParen,"Expected ')'",d);break;case a.TokenID.LBrack:this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.RBrack&&a.hasFlag(f,h.ArraySuffix)){this.tok=this.scanner.scan();b.nodeType==a.NodeType.TypeRef?b.arrayCount++:b=new a.BinaryExpression(a.NodeType.Index,b,null);b.limChar=this.scanner.pos;break}b=new a.BinaryExpression(a.NodeType.Index,b,this.parseExpr(d|a.ErrorRecoverySet.RBrack,a.OperatorPrecedence.No,!0,h.NoTypes));b.minChar=k;b.limChar=this.scanner.pos;this.chkCurTok(a.TokenID.RBrack,
"Expected ']'",d);break;case a.TokenID.Dot:e=null;this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.ID||!this.scanner.lastTokenHadNewline()&&a.convertTokToIDName(this.tok))b.flags|=a.ASTFlags.DotLHS,e=this.createRef(this.tok.getText(),this.scanner.startPos),e.limChar=this.scanner.pos,this.tok=this.scanner.scan();else{this.reportParseError("Expected identifier following dot");if(this.errorRecovery)return this.skip(d),b.flags|=a.ASTFlags.Error|a.ASTFlags.DotLHS,b;e=new a.MissingIdentifier}b=
new a.BinaryExpression(a.NodeType.Dot,b,e);b.minChar=k;b.limChar=this.scanner.lastTokenLimChar();break;case a.TokenID.Arrow:b=this.parseFncDecl(d,!1,!1,!1,null,!1,!1,!1,a.Modifiers.None,{preProcessedLambdaArgs:b});b.fncFlags|=a.FncFlags.IsFunctionExpression;b.minChar=k;b.limChar=this.scanner.lastTokenLimChar();break;default:return b}};g.prototype.parseTry=function(b,l,c,i){var f=this.scanner.startPos,k=this.parseComments();this.tok=this.scanner.scan();if(this.tok.tokenId!=a.TokenID.LCurly&&(this.reportParseError("Expected '{'"),
this.errorRecovery))return b.minChar=f,b.limChar=this.scanner.lastTokenLimChar(),b.flags|=a.ASTFlags.Error,b;b.body=this.parseStatement(l,c,i);b.minChar=f;b.limChar=b.body.limChar;b.preComments=k;b.postComments=this.parseComments();return b};g.prototype.parseCatch=function(b,l,c){var i=this.scanner.startPos,f=this.parseComments();this.tok=this.scanner.scan();this.chkCurTok(a.TokenID.LParen,"Expected '('",b|a.ErrorRecoverySet.ExprStart);if(this.tok.tokenId!=a.TokenID.ID||a.convertTokToID(this.tok,
this.strictMode))if(this.reportParseError("Expected identifier in catch header"),this.errorRecovery)return this.skip(b),i=new a.Catch(new a.VarDecl(new a.MissingIdentifier,this.nestingLevel),new a.Statement(a.NodeType.Empty)),i.minChar=this.scanner.startPos,i.limChar=this.scanner.pos,i.flags|=a.ASTFlags.Error,i;var k=new a.VarDecl(new a.Identifier(this.tok.getText()),this.nestingLevel);k.id.minChar=this.scanner.startPos;k.id.limChar=this.scanner.pos;k.minChar=k.id.minChar;k.limChar=k.id.limChar;this.tok=
this.scanner.scan();this.chkCurTok(a.TokenID.RParen,"Expected ')'",b|a.ErrorRecoverySet.StmtStart);if(this.tok.tokenId!=a.TokenID.LCurly&&(this.reportParseError("Expected '{' to start catch body"),this.errorRecovery))return this.skip(b),i=new a.Catch(new a.VarDecl(new a.MissingIdentifier,this.nestingLevel),new a.Statement(a.NodeType.Empty)),i.minChar=this.scanner.startPos,i.limChar=this.scanner.pos,i.flags|=a.ASTFlags.Error,i;b=this.parseStatement(b,l,c);k=new a.Catch(k,b);k.minChar=i;k.limChar=b.limChar;
k.preComments=f;k.postComments=this.parseComments();return k};g.prototype.parseFinally=function(b,l,c){var i=this.scanner.startPos,f=this.parseComments();this.tok=this.scanner.scan();if(this.tok.tokenId!=a.TokenID.LCurly&&(this.reportParseError("Expected '{' to start body of finally statement"),this.errorRecovery))return this.skip(b),i=new a.Finally(new a.Statement(a.NodeType.Empty)),i.flags|=a.ASTFlags.Error,i.minChar=this.scanner.startPos,i.limChar=this.scanner.pos,i;b=this.parseStatement(b,l,c);
b=new a.Finally(b);b.minChar=i;b.limChar=b.body.limChar;b.preComments=f;b.postComments=this.parseComments();return b};g.prototype.parseTryCatchFinally=function(b,l,c,i){var f=new a.Try(null),k=this.scanner.startPos;this.pushStmt(f,i);this.parseTry(f,b|a.ErrorRecoverySet.Catch,l,c);this.popStmt();var e=i=null;this.tok.tokenId==a.TokenID.CATCH&&(e=this.parseCatch(b|a.ErrorRecoverySet.Catch,l,c),i=new a.TryCatch(f,e),i.minChar=f.minChar,i.limChar=e.limChar);if(this.tok.tokenId!=a.TokenID.FINALLY)return null==
i?(this.reportParseError("try with neither catch nor finally"),this.errorRecovery?(f=new a.TryFinally(f,new a.Finally(new a.AST(a.NodeType.Empty))),f.flags|=a.ASTFlags.Error,f.minChar=this.scanner.startPos,f.limChar=this.scanner.pos,f):new a.TryFinally(f,new a.Finally(new a.AST(a.NodeType.Empty)))):i;i&&(f=i);b=this.parseFinally(b,l,c);e=new a.TryFinally(f,b);e.minChar=k;e.limChar=b.limChar;return e};g.prototype.parseStatement=function(d,l,c){function i(){return a.hasFlag(m,a.Modifiers.Ambient)||
a.hasFlag(c,a.Modifiers.Ambient)}function f(){a.hasFlag(m,a.Modifiers.Exported)&&this.reportError("Statement may not be exported")}var k=null,e=null,g,m=a.Modifiers.None,j=this.scanner.startPos,q=!1,p=!1;g=null;var r=this.parseComments();for(this.state=b.StartStatement;;){switch(this.tok.tokenId){case a.TokenID.EOF:k=new a.AST(a.NodeType.Error);k.minChar=j;k.limChar=this.scanner.pos;break;case a.TokenID.FUNCTION:this.inStaticFnc&&this.reportParseError("Ambient static function delarations may only contain other ambient static function declarations");
if(this.parsingDeclareFile||i()||this.ambientModule){this.tok=this.scanner.scan();g=this.parsePropertyDecl(d|a.ErrorRecoverySet.SColon,m,!0,!1);if(g.nodeType==a.NodeType.VarDecl)this.reportParseError("function keyword can only introduce function declaration");else if(g.nodeType==a.NodeType.FuncDecl&&(g.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;k=g}else k=this.parseFncDecl(d,!0,!1,!1,null,!1,!1,i(),m,null),a.hasFlag(k.fncFlags,a.FncFlags.IsFatArrowFunction)&&(p=!0),this.ambientModule&&this.reportParseError("function declaration not permitted within ambient module"),
a.hasFlag(m,a.Modifiers.Exported)&&(k.fncFlags|=a.FncFlags.Exported);break;case a.TokenID.MODULE:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None?(this.reportParseError("module not allowed in this context"),this.tok=this.scanner.scan(),k=new a.AST(a.NodeType.Error),k.minChar=j,k.limChar=this.scanner.lastTokenLimChar()):k=this.parseModuleDecl(d,m);break;case a.TokenID.IMPORT:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None?(this.reportParseError("module not allowed in this context"),
this.tok=this.scanner.scan(),k=new a.AST(a.NodeType.Error),k.minChar=j,k.limChar=this.scanner.lastTokenLimChar()):k=this.parseImportDecl(d,m);break;case a.TokenID.EXPORT:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None&&(this.reportParseError("'export' statements are only allowed at the global and module levels"),this.tok=this.scanner.scan(),k=new a.AST(a.NodeType.Error),k.minChar=j,k.limChar=this.scanner.lastTokenLimChar());this.topLevel&&(this.hasTopLevelImportOrExport=!0);m|=a.Modifiers.Exported;
...
this.strictMode)))m|=a.Modifiers.Setter,this.prevIDTok=null;g=this.parsePropertyDecl(d|a.ErrorRecoverySet.SColon,m,i(),!1);if(g.nodeType==a.NodeType.VarDecl||g.nodeType==a.NodeType.FuncDecl&&a.hasFlag(g.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;k=g}break;case a.TokenID.PUBLIC:if(this.parsingClassConstructorDefinition)this.inferPropertiesFromThisAssignment||this.reportParseError("Property declarations are not permitted within constructor bodies"),this.tok=this.scanner.scan(),j=this.scanner.pos,
...
this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)))m|=a.Modifiers.Setter;i()&&(m|=a.Modifiers.Ambient);g=this.parsePropertyDecl(d|a.ErrorRecoverySet.SColon,m,this.parsingDeclareFile||(m&a.Modifiers.Ambient)!=a.Modifiers.None,!0);(k=this.topStaticsList())&&g.nodeType==a.NodeType.VarDecl&&k.append(g);if(g.nodeType==a.NodeType.VarDecl||g.nodeType==a.NodeType.FuncDecl&&a.hasFlag(g.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;k=g;break;case a.TokenID.FOR:f();m!=a.Modifiers.None&&
this.reportParseError("syntax error: for statement does not take modifiers");j=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.ExprStart|a.ErrorRecoverySet.Var);this.state=b.ForInit;q=!0;switch(this.tok.tokenId){case a.TokenID.VAR:g=this.parseVarDecl(d|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.In,a.Modifiers.None,!1,!1,!1);break;case a.TokenID.SColon:g=null;this.state=b.ForCondStart;break;default:g=this.parseExpr(d|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.In,
a.OperatorPrecedence.No,!1,h.NoTypes)}this.state=b.ForInitAfterVar;this.tok.tokenId==a.TokenID.IN?null==g||!q?(this.reportParseError("malformed for statement"),this.errorRecovery&&(this.skip(d|a.ErrorRecoverySet.StmtStart),k=new a.AST(a.NodeType.Empty),k.flags|=a.ASTFlags.Error)):(this.tok=this.scanner.scan(),k=new a.ForInStatement(g,this.parseExpr(a.ErrorRecoverySet.RParen|d,a.OperatorPrecedence.Cma,!1,h.NoTypes)),k.limChar=this.scanner.pos,this.chkCurTok(a.TokenID.RParen,"Expected ')'",a.ErrorRecoverySet.StmtStart|
d),this.pushStmt(k,e),k.body=this.parseStatement(d,l,c),this.popStmt(),k.minChar=j):(g=new a.ForStatement(g),g.minChar=j,this.chkCurTok(a.TokenID.SColon,"Expected ';'",d),this.tok.tokenId==a.TokenID.SColon?g.cond=null:(g.cond=this.parseExpr(d|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes),this.tok.tokenId!=a.TokenID.SColon&&(this.skip(d|a.ErrorRecoverySet.StmtStart),k=g,k.flags|=a.ASTFlags.Error)),this.tok=this.scanner.scan(),g.incr=this.tok.tokenId==a.TokenID.RParen?
null:this.parseExpr(d|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes),this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.LCurly),this.pushStmt(g,e),g.body=this.parseStatement(d,l,c),this.popStmt(),g.limChar=g.body.limChar,k=g);break;case a.TokenID.WITH:a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("'with' statements are only available in ES5 codegen mode or better");this.strictMode&&this.reportParseError("'with' statements are not available in strict mode");
f();m!=a.Modifiers.None&&this.reportParseError("'with' statement does not take modifiers");j=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.ExprStart|a.ErrorRecoverySet.Var);k=this.parseExpr(d|a.ErrorRecoverySet.Colon,a.OperatorPrecedence.No,!0,h.NoTypes);this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.LCurly);k=new a.WithStatement(k);k.body=this.parseStatement(d,l,c);k.minChar=j;k.limChar=k.body.limChar;break;case a.TokenID.SWITCH:f();
m!=a.Modifiers.None&&this.reportParseError("'switch' statement does not take modifiers");this.chkNxtTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.ExprStart);k=new a.SwitchStatement(this.parseExpr(d|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes));this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.LCurly);g=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",d|a.ErrorRecoverySet.SCase);k.defaultCase=null;k.caseList=new a.ASTList;q=null;for(this.pushStmt(k,
e);;)if(this.tok.tokenId==a.TokenID.CASE||this.tok.tokenId==a.TokenID.DEFAULT){var s=this.tok.tokenId==a.TokenID.DEFAULT,q=new a.CaseStatement;q.minChar=this.scanner.startPos;this.tok=this.scanner.scan();s?k.defaultCase=q:q.expr=this.parseExpr(d|a.ErrorRecoverySet.Colon,a.OperatorPrecedence.No,!0,h.NoTypes);this.chkCurTok(a.TokenID.Colon,"Expected ':'",d|a.ErrorRecoverySet.StmtStart);q.body=new a.ASTList;this.parseStmtList(d|a.ErrorRecoverySet.RCurly,q.body,!1,!0,l,m);q.limChar=q.body.limChar;k.caseList.append(q)}else break;
k.caseList.minChar=g;k.caseList.limChar=this.scanner.pos;k.limChar=k.caseList.limChar;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);this.popStmt();break;case a.TokenID.WHILE:f();m!=a.Modifiers.None&&this.reportParseError("'while' statement does not take modifiers");j=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",a.ErrorRecoverySet.ExprStart|d);k=new a.WhileStatement(this.parseExpr(d|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes));k.minChar=j;this.chkCurTok(a.TokenID.RParen,
"Expected ')'",d|a.ErrorRecoverySet.StmtStart);this.pushStmt(k,e);k.body=this.parseStatement(d,l,c);k.limChar=k.body.limChar;this.popStmt();break;case a.TokenID.DO:f();m!=a.Modifiers.None&&this.reportParseError("'do' statement does not take modifiers");j=this.scanner.startPos;this.tok=this.scanner.scan();k=new a.DoWhileStatement;k.minChar=j;this.pushStmt(k,e);k.body=this.parseStatement(d|a.ErrorRecoverySet.While,l,c);this.popStmt();k.whileAST=new a.Identifier("while");k.whileAST.minChar=this.scanner.startPos;
this.chkCurTok(a.TokenID.WHILE,"Expected 'while'",d|a.ErrorRecoverySet.LParen);k.whileAST.limChar=k.whileAST.minChar+5;this.chkCurTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.ExprStart);k.cond=this.parseExpr(d|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes);k.limChar=this.scanner.pos;this.chkCurTok(a.TokenID.RParen,"Expected ')'",d);this.tok.tokenId==a.TokenID.SColon&&(this.tok=this.scanner.scan());break;case a.TokenID.IF:f();m!=a.Modifiers.None&&this.reportParseError("if statement does not take modifiers");
j=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",d|a.ErrorRecoverySet.ExprStart);k=new a.IfStatement(this.parseExpr(d|a.ErrorRecoverySet.LParen,a.OperatorPrecedence.No,!0,h.NoTypes));k.minChar=j;this.chkCurTok(a.TokenID.RParen,"Expected ')'",d|a.ErrorRecoverySet.StmtStart);this.pushStmt(k,e);k.thenBod=this.parseStatement(a.ErrorRecoverySet.Else|d,l,c);k.limChar=k.thenBod.limChar;this.tok.tokenId==a.TokenID.ELSE&&(this.tok=this.scanner.scan(),k.elseBod=this.parseStatement(d,l,
c),k.limChar=k.elseBod.limChar);this.popStmt();break;case a.TokenID.TRY:f();m!=a.Modifiers.None&&this.reportParseError("try statement does not take modifiers");j=this.scanner.startPos;k=this.parseTryCatchFinally(d,a.AllowedElements.FunctionBody,c,e);break;case a.TokenID.LCurly:f();m!=a.Modifiers.None&&this.reportParseError("block does not take modifiers");j=this.scanner.startPos;this.tok=this.scanner.scan();k=new a.Block(new a.ASTList,!0);this.pushStmt(k,e);this.parseStmtList(d|a.ErrorRecoverySet.RCurly,
k.stmts,!1,!1,a.AllowedElements.Block,m);this.popStmt();k.stmts.minChar=j;k.stmts.limChar=this.scanner.pos;k.minChar=k.stmts.minChar;k.limChar=k.stmts.limChar;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",d);break;case a.TokenID.SColon:f();m!=a.Modifiers.None&&this.reportParseError("modifier can not appear here");k=new a.AST(a.NodeType.Empty);this.tok=this.scanner.scan();break;case a.TokenID.BREAK:case a.TokenID.CONTINUE:f();m!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before jump statement");
p=new a.Jump(this.tok.tokenId==a.TokenID.BREAK?a.NodeType.Break:a.NodeType.Continue);this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.ID&&!this.scanner.lastTokenHadNewline()&&(p.target=this.tok.getText(),this.tok=this.scanner.scan());this.resolveJumpTarget(p);k=p;p=!0;break;case a.TokenID.RETURN:f();m!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before return statement");this.inFnc||this.reportParseError("return statement outside of function body");j=this.scanner.startPos;
this.tok=this.scanner.scan();k=new a.ReturnStatement;k.minChar=j;this.tok.tokenId!=a.TokenID.SColon&&(this.tok.tokenId!=a.TokenID.RCurly&&!this.scanner.lastTokenHadNewline())&&(k.returnExpression=this.parseExpr(d|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.No,!0,h.NoTypes));p=!0;k.limChar=this.scanner.lastTokenLimChar();break;case a.TokenID.THROW:f();m!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before a throw statement");j=this.scanner.startPos;this.tok=this.scanner.scan();
this.tok.tokenId!=a.TokenID.SColon&&this.tok.tokenId!=a.TokenID.RCurly&&!this.scanner.lastTokenHadNewline()?g=this.parseExpr(d|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.No,!0,h.NoTypes):(this.reportParseError("throw with no target"),g=null);k=new a.UnaryExpression(a.NodeType.Throw,g);k.limChar=this.scanner.lastTokenLimChar();p=!0;break;case a.TokenID.ENUM:this.tok=this.scanner.scan();k=this.parseEnumDecl(d,m);k.minChar=j;k.limChar=this.scanner.lastTokenLimChar();if(this.parsingDeclareFile||a.hasFlag(m,
a.Modifiers.Ambient))k.modFlags|=a.ModuleFlags.Ambient;a.hasFlag(m,a.Modifiers.Exported)&&(k.modFlags|=a.ModuleFlags.Exported);break;case a.TokenID.DEBUGGER:f();m!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before debugger statement");j=this.scanner.startPos;this.tok=this.scanner.scan();k=new a.DebuggerStatement;k.minChar=j;p=!0;k.limChar=this.scanner.lastTokenLimChar();break;default:m!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before an expression statement or label"),
j=this.scanner.startPos,q=this.scanner.pos,g=this.parseExpr(a.ErrorRecoverySet.Colon|a.ErrorRecoverySet.StmtStart|d,a.OperatorPrecedence.No,!0,h.NoTypes),this.scanner.pos==q?(this.tok=this.scanner.scan(),k=g):this.tok.tokenId==a.TokenID.Colon&&!this.scanner.lastTokenHadNewline()&&g&&g.nodeType==a.NodeType.Name?(null==e&&(e=new a.ASTList),e.append(new a.Label(g)),this.tok=this.scanner.scan()):(k=g,p=!0)}if(k)break}if(p)switch(this.tok.tokenId){case a.TokenID.SColon:this.tok=this.scanner.scan();k.flags|=
...
k.preComments=r;this.ambientModule&&!this.okAmbientModuleMember(k)&&this.reportParseError("statement not permitted within ambient module");k.flags|=a.ASTFlags.IsStatement;return k};g.prototype.okAmbientModuleMember=function(b){var l=b.nodeType;return l==a.NodeType.Class||l==a.NodeType.Import||l==a.NodeType.Interface||l==a.NodeType.Module||l==a.NodeType.Empty||l==a.NodeType.VarDecl&&(a.hasFlag(b.varFlags,a.VarFlags.Property)||a.hasFlag(b.varFlags,a.VarFlags.Exported))||l==a.NodeType.FuncDecl&&b.isMethod()};
g.prototype.parseStmtList=function(d,l,c,i,f,k){l.minChar=this.scanner.startPos;var g=this.scanner.pos,e=(f&a.AllowedElements.ModuleDecls)==a.AllowedElements.None,m=(f&a.AllowedElements.ClassDecls)==a.AllowedElements.None,d=d|a.ErrorRecoverySet.TypeScriptS|a.ErrorRecoverySet.RCurly;this.state=b.StartStmtList;var j=this.strictMode;for(this.nestingLevel++;;){if(this.tok.tokenId==a.TokenID.RCurly||i&&(this.tok.tokenId==a.TokenID.CASE||this.tok.tokenId==a.TokenID.DEFAULT)||e&&this.tok.tokenId==a.TokenID.EXPORT||
m&&this.tok.tokenId==a.TokenID.CLASS||this.tok.tokenId==a.TokenID.EOF){this.state=b.EndStmtList;l.limChar=g;0==l.members.length?l.preComments=this.parseComments():l.postComments=this.parseComments();this.strictMode=j;this.nestingLevel--;break}var h=this.parseStatement(d&~(a.ErrorRecoverySet.Else|a.ErrorRecoverySet.RParen|a.ErrorRecoverySet.Catch|a.ErrorRecoverySet.Colon),f,k);h&&(h.postComments=this.combineComments(h.postComments,this.parseCommentsForLine(this.scanner.prevLine)),l.append(h),g=h.limChar,
c&&(h.nodeType==a.NodeType.QString?"use strict"==h.text?(l.flags|=a.ASTFlags.StrictMode,this.strictMode=!0):c=!1:c=!1))}};g.prototype.quickParse=function(b,l,c){var i=a.moduleGenTarget;try{a.moduleGenTarget=a.ModuleGenTarget.Local;var f=this.parse(b,l,c,a.AllowedElements.QuickParse);return new j(f,this.scanner.lexState)}finally{a.moduleGenTarget=i}};g.prototype.parse=function(d,l,c,i){"undefined"===typeof i&&(i=a.AllowedElements.Global);this.ambientModule=!1;this.topLevel=!0;this.hasTopLevelImportOrExport=
this.parseError=!1;this.fname=l;this.currentUnitIndex=c;this.amdDependencies=[];this.scanner.resetComments();this.scanner.setSourceText(d,a.LexMode.File);var d=this.scanner.leftCurlyCount,f=this.scanner.rightCurlyCount,k=this.scanner.pos;this.tok=this.scanner.scan();this.pushDeclLists();var g=new a.ASTList;g.minChar=k;this.state=b.StartScript;this.parsingDeclareFile=a.isDSTRFile(l)||a.isDTSFile(l);this.parseStmtList(a.ErrorRecoverySet.EOF|a.ErrorRecoverySet.Func,g,!0,!1,i,a.Modifiers.None);this.tok.tokenId!=
a.TokenID.EOF&&this.reportParseError("Unexpected statement block terminator '"+a.tokenTable[this.tok.tokenId].text+"'");this.state=b.EndScript;g.limChar=this.scanner.pos;i=null;if(a.moduleGenTarget!=a.ModuleGenTarget.Local&&this.hasTopLevelImportOrExport){var e=a.switchToForwardSlashes(l),i=new a.Identifier(e),i=new a.ModuleDecl(i,g,this.topVarList(),this.topScopeList());i.modFlags|=a.ModuleFlags.IsDynamic;i.modFlags|=a.ModuleFlags.IsWholeFile;i.modFlags|=a.ModuleFlags.Exported;this.parsingDeclareFile&&
(i.modFlags|=a.ModuleFlags.Ambient);i.minChar=k;i.limChar=this.scanner.pos;i.prettyName=a.getPrettyName(e);i.amdDependencies=this.amdDependencies;g=new a.ASTList;g.minChar=i.minChar;g.limChar=i.limChar;g.append(i)}e=new a.Script(this.topVarList(),this.topScopeList());e.bod=g;this.popDeclLists();e.minChar=k;e.limChar=this.scanner.pos;e.locationInfo=new a.LocationInfo(l,this.scanner.lineMap,c);e.leftCurlyCount=this.scanner.leftCurlyCount-d;e.rightCurlyCount=this.scanner.rightCurlyCount-f;e.isDeclareFile=
this.parsingDeclareFile;e.topLevelMod=i;return e};a.Parser=g;a.quickParse=function(b,l,c,i,f,k){l=c.getText(i,f);b.log("Quick parse range ("+i+","+f+'): "'+a.stringToLiteral(l,100)+'"');b=new g;b.setErrorRecovery(null,-1,-1);b.errorCallback=k;k=new a.TypeDecl(a.NodeType.Class,null,null,null,null,null);b.currentClassDecl=k;return b.quickParse(new a.StringSourceText(l),"",0)}})(TypeScript||(TypeScript={}));
...
a.LexCodeRBR?a.LexCodeLBR:c==a.LexCodeRC?a.LexCodeLC:c==a.LexCodeRPR?a.LexCodeLPR:0};var i=a.NumberScanState||(a.NumberScanState={});i._map=[];i._map[0]="Start";i.Start=0;i._map[1]="InFraction";i.InFraction=1;i._map[2]="InExponent";i.InExponent=2;var f=a.NumberScanState,i=a.LexState||(a.LexState={});i._map=[];i._map[0]="Start";i.Start=0;i._map[1]="InMultilineComment";i.InMultilineComment=1;var k=a.LexState,i=a.LexMode||(a.LexMode={});i._map=[];i._map[0]="Line";i.Line=0;i._map[1]="File";i.File=1;var w=
a.LexMode,i=a.CommentStyle||(a.CommentStyle={});i._map=[];i._map[0]="Line";i.Line=0;i._map[1]="Block";i.Block=1;var n=function(a){this.text=a};n.prototype.getText=function(a,c){return this.text.substring(a,c)};n.prototype.getLength=function(){return this.text.length};a.StringSourceText=n;var m=function(a,c,b){this.segmentStart=a;this.segmentEnd=c;this.segment=b};m.prototype.charCodeAt=function(a){return this.segment.charCodeAt(a-this.segmentStart)};m.prototype.substring=function(a,c){return this.segment.substring(a-
this.segmentStart,c-this.segmentStart)};a.SourceTextSegment=m;var u=function(a,c){this.seg1=a;this.seg2=c};u.prototype.charCodeAt=function(a){return this.seg1.segmentStart<=a&&a<this.seg1.segmentEnd?this.seg1.segment.charCodeAt(a-this.seg1.segmentStart):this.seg2.segment.charCodeAt(a-this.seg2.segmentStart)};u.prototype.substring=function(a,c){return this.seg1.segmentStart<=a&&c<=this.seg1.segmentEnd?this.seg1.segment.substring(a-this.seg1.segmentStart,c-this.seg1.segmentStart):this.seg2.segment.substring(a-
this.seg2.segmentStart)+this.seg1.segment.substring(0,c-this.seg1.segmentStart)};a.AggerateSourceTextSegment=u;var q=function(a){this.sourceText=a;this.agg=new u(q.emptySegment,q.emptySegment);this.len=this.sourceText.getLength()};q.emptySegment=new m(0,0,"");q.prototype.max=function(a,c){return a>=c?a:c};q.prototype.min=function(a,c){return a<=c?a:c};q.prototype.fetchSegment=function(c,b){if(this.agg.seg1.segmentStart<=c&&b<=this.agg.seg1.segmentEnd)return this.agg.seg1;if(this.agg.seg2.segmentStart<=
c&&b<=this.agg.seg1.segmentEnd)return this.agg;var d=this.agg.seg1,f=d.segmentEnd,i=a.max(f+512,b),i=a.min(i,this.len),k=this.sourceText.getText(f,i),f=new m(f,i,k);this.agg.seg2=d;this.agg.seg1=f;return this.agg};q.prototype.charCodeAt=function(a){return this.fetchSegment(a,a+1).charCodeAt(a)};q.prototype.substring=function(a,c){return this.fetchSegment(a,c).substring(a,c)};a.ScannerTextStream=q;i=function(){this.prevToken=this.prevSavedToken=this.curSavedToken=this.prevToken=null;this.currentToken=
0;this.tokens=[];this.line=this.prevLine=1;this.col=0;this.lexState=k.Start;this.commentStack=[]};i.prototype.previousToken=function(){return this.prevToken};i.prototype.close=function(){this.currentToken=0};i.prototype.addToken=function(c,b){this.tokens[this.currentToken++]=new a.SavedToken(c,b.startPos,b.pos)};i.prototype.scan=function(){this.startLine=this.line;this.startPos=this.col;if(this.currentTokenIndex==this.currentTokens.length)if(this.line<this.lineMap.length)this.line++,this.currentTokenIndex=
...
this.pos))):null};i.prototype.scanDecimalNumber=function(c){for(var d=!1,i=this.pos,k=this.col;;)if(b(this.ch))d=!0,this.nextChar();else if(this.ch==a.LexCodeDOT)if(c==f.Start)this.nextChar(),c=f.InFraction;else{if(d)return new a.NumberToken(parseFloat(this.src.substring(this.startPos,this.pos)));this.pos=i;this.col=k;return null}else if(this.ch==a.LexCode_e||this.ch==a.LexCode_E)if(c==f.Start)if(d)d=!1,this.nextChar(),c=f.InExponent;else return this.pos=i,this.col=k,null;else if(c==f.InFraction)this.nextChar(),
c=f.InExponent,d=!1;else{if(d)return new a.NumberToken(parseFloat(this.src.substring(this.startPos,this.pos)));this.pos=i;this.col=k;return null}else if(this.ch==a.LexCodePLS||this.ch==a.LexCodeMIN)if(c==f.InExponent){if(d)return this.pos=i,this.col=k,null;this.nextChar()}else{if(c==f.InFraction||d)return new a.NumberToken(parseFloat(this.src.substring(this.startPos,this.pos)));this.pos=i;this.col=k;return null}else{if(d)return new a.NumberToken(parseFloat(this.src.substring(this.startPos,this.pos)));
this.pos=i;this.col=k;return null}};i.prototype.scanNumber=function(){if(this.peekChar()==a.LexCode_0)switch(this.peekCharAt(this.pos+1)){case a.LexCode_x:case a.LexCode_X:return this.advanceChar(2),this.scanHexDigits();case a.LexCode_8:case a.LexCode_9:case a.LexCodeDOT:return this.scanDecimalNumber(f.Start);default:return this.scanOctalDigits()}else return this.scanDecimalNumber(f.Start)};i.prototype.scanFraction=function(){return this.scanDecimalNumber(f.InFraction)};i.prototype.newLine=function(){this.col=
0;this.mode==w.File&&(this.line++,this.lineMap[this.line]=this.pos+1)};i.prototype.finishMultilineComment=function(){var c;for(this.lexState=k.InMultilineComment;this.pos<this.len;){if(this.ch==a.LexCodeMUL){if(c=this.peekCharAt(this.pos+1),c==a.LexCodeSLH)return this.advanceChar(2),this.mode==w.File&&this.tokenStart(),this.lexState=k.Start,!0}else if(this.ch==a.LexCodeNWL&&(this.newLine(),this.mode==w.Line)){this.nextChar();break}this.nextChar()}return!1};i.prototype.pushComment=function(a){this.commentStack.push(a)};
...
this.len&&!this.endsLine(this.ch);)this.nextChar();this.mode==w.File&&this.tokenStart()};i.prototype.tokenText=function(){return this.src.substring(this.startPos,this.pos)};i.prototype.findClosingSLH=function(){for(var c=this.pos,b=this.src.charCodeAt(c),d=0,f=!1;!this.endsLine(b)&&c<this.len;){if(b==a.LexCodeSLH&&!f)return c;d=b;c++;f=f?!1:d==a.LexCodeBSL;b=this.src.charCodeAt(c)}return-1};i.prototype.speculateRegex=function(){if(void 0!=a.noRegexTable[this.prevTok.tokenId])return null;var c=this.pos,
b=this.col,d=this.findClosingSLH();if(0<d){var f=this.src.substring(c,d),i="";this.pos=d+1;this.ch=this.peekChar();for(i=this.pos;this.ch==a.LexCode_i||this.ch==a.LexCode_g||this.ch==a.LexCode_m;)this.nextChar();if(3<this.pos-i)return null;i=this.src.substring(i,this.pos);d=void 0;try{d=RegExp(f,i)}catch(k){}if(d)return this.col=b+(this.pos-this.startPos),new a.RegexToken(d)}this.pos=c;this.col=b;return null};i.prototype.lastTokenHadNewline=function(){return this.prevLine!=this.startLine};i.prototype.lastTokenLimChar=
function(){return this.interveningWhitespace?this.interveningWhitespacePos:this.startPos};i.prototype.advanceChar=function(a){this.pos+=a;this.col+=a;this.ch=this.peekChar()};i.prototype.nextChar=function(){this.pos++;this.col++;this.ch=this.peekChar()};i.prototype.scan=function(){if(this.lexState==k.InMultilineComment&&this.scanComments){this.ch=this.peekChar();var c=this.line;this.finishMultilineComment();if(this.startPos<this.pos){var b=this.src.substring(this.startPos,this.pos);this.tokenStart();
return new a.CommentToken(a.TokenID.Comment,b,!0,this.startPos,c,!0)}return a.staticTokens[a.TokenID.EOF]}this.prevLine=this.line;this.prevTok=this.innerScan();this.saveScan&&this.saveScan.addToken(this.prevTok,this);return this.prevTok};i.prototype.innerScan=function(){var d;this.tokenStart();for(this.ch=this.peekChar();this.pos<this.len;){if(c[this.ch]){do this.nextChar();while(c[this.ch]||b(this.ch));var f=this.src.substring(this.startPos,this.pos);return null!=(d=a.LexKeywordTable.lookup(f))?
a.staticTokens[d]:new a.StringToken(a.TokenID.ID,f)}if(this.ch==a.LexCodeSpace){this.interveningWhitespace||(this.interveningWhitespacePos=this.pos);do this.nextChar();while(this.ch==a.LexCodeSpace);if(this.mode==w.Line)return d=this.src.substring(this.startPos,this.pos),new a.WhitespaceToken(a.TokenID.Whitespace,d);this.tokenStart();this.interveningWhitespace=!0}else if(this.ch==a.LexCodeSLH){this.nextChar();var i;if(this.ch==a.LexCodeSLH){this.interveningWhitespace||(this.interveningWhitespacePos=
this.pos-1);var f=this.pos-1,k=this.line;this.finishSinglelineComment();i=this.src.substring(f,this.pos);i=new a.CommentToken(a.TokenID.Comment,i,!1,f,k,!1);if(this.scanComments)return this.startPos=f,i;this.pushComment(i);this.interveningWhitespace=!0}else if(this.ch==a.LexCodeMUL){this.interveningWhitespace||(this.interveningWhitespacePos=this.pos-1);f=this.pos-1;k=this.line;this.nextChar();this.finishMultilineComment();i=this.src.substring(f,this.pos);var g=this.peekChar()==a.LexCodeNWL||this.peekChar()==
a.LexCodeRET;i=new a.CommentToken(a.TokenID.Comment,i,!0,f,k,g);if(this.scanComments)return this.startPos=f,i;this.pushComment(i);this.interveningWhitespace=!0}else return(d=this.speculateRegex())?d:this.peekCharAt(this.pos)==a.LexCodeEQ?(this.nextChar(),a.staticTokens[a.TokenID.AsgDiv]):a.staticTokens[a.TokenID.Div]}else{if(this.ch==a.LexCodeSMC)return this.nextChar(),a.staticTokens[a.TokenID.SColon];if(this.ch==a.LexCodeAPO||this.ch==a.LexCodeQUO){d=this.ch;f=0;i=!1;do f=this.ch,i=i?!1:f==a.LexCodeBSL,
this.nextChar();while(this.ch!=a.LexEOF&&(i||this.ch!=d));this.ch!=a.LexEOF&&this.nextChar();return new a.StringToken(a.TokenID.QString,this.src.substring(this.startPos,this.pos))}if(l[this.ch])return d=l[this.ch],d.tokenId==a.TokenID.LCurly?this.leftCurlyCount++:d.tokenId==a.TokenID.RCurly&&this.rightCurlyCount++,this.nextChar(),d;if(this.ch>=a.LexCode_0&&this.ch<=a.LexCode_9){if(d=this.scanNumber())return d;this.nextChar();return a.staticTokens[a.TokenID.Error]}switch(this.ch){case a.LexCodeTAB:case a.LexCodeVTAB:this.interveningWhitespace||
(this.interveningWhitespacePos=this.pos);if(this.mode==w.Line){do this.nextChar();while(this.ch==a.LexCodeSpace||9==this.ch);d=this.src.substring(this.startPos,this.pos);return new a.WhitespaceToken(a.TokenID.Whitespace,d)}this.interveningWhitespace=!0;case 255:case 254:case 239:case 187:case 191:case 8232:case 8233:case a.LexCodeNWL:case a.LexCodeRET:if(this.ch==a.LexCodeNWL&&(this.newLine(),this.mode==w.Line))return a.staticTokens[a.TokenID.EOF];this.interveningWhitespace||(this.interveningWhitespacePos=
...
default:return a.staticTokens[a.TokenID.EOF]}}}return a.staticTokens[a.TokenID.EOF]};a.Scanner=i;a.convertTokToIDName=function(a){return j(a,!0,!1)};a.convertTokToID=function(a,c){return j(a,!1,c)};a.getLineNumberFromPosition=g;a.getSourceLineColFromMap=d;a.getLineColumnFromPosition=function(a,c){var b={line:-1,col:-1};d(b,c,a.locationInfo.lineMap);0<=b.col&&b.col++;return b};a.getPositionFromLineColumn=function(a,c,b){return a.locationInfo.lineMap[c]+(b-1)}})(TypeScript||(TypeScript={}));
(function(a){function e(c,b,d,f,i){c=new a.ScopeChain(null,b.scopeChain,c);c.thisType=d;c.classType=f;c.fnc=i;b.scopeChain=c}function h(a){a.scopeChain=a.scopeChain.previous}function b(a,c){return null==a||!a.isInstanceProperty()?c:a}function j(a){return a.isInstanceProperty()}function g(c,b){var d=null,f=null;c.name&&c.mod&&(c.name.sym=c.mod.symbol);var i=c.mod;i&&(d=new a.SymbolTableScope(i.members,i.ambientMembers,i.enclosedTypes,i.ambientEnclosedTypes,i.symbol),i.memberScope=d,b.modDeclChain.push(c),
b.typeFlow.checker.currentModDecl=c,f=new a.SymbolAggregateScope(i.symbol),f.addParentScope(d),f.addParentScope(b.scopeChain.scope),e(f,b,null,null,null),i.containedScope=f,i.symbol&&b.typeFlow.addLocalsFromScope(i.containedScope,i.symbol,c.vars,i.members.privateMembers,!0))}function d(c,b){var d=null,f=null;c.name&&c.type&&(c.name.sym=c.type.symbol);var i=c.type;if(i){d=b.typeFlow.checker.scopeOf(i);f=new a.SymbolAggregateScope(i.symbol);f.addParentScope(d);f.addParentScope(b.scopeChain.scope);i.containedScope=
f;i.memberScope=d;var k=i.instanceType,d=b.typeFlow.checker.scopeOf(k);k.memberScope=d;f=new a.SymbolAggregateScope(k.symbol);f.addParentScope(b.scopeChain.scope);e(f,b,k,i,null);k.containedScope=f}else c.type=b.typeFlow.anyType}function l(c,b){var d=null,f=null;c.name&&c.type&&(c.name.sym=c.type.symbol);var i=c.type,d=b.typeFlow.checker.scopeOf(i);i.memberScope=d;f=new a.SymbolAggregateScope(i.symbol);f.addParentScope(d);f.addParentScope(b.scopeChain.scope);e(f,b,null,null,null);i.containedScope=
f}function c(c,b){var d=c.type,f=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),i=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),d=new a.Type,k=new a.WithSymbol(c.minChar,b.typeFlow.checker.locationInfo.unitIndex,d);d.members=f;d.ambientMembers=i;d.symbol=k;d.setHasImplementation();c.type=d;f=new a.SymbolScopeBuilder(d.members,d.ambientMembers,null,null,b.scopeChain.scope,d.symbol);e(f,b,null,null,null);d.containedScope=
f}function i(c,b){var d=null,f=null;c.type&&(f=c.type.symbol);var i=a.hasFlag(c.fncFlags,a.FncFlags.Static),k=i&&null!=b.scopeChain.fnc?b.scopeChain.fnc.type.memberScope:b.scopeChain.scope;b.scopeChain.thisType&&(!c.isConstructor||a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod))?(d=b.scopeChain.thisType,k=!(d.typeFlags&a.TypeFlags.IsClass)&&!a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod)?!c.isMethod()||i?d.constructorScope:d.containedScope:b.scopeChain.previous.scope.container&&b.scopeChain.previous.scope.container.declAST&&
b.scopeChain.previous.scope.container.declAST.nodeType==a.NodeType.FuncDecl&&b.scopeChain.previous.scope.container.declAST.isConstructor?d.constructorScope:i&&b.scopeChain.classType?b.scopeChain.classType.containedScope:d.containedScope,d=d.symbol):c.isConstructor&&b.scopeChain.thisType&&(d=b.scopeChain.thisType.symbol);if(null==c.type||a.hasFlag(c.type.symbol.flags,a.SymbolFlags.TypeSetDuringScopeAssignment)){b.scopeChain.fnc&&b.scopeChain.fnc.type&&(d=b.scopeChain.fnc.type.symbol);var g=null,l=
b.scopeChain.fnc,j=c.name?c.name.text:null,h=null;i?(null==l.type.members&&d.getType().memberScope&&(l.type.members=d.type.memberScope.valueMembers),g=b.scopeChain.fnc.type.memberScope,l.innerStaticFuncs[l.innerStaticFuncs.length]=c):g=!c.isConstructor&&d&&d.declAST&&d.declAST.nodeType==a.NodeType.FuncDecl&&d.declAST.isConstructor&&!c.isMethod()?b.scopeChain.thisType.constructorScope:b.scopeChain.scope;j&&("__missing"!=j&&!c.isAccessor())&&(h=g.findLocal(j,!1,!1));b.typeFlow.checker.createFunctionSignature(c,
d,g,h,null==h);if(!c.accessorSymbol&&c.fncFlags&a.FncFlags.ClassMethod&&d&&(!h||h.declAST.nodeType!=a.NodeType.FuncDecl)&&c.isAccessor()||h&&h.isAccessor())c.accessorSymbol=b.typeFlow.checker.createAccessorSymbol(c,h,d.getType(),c.isMethod()&&i,!0,g,d);c.type.symbol.flags|=a.SymbolFlags.TypeSetDuringScopeAssignment}c.name&&c.type&&(c.name.sym=c.type.symbol);c.scopeType=c.type;if(!c.isOverload){var d=new a.StringHashTable,h=new a.ScopedMembers(new a.DualStringHashTable(d,new a.StringHashTable)),g=
new a.StringHashTable,j=new a.ScopedMembers(new a.DualStringHashTable(g,new a.StringHashTable)),g=new a.StringHashTable,l=new a.ScopedMembers(new a.DualStringHashTable(g,new a.StringHashTable)),A=new a.StringHashTable,A=new a.ScopedMembers(new a.DualStringHashTable(A,new a.StringHashTable));c.unitIndex=b.typeFlow.checker.locationInfo.unitIndex;f=new a.SymbolScopeBuilder(h,j,null,null,k,f);l=new a.SymbolScopeBuilder(l,A,null,null,k,null);c.isConstructor&&b.scopeChain.thisType&&(b.scopeChain.thisType.constructorScope=
f);c.symbols=d;if(!c.isSpecialFn()){h=c.type;k=c.signature;c.isConstructor||(h.containedScope=f,f.container=h.symbol,h.memberScope=l,l.container=h.symbol);c.enclosingFnc=b.scopeChain.fnc;h.enclosingType=i?b.scopeChain.classType:b.scopeChain.thisType;h=c.type.symbol;(c.fncFlags&a.FncFlags.Signature)==a.FncFlags.None&&c.vars&&(b.typeFlow.addLocalsFromScope(f,h,c.vars,d,!1),b.typeFlow.addLocalsFromScope(l,h,c.statics,g,!1));if(k.parameters){i=k.parameters.length;for(d=0;d<i;d++)b.typeFlow.checker.resolveTypeLink(f,
k.parameters[d].parameter.typeLink,!0)}b.typeFlow.checker.resolveTypeLink(f,k.returnType,c.isSignature())}if(!c.isConstructor||a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod))i=c.isConstructor&&a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod)?b.scopeChain.thisType:null,e(f,b,i,null,c)}}function f(c,b){if(c.param){var d=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),d=new a.SymbolScopeBuilder(d,null,null,null,b.scopeChain.scope,b.scopeChain.scope.container);c.containedScope=
d;e(d,b,b.scopeChain.thisType,b.scopeChain.classType,b.scopeChain.fnc)}}a.AssignScopeContext=function(a,c,b){this.scopeChain=a;this.typeFlow=c;this.modDeclChain=b};a.pushAssignScope=e;a.popAssignScope=h;a.instanceCompare=b;a.instanceFilterStop=j;var k=function(a,c){this.select=a;this.stop=c;this.result=null};k.prototype.reset=function(){this.result=null};k.prototype.update=function(a){return(this.result=this.select(this.result,a))?this.stop(this.result):!1};a.ScopeSearchFilter=k;a.instanceFilter=
new k(b,j);a.preAssignModuleScopes=g;a.preAssignClassScopes=d;a.preAssignInterfaceScopes=l;a.preAssignWithScopes=c;a.preAssignFuncDeclScopes=i;a.preAssignCatchScopes=f;a.preAssignScopes=function(b,k,e){var k=e.state,j=!0;b&&(b.nodeType==a.NodeType.List?b.enclosingScope=k.scopeChain.scope:b.nodeType==a.NodeType.Module?g(b,k):b.nodeType==a.NodeType.Class?d(b,k):b.nodeType==a.NodeType.Interface?l(b,k):b.nodeType==a.NodeType.With?c(b,k):b.nodeType==a.NodeType.FuncDecl?i(b,k):b.nodeType==a.NodeType.Catch?
f(b,k):b.nodeType==a.NodeType.TypeRef&&(j=!1));e.options.goChildren=j;return b};a.postAssignScopes=function(c,b,d){var b=d.state,f=!0;c&&(c.nodeType==a.NodeType.Module?(h(b),b.modDeclChain.pop(),1<=b.modDeclChain.length&&(b.typeFlow.checker.currentModDecl=b.modDeclChain[b.modDeclChain.length-1])):c.nodeType==a.NodeType.Class?h(b):c.nodeType==a.NodeType.Interface?h(b):c.nodeType==a.NodeType.With?h(b):c.nodeType==a.NodeType.FuncDecl?(!c.isConstructor||a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod))&&
!c.isOverload&&h(b):c.nodeType==a.NodeType.Catch?c.param&&h(b):f=!1);d.options.goChildren=f;return c}})(TypeScript||(TypeScript={}));
(function(a){function e(b,e,g){var e=g.state,d=b.minChar,l=b.limChar;b.nodeType==a.NodeType.Script&&e.pos>l&&(l=e.pos);if(d<=e.pos&&l>=e.pos){switch(b.nodeType){case a.NodeType.Script:e.scopeGetter=function(){return null===b.bod?null:b.bod.enclosingScope};e.scopeStartAST=b;break;case a.NodeType.Class:e.scopeGetter=function(){return null===b.type||null===b.type.instanceType.containedScope?null:b.type.instanceType.containedScope};e.scopeStartAST=b;e.enclosingClassDecl=b;break;case a.NodeType.ObjectLit:b.targetType&&
...
!1:(e.scopeGetter=function(){return b.isConstructor&&a.hasFlag(b.fncFlags,a.FncFlags.ClassMethod)&&b.type&&b.type.enclosingType?b.type.enclosingType.constructorScope:b.scopeType?b.scopeType.containedScope:b.type?b.type.containedScope:null},e.scopeStartAST=b)}g.options.goChildren=!0}else g.options.goChildren=!1;return b}a.TypeCollectionContext=function(a,e){this.scopeChain=a;this.checker=e;this.script=null};a.MemberScopeContext=function(b,e,g){this.flow=b;this.pos=e;this.matchFlag=g;this.ast=this.type=
null;this.options=new a.AstWalkOptions};var h=function(a,e,g,d,l){this.logger=a;this.script=e;this.text=g;this.pos=d;this.isMemberCompletion=l;this.scopeStartAST=this.objectLiteralScopeGetter=this.scopeGetter=null;this.skipNextFuncDeclForClass=!1;this.enclosingObjectLit=this.enclosingClassDecl=this.deepestModuleDecl=null;this.publicsOnly=!0;this.useFullAst=!1};h.prototype.getScope=function(){return this.scopeGetter()};h.prototype.getObjectLiteralScope=function(){return this.objectLiteralScopeGetter()};
...
this.pos:this.pos+1,null).Script}return this.scriptFragment};a.EnclosingScopeContext=h;a.preFindMemberScope=function(b,e,g){e=g.state;if(a.hasFlag(b.flags,e.matchFlag)&&(0>e.pos||e.pos==b.limChar))e.ast=b,null==b.type&&0<=e.pos&&e.flow.inScopeTypeCheck(b,e.scope),e.type=b.type,e.options.stopWalk();return b};a.pushTypeCollectionScope=function(b,e,g,d,l,c,i,f,k){e=new a.SymbolScopeBuilder(e,g,d,l,null,b);b=new a.ScopeChain(b,c.scopeChain,e);b.thisType=i;b.classType=f;b.moduleDecl=k;c.scopeChain=b};
a.popTypeCollectionScope=function(a){a.scopeChain=a.scopeChain.previous};a.preFindEnclosingScope=e;a.findEnclosingScopeAt=function(b,j,g,d,l){b=new h(b,j,g,d,l);a.getAstWalkerFactory().walk(j,e,null,null,b);return null===b.scopeStartAST?null:b}})(TypeScript||(TypeScript={}));
(function(a){var e=function(){this.hasVariableArgList=!1;this.declAST=this.parameters=null;this.typeCheckStatus=a.TypeCheckStatus.NotStarted;this.nonOptionalParameterCount=0};e.prototype.specializeType=function(b,h,g){var d=new e;this.hasVariableArgList&&(d.hasVariableArgList=!0);d.returnType=new a.TypeLink;d.returnType.type=this.returnType.type?this.returnType.type.specializeType(b,h,g,!1):g.anyType;if(this.parameters){d.parameters=[];for(var l=0,c=this.parameters.length;l<c;l++){var i=this.parameters[l],
f=new a.ValueLocation,k=new a.ParameterSymbol(i.name,i.location,g.locationInfo.unitIndex,f);k.declAST=this.declAST;f.symbol=k;f.typeLink=new a.TypeLink;d.parameters[l]=k;(i=i.getType())?(f.typeLink.type=i.specializeType(b,h,g,!1),k.declAST.type=f.typeLink.type):f.typeLink.type=g.anyType}}d.nonOptionalParameterCount=this.nonOptionalParameterCount;d.declAST=this.declAST;return d};e.prototype.toString=function(){return this.toStringHelper(!1,!1,null)};e.prototype.toStringHelper=function(a,e,g){var d;
d=e?"[":"(";for(var l=this.parameters.length,c=0;c<l;c++)d+=this.parameters[c].name+(this.parameters[c].isOptional()?"?":"")+": ",d+=this.parameters[c].getType().getScopedTypeName(g),c<l-1&&(d+=",");d=a?e?d+"] => ":d+") => ":e?d+"]: ":d+"): ";return d=this.returnType.type?d+this.returnType.type.getScopedTypeName(g):d+"any"};a.Signature=e;var h=function(){this.signatures=[];this.hasImplementation=!0;this.definitionSignature=null;this.hasBeenTypechecked=!1;this.flags=a.SignatureFlags.None};h.prototype.addSignature=
function(b){null==this.signatures&&(this.signatures=[]);this.signatures[this.signatures.length]=b;b.declAST&&(!b.declAST.isOverload&&!b.declAST.isSignature()&&!a.hasFlag(b.declAST.fncFlags,a.FncFlags.Ambient)&&a.hasFlag(b.declAST.fncFlags,a.FncFlags.Definition))&&(this.definitionSignature=b)};h.prototype.toString=function(){return this.signatures.toString()};h.prototype.toStrings=function(b,e,g){var d=[],l=this.signatures.length;1<l&&(e=!1);for(var c=0;c<l;c++)1<l&&this.signatures[c]==this.definitionSignature||
(d[c]=this.flags&a.SignatureFlags.IsIndexer?this.signatures[c].toStringHelper(e,!0,g):b+this.signatures[c].toStringHelper(e,!1,g));return d};h.prototype.specializeType=function(a,e,g){var d=new h;if(this.signatures)for(var l=0,c=this.signatures.length;l<c;l++)d.addSignature(this.signatures[l].specializeType(a,e,g));return d};h.prototype.verifySignatures=function(b){var e=0;if(this.signatures&&0<(e=this.signatures.length))for(var g=0;g<e;g++){for(var d=g+1;d<e;d++)this.signatures[g].declAST&&(this.signatures[d].declAST&&
...
(function(a){function e(c,b){return c.declAST&&b&&b.declAST&&c.declAST.nodeType==a.NodeType.FuncDecl?c.declAST.minChar<=b.declAST.minChar&&c.declAST.limChar>=b.declAST.limChar:!1}function h(a,c){for(;a.container;){if(a==c||e(a.container,c))return!0;a=a.container}return!1}var b=a.TypeCheckStatus||(a.TypeCheckStatus={});b._map=[];b._map[0]="NotStarted";b.NotStarted=0;b._map[1]="Started";b.Started=1;b._map[2]="Finished";b.Finished=2;var j=a.TypeCheckStatus;a.aLexicallyEnclosesB=e;a.aEnclosesB=h;var g=
...
b,b=b.container;return c};g.prototype.findCommonAncestorPath=function(a){if(null==this.container)return[];for(var c=this.container.pathToRoot(),a=a?a.pathToRoot():[],b=-1,d=0,f=c.length;d<f;d++){for(var i=c[d],e=0,g=a.length;e<g;e++)if(i==a[e]){b=d;break}if(0<=b)break}return 0<=b?c.slice(0,b):c};g.prototype.scopeRelativeName=function(a){if(null==a)return this.name;for(var a=this.findCommonAncestorPath(a.container),c="",b=0,d=a.length;b<d;b++)c=a[b].name+"."+c;return c+=this.name};g.prototype.fullName=
...
this.declModule.mod.symbol&&h(b.currentModDecl.mod.symbol,this.declModule.mod.symbol);var d=this.declAST&&this.declAST.nodeType==a.NodeType.FuncDecl,f=d&&this.declAST.isMethod(),d=d&&a.hasFlag(this.declAST.fncFlags,a.FncFlags.Static),i=f&&a.hasFlag(this.declAST.fncFlags,a.FncFlags.Private),e=this.isType()&&this.aliasLink;return this.isMember()||f||d||e?a.hasFlag(this.flags,a.SymbolFlags.Private)||i?null==c.container&&this.container!=c.container?!1:null==this.container?!0:h(c.container,this.container):
...
};a.SymbolScope=b;e=function(a){this.container=a;this.parents=this.typeAmbientCache=this.typeImplCache=this.typeCache=this.valueAmbientCache=this.valueImplCache=this.valueCache=null;this.container=a};__extends(e,b);e.prototype.printLabel=function(){return"agg"};e.prototype.search=function(a,b,e,c){if(this.parents)for(var i=0;i<this.parents.length;i++){var f=this.parents[i].search(a,b,e,c);if(f&&a.update(f))return f}return a.result};e.prototype.getAllSymbolNames=function(a){var b=[];if(this.parents)for(var e=
...
a);if(this.parents)for(var d=0;d<this.parents.length;d++)this.parents[d].print(a)};e.prototype.findImplementation=function(b,d,e){var c=null,i=0,f=this.valueImplCache;e&&(f=this.typeImplCache);if(f&&null!=(c=f.lookup(b))&&(d?!(a.hasFlag(c.flags,a.SymbolFlags.Private)||c.declAST&&c.declAST.nodeType==a.NodeType.FuncDecl&&a.hasFlag(c.declAST.fncFlags,a.FncFlags.Private)):1))return c;if(this.parents)for(i=0;i<this.parents.length&&!(c=this.parents[i].findImplementation(b,d,e));i++);f&&(f=e?this.typeImplCache=
new a.StringHashTable:this.valueImplCache=new a.StringHashTable);f.add(b,c);return c};e.prototype.find=function(b,d,e){var c=null,i=0,f=this.valueCache;e&&(f=this.typeCache);if(f&&null!=(c=f.lookup(b))&&(d?!(a.hasFlag(c.flags,a.SymbolFlags.Private)||c.declAST&&c.declAST.nodeType==a.NodeType.FuncDecl&&a.hasFlag(c.declAST.fncFlags,a.FncFlags.Private)):1))return c;if(this.parents)for(i=0;i<this.parents.length&&!(c=this.parents[i].find(b,d,e));i++);null==f&&(f=e?this.typeCache=new a.StringHashTable:this.valueCache=
new a.StringHashTable);f.add(b,c);return c};e.prototype.findAmbient=function(b,d,e){var c=null,i=0,f=this.valueAmbientCache;e&&(f=this.typeAmbientCache);if(f&&null!=(c=f.lookup(b)))return c;if(this.parents)for(i=0;i<this.parents.length&&!(c=this.parents[i].findAmbient(b,d,e));i++);null==f&&(f=e?this.typeAmbientCache=new a.StringHashTable:this.valueAmbientCache=new a.StringHashTable);f.add(b,c);return c};e.prototype.addParentScope=function(a){null==this.parents&&(this.parents=[]);this.parents[this.parents.length]=
a};a.SymbolAggregateScope=e;e=function(a,b,e,c,i){this.container=i;this.valueMembers=a;this.ambientValueMembers=b;this.enclosedTypes=e;this.ambientEnclosedTypes=c;this.container=i};__extends(e,b);e.prototype.printLabel=function(){return"table"};e.prototype.getAllSymbolNames=function(a){return this.getAllTypeSymbolNames(a).concat(this.getAllValueSymbolNames(a))};e.prototype.getAllTypeSymbolNames=function(){var a=[];this.ambientEnclosedTypes&&(a=a.concat(this.ambientEnclosedTypes.allMembers.getAllKeys()));
this.enclosedTypes&&(a=a.concat(this.enclosedTypes.allMembers.getAllKeys()));return a};e.prototype.getAllValueSymbolNames=function(){var a=[];this.ambientValueMembers&&(a=a.concat(this.ambientValueMembers.allMembers.getAllKeys()));this.valueMembers&&(a=a.concat(this.valueMembers.allMembers.getAllKeys()));return a};e.prototype.search=function(a,b,e,c){b=this.find(b,e,c);a.update(b);return a.result};e.prototype.find=function(a,b,e){var c=null,i=null;e?(c=null==this.enclosedTypes?null:b?this.enclosedTypes.publicMembers:
...
b)},null);this.enclosedTypes&&this.enclosedTypes.allMembers.map(function(b){a.WriteLine("  "+b)},null)};e.prototype.findImplementation=function(a,b,e){(a=this.find(a,b,e))&&(a.kind()==h.Type?a.type.hasImplementation()||(a=null):a.container&&a.container.kind()==h.Type&&(a.container.type.hasImplementation()||(a=null)));return a};e.prototype.getTable=function(){return this.valueMembers.publicMembers};a.SymbolTableScope=e;var j=function(a,b,e,c,i,f){this.container=f;this.valueMembers=a;this.ambientValueMembers=
b;this.enclosedTypes=e;this.ambientEnclosedTypes=c;this.parent=i;this.container=f};__extends(j,b);j.prototype.printLabel=function(){return"builder"};j.prototype.getAllSymbolNames=function(a){return this.getAllTypeSymbolNames(a).concat(this.getAllValueSymbolNames(a))};j.prototype.getAllTypeSymbolNames=function(a){var b=[];this.ambientEnclosedTypes&&(b=b.concat(this.ambientEnclosedTypes.allMembers.getAllKeys()));this.enclosedTypes&&(b=b.concat(this.enclosedTypes.allMembers.getAllKeys()));!a&&this.parent&&
(a=this.parent.getAllTypeSymbolNames(a))&&(b=b.concat(a));return b};j.prototype.getAllValueSymbolNames=function(a){var b=[];this.ambientValueMembers&&(b=b.concat(this.ambientValueMembers.allMembers.getAllKeys()));this.valueMembers&&(b=b.concat(this.valueMembers.allMembers.getAllKeys()));!a&&this.parent&&(a=this.parent.getAllValueSymbolNames(a))&&(b=b.concat(a));return b};j.prototype.search=function(a,b,e,c){var i=null,f=null==this.valueMembers?null:e?this.valueMembers.publicMembers:this.valueMembers.allMembers,
k=null==this.ambientValueMembers?null:e?this.ambientValueMembers.publicMembers:this.ambientValueMembers.allMembers;c&&(f=null==this.enclosedTypes?null:e?this.enclosedTypes.publicMembers:this.enclosedTypes.allMembers,k=null==this.ambientEnclosedTypes?null:e?this.ambientEnclosedTypes.publicMembers:this.ambientEnclosedTypes.allMembers);return k&&null!=(i=k.lookup(b))&&a.update(i)||f&&null!=(i=f.lookup(b))&&a.update(i)||this.parent&&(i=this.parent.search(a,b,e,c))&&a.update(i)?i:a.result};j.prototype.print=
...
(function(a){function e(c,b,e,l,g,h,j,q){void 0!==c&&(a.tokenTable[c]=new d(c,b,e,l,g,h,j,q),l!=a.NodeType.None&&(a.nodeTypeTable[l]=j,a.nodeTypeToTokTable[l]=c),h!=a.NodeType.None&&(a.nodeTypeTable[h]=j))}function h(c){return a.tokenTable[c]}var b=a.TokenID||(a.TokenID={});b._map=[];b._map[0]="ANY";b.ANY=0;b._map[1]="BOOL";b.BOOL=1;b._map[2]="BREAK";b.BREAK=2;b._map[3]="CASE";b.CASE=3;b._map[4]="CATCH";b.CATCH=4;b._map[5]="CLASS";b.CLASS=5;b._map[6]="CONST";b.CONST=6;b._map[7]="CONTINUE";b.CONTINUE=
...
b.Uni=14;b._map[15]="Lim";b.Lim=15;var b=a.OperatorPrecedence,g=a.Reservation||(a.Reservation={});g._map=[];g.None=0;g.Javascript=1;g.JavascriptFuture=2;g.TypeScript=4;g.JavascriptFutureStrict=8;g.TypeScriptAndJS=g.Javascript|g.TypeScript;g.TypeScriptAndJSFuture=g.JavascriptFuture|g.TypeScript;g.TypeScriptAndJSFutureStrict=g.JavascriptFutureStrict|g.TypeScript;var g=a.Reservation,d;d=function(a,c,b,d,e,l,g,h){this.tokenId=a;this.reservation=c;this.binopPrecedence=b;this.binopNodeType=d;this.unopPrecedence=
e;this.unopNodeType=l;this.text=g;this.ers=h};a.TokenInfo=d;e(j.ANY,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"any",a.ErrorRecoverySet.PrimType);e(j.BOOL,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"bool",a.ErrorRecoverySet.PrimType);e(j.BREAK,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"break",a.ErrorRecoverySet.Stmt);e(j.CASE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"case",a.ErrorRecoverySet.SCase);e(j.CATCH,g.TypeScriptAndJS,b.No,a.NodeType.None,
b.No,a.NodeType.None,"catch",a.ErrorRecoverySet.Catch);e(j.CLASS,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"class",a.ErrorRecoverySet.TypeScriptS);e(j.CONST,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"const",a.ErrorRecoverySet.Var);e(j.CONTINUE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"continue",a.ErrorRecoverySet.Stmt);e(j.DEBUGGER,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.Debugger,"debugger",a.ErrorRecoverySet.Stmt);
e(j.DEFAULT,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"default",a.ErrorRecoverySet.SCase);e(j.DELETE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.Uni,a.NodeType.Delete,"delete",a.ErrorRecoverySet.Prefix);e(j.DO,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"do",a.ErrorRecoverySet.Stmt);e(j.ELSE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"else",a.ErrorRecoverySet.Else);e(j.ENUM,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"enum",a.ErrorRecoverySet.TypeScriptS);
e(j.EXPORT,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"export",a.ErrorRecoverySet.TypeScriptS);e(j.EXTENDS,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"extends",a.ErrorRecoverySet.None);e(j.DECLARE,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"declare",a.ErrorRecoverySet.Stmt);e(j.FALSE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"false",a.ErrorRecoverySet.RLit);e(j.FINALLY,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,
"finally",a.ErrorRecoverySet.Catch);e(j.FOR,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"for",a.ErrorRecoverySet.Stmt);e(j.FUNCTION,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"function",a.ErrorRecoverySet.Func);e(j.CONSTRUCTOR,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"constructor",a.ErrorRecoverySet.Func);e(j.GET,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"get",a.ErrorRecoverySet.Func);e(j.SET,g.TypeScript,b.No,a.NodeType.None,
b.No,a.NodeType.None,"set",a.ErrorRecoverySet.Func);e(j.IF,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"if",a.ErrorRecoverySet.Stmt);e(j.IMPLEMENTS,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"implements",a.ErrorRecoverySet.None);e(j.IMPORT,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"import",a.ErrorRecoverySet.TypeScriptS);e(j.IN,g.TypeScriptAndJS,b.Cmp,a.NodeType.In,b.No,a.NodeType.None,"in",a.ErrorRecoverySet.None);e(j.INSTANCEOF,
g.TypeScriptAndJS,b.Cmp,a.NodeType.InstOf,b.No,a.NodeType.None,"instanceof",a.ErrorRecoverySet.BinOp);e(j.INTERFACE,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"interface",a.ErrorRecoverySet.TypeScriptS);e(j.LET,g.JavascriptFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"let",a.ErrorRecoverySet.None);e(j.MODULE,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"module",a.ErrorRecoverySet.TypeScriptS);e(j.NEW,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,
"new",a.ErrorRecoverySet.PreOp);e(j.NUMBER,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"number",a.ErrorRecoverySet.PrimType);e(j.NULL,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"null",a.ErrorRecoverySet.RLit);e(j.PACKAGE,g.JavascriptFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"package",a.ErrorRecoverySet.None);e(j.PRIVATE,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"private",a.ErrorRecoverySet.TypeScriptS);e(j.PROTECTED,g.JavascriptFutureStrict,
b.No,a.NodeType.None,b.No,a.NodeType.None,"protected",a.ErrorRecoverySet.None);e(j.PUBLIC,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"public",a.ErrorRecoverySet.TypeScriptS);e(j.RETURN,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"return",a.ErrorRecoverySet.Stmt);e(j.STATIC,g.TypeScriptAndJSFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"static",a.ErrorRecoverySet.None);e(j.STRING,g.TypeScript,b.No,a.NodeType.None,b.No,a.NodeType.None,"string",a.ErrorRecoverySet.PrimType);
e(j.SUPER,g.TypeScriptAndJSFuture,b.No,a.NodeType.None,b.No,a.NodeType.None,"super",a.ErrorRecoverySet.RLit);e(j.SWITCH,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"switch",a.ErrorRecoverySet.Stmt);e(j.THIS,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"this",a.ErrorRecoverySet.RLit);e(j.THROW,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"throw",a.ErrorRecoverySet.Stmt);e(j.TRUE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"true",a.ErrorRecoverySet.RLit);
e(j.TRY,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"try",a.ErrorRecoverySet.Stmt);e(j.TYPEOF,g.TypeScriptAndJS,b.No,a.NodeType.None,b.Uni,a.NodeType.Typeof,"typeof",a.ErrorRecoverySet.Prefix);e(j.VAR,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"var",a.ErrorRecoverySet.Var);e(j.VOID,g.TypeScriptAndJS,b.No,a.NodeType.None,b.Uni,a.NodeType.Void,"void",a.ErrorRecoverySet.Prefix);e(j.WITH,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.With,"with",a.ErrorRecoverySet.Stmt);
e(j.WHILE,g.TypeScriptAndJS,b.No,a.NodeType.None,b.No,a.NodeType.None,"while",a.ErrorRecoverySet.While);e(j.YIELD,g.JavascriptFutureStrict,b.No,a.NodeType.None,b.No,a.NodeType.None,"yield",a.ErrorRecoverySet.None);e(j.ID,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"identifier",a.ErrorRecoverySet.ID);e(j.NumberLit,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"numberLiteral",a.ErrorRecoverySet.Literal);e(j.Regex,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"regex",a.ErrorRecoverySet.RegExp);
e(j.QString,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"qstring",a.ErrorRecoverySet.Literal);e(j.SColon,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,";",a.ErrorRecoverySet.SColon);e(j.RParen,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,")",a.ErrorRecoverySet.RParen);e(j.RBrack,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"]",a.ErrorRecoverySet.RBrack);e(j.LCurly,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"{",a.ErrorRecoverySet.LCurly);e(j.RCurly,g.None,b.No,a.NodeType.None,
b.No,a.NodeType.None,"}",a.ErrorRecoverySet.RCurly);e(j.Ellipsis,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"...",a.ErrorRecoverySet.None);e(j.Comma,g.None,b.Cma,a.NodeType.Comma,b.No,a.NodeType.None,",",a.ErrorRecoverySet.Comma);e(j.Asg,g.None,b.Asg,a.NodeType.Asg,b.No,a.NodeType.None,"=",a.ErrorRecoverySet.Asg);e(j.AsgAdd,g.None,b.Asg,a.NodeType.AsgAdd,b.No,a.NodeType.None,"+=",a.ErrorRecoverySet.BinOp);e(j.AsgSub,g.None,b.Asg,a.NodeType.AsgSub,b.No,a.NodeType.None,"-=",a.ErrorRecoverySet.BinOp);
e(j.AsgMul,g.None,b.Asg,a.NodeType.AsgMul,b.No,a.NodeType.None,"*=",a.ErrorRecoverySet.BinOp);e(j.AsgDiv,g.None,b.Asg,a.NodeType.AsgDiv,b.No,a.NodeType.None,"/=",a.ErrorRecoverySet.BinOp);e(j.AsgMod,g.None,b.Asg,a.NodeType.AsgMod,b.No,a.NodeType.None,"%=",a.ErrorRecoverySet.BinOp);e(j.AsgAnd,g.None,b.Asg,a.NodeType.AsgAnd,b.No,a.NodeType.None,"&=",a.ErrorRecoverySet.BinOp);e(j.AsgXor,g.None,b.Asg,a.NodeType.AsgXor,b.No,a.NodeType.None,"^=",a.ErrorRecoverySet.BinOp);e(j.AsgOr,g.None,b.Asg,a.NodeType.AsgOr,
b.No,a.NodeType.None,"|=",a.ErrorRecoverySet.BinOp);e(j.AsgLsh,g.None,b.Asg,a.NodeType.AsgLsh,b.No,a.NodeType.None,"<<=",a.ErrorRecoverySet.BinOp);e(j.AsgRsh,g.None,b.Asg,a.NodeType.AsgRsh,b.No,a.NodeType.None,">>=",a.ErrorRecoverySet.BinOp);e(j.AsgRs2,g.None,b.Asg,a.NodeType.AsgRs2,b.No,a.NodeType.None,">>>=",a.ErrorRecoverySet.BinOp);e(j.QMark,g.None,b.Que,a.NodeType.QMark,b.No,a.NodeType.None,"?",a.ErrorRecoverySet.BinOp);e(j.Colon,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,":",a.ErrorRecoverySet.Colon);
e(j.LogOr,g.None,b.Lor,a.NodeType.LogOr,b.No,a.NodeType.None,"||",a.ErrorRecoverySet.BinOp);e(j.LogAnd,g.None,b.Lan,a.NodeType.LogAnd,b.No,a.NodeType.None,"&&",a.ErrorRecoverySet.BinOp);e(j.Or,g.None,b.Bor,a.NodeType.Or,b.No,a.NodeType.None,"|",a.ErrorRecoverySet.BinOp);e(j.Xor,g.None,b.Xor,a.NodeType.Xor,b.No,a.NodeType.None,"^",a.ErrorRecoverySet.BinOp);e(j.And,g.None,b.Ban,a.NodeType.And,b.No,a.NodeType.None,"&",a.ErrorRecoverySet.BinOp);e(j.EQ,g.None,b.Equ,a.NodeType.Eq,b.No,a.NodeType.None,"==",
a.ErrorRecoverySet.BinOp);e(j.NE,g.None,b.Equ,a.NodeType.Ne,b.No,a.NodeType.None,"!=",a.ErrorRecoverySet.BinOp);e(j.Eqv,g.None,b.Equ,a.NodeType.Eqv,b.No,a.NodeType.None,"===",a.ErrorRecoverySet.BinOp);e(j.NEqv,g.None,b.Equ,a.NodeType.NEqv,b.No,a.NodeType.None,"!==",a.ErrorRecoverySet.BinOp);e(j.LT,g.None,b.Cmp,a.NodeType.Lt,b.No,a.NodeType.None,"<",a.ErrorRecoverySet.BinOp);e(j.LE,g.None,b.Cmp,a.NodeType.Le,b.No,a.NodeType.None,"<=",a.ErrorRecoverySet.BinOp);e(j.GT,g.None,b.Cmp,a.NodeType.Gt,b.No,
a.NodeType.None,">",a.ErrorRecoverySet.BinOp);e(j.GE,g.None,b.Cmp,a.NodeType.Ge,b.No,a.NodeType.None,">=",a.ErrorRecoverySet.BinOp);e(j.Lsh,g.None,b.Shf,a.NodeType.Lsh,b.No,a.NodeType.None,"<<",a.ErrorRecoverySet.BinOp);e(j.Rsh,g.None,b.Shf,a.NodeType.Rsh,b.No,a.NodeType.None,">>",a.ErrorRecoverySet.BinOp);e(j.Rs2,g.None,b.Shf,a.NodeType.Rs2,b.No,a.NodeType.None,">>>",a.ErrorRecoverySet.BinOp);e(j.Add,g.None,b.Add,a.NodeType.Add,b.Uni,a.NodeType.Pos,"+",a.ErrorRecoverySet.AddOp);e(j.Sub,g.None,b.Add,
a.NodeType.Sub,b.Uni,a.NodeType.Neg,"-",a.ErrorRecoverySet.AddOp);e(j.Mult,g.None,b.Mul,a.NodeType.Mul,b.No,a.NodeType.None,"*",a.ErrorRecoverySet.BinOp);e(j.Div,g.None,b.Mul,a.NodeType.Div,b.No,a.NodeType.None,"/",a.ErrorRecoverySet.BinOp);e(j.Pct,g.None,b.Mul,a.NodeType.Mod,b.No,a.NodeType.None,"%",a.ErrorRecoverySet.BinOp);e(j.Tilde,g.None,b.No,a.NodeType.None,b.Uni,a.NodeType.Not,"~",a.ErrorRecoverySet.PreOp);e(j.Bang,g.None,b.No,a.NodeType.None,b.Uni,a.NodeType.LogNot,"!",a.ErrorRecoverySet.PreOp);
e(j.Inc,g.None,b.No,a.NodeType.None,b.Uni,a.NodeType.IncPre,"++",a.ErrorRecoverySet.PreOp);e(j.Dec,g.None,b.No,a.NodeType.None,b.Uni,a.NodeType.DecPre,"--",a.ErrorRecoverySet.PreOp);e(j.LParen,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"(",a.ErrorRecoverySet.LParen);e(j.LBrack,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,"[",a.ErrorRecoverySet.LBrack);e(j.Dot,g.None,b.Uni,a.NodeType.None,b.No,a.NodeType.None,".",a.ErrorRecoverySet.Dot);e(j.EOF,g.None,b.No,a.NodeType.None,b.No,a.NodeType.None,
...
new a.StringHashTable)),c=new a.ScopedMembers(new a.DualStringHashTable(this.dualGlobalTypes,new a.StringHashTable)),i=new a.ScopedMembers(new a.DualStringHashTable(this.dualAmbientGlobalTypes,new a.StringHashTable));this.globalScope=new a.SymbolScopeBuilder(d,e,c,i,this.importedGlobals,null);this.voidType=this.enterPrimitive(a.Primitive.Void,"void");this.booleanType=this.enterPrimitive(a.Primitive.Boolean,"bool");this.doubleType=this.enterPrimitive(a.Primitive.Double,"number");this.importedGlobals.ambientEnclosedTypes.addPublicMember("number",
this.doubleType.symbol);this.stringType=this.enterPrimitive(a.Primitive.String,"string");this.anyType=this.enterPrimitive(a.Primitive.Any,"any");this.nullType=this.enterPrimitive(a.Primitive.Null,"null");this.undefinedType=this.enterPrimitive(a.Primitive.Undefined,"undefined");this.setCollectionMode(b.Resident);this.wildElm=new a.TypeSymbol("_element",0,-1,new a.Type);this.importedGlobalsTypeTable.addPublicMember(this.wildElm.name,this.wildElm);this.mod=new a.ModuleType(c,i);this.mod.members=d;this.mod.ambientMembers=
e;this.mod.containedScope=this.globalScope;this.gloMod=new a.TypeSymbol(a.globalId,0,-1,this.mod);this.mod.members.addPublicMember(this.gloMod.name,this.gloMod);this.defineGlobalValue("undefined",this.undefinedType)};h.prototype.enterPrimitive=function(b,e){var c=new a.Type;c.primitiveTypeClass=b;var i=new a.TypeSymbol(e,0,-1,c);i.typeCheckStatus=a.TypeCheckStatus.Finished;c.symbol=i;this.importedGlobals.enter(null,null,i,this.errorReporter,!0,!0,!0);return c};h.prototype.setCollectionMode=function(a){this.residentTypeCheck=
...
this.ambientGlobals;this.dualAmbientGlobalTypes.secondaryTable=this.ambientGlobalTypes};h.prototype.defineGlobalValue=function(b,e){var c=new a.ValueLocation;c.typeLink=new a.TypeLink;c=new a.VariableSymbol(b,0,-1,c);c.setType(e);c.typeCheckStatus=a.TypeCheckStatus.Finished;c.container=this.gloMod;this.importedGlobalsTable.addPublicMember(b,c)};a.PersistentGlobalTypeState=h;var j;j=function(a,b,c){this.contextualType=a;this.provisional=b;this.contextID=c;this.targetAccessorType=this.targetThis=this.targetSig=
null};a.ContextualTypeContext=j;var g=function(a){this.checker=a;this.contextStack=[];this.hadProvisionalErrors=!1};g.contextID=a.TypeCheckStatus.Finished+1;g.prototype.pushContextualType=function(a,b){this.contextStack.push(new j(a,b,g.contextID++));this.checker.errorReporter.pushToErrorSink=b};g.prototype.popContextualType=function(){var a=this.contextStack.pop();this.checker.errorReporter.pushToErrorSink=this.isProvisional();this.hadProvisionalErrors=this.hadProvisionalErrors||a.provisional&&this.checker.errorReporter.getCapturedErrors().length;
...
var e=new a.ScopeChain(this.gloMod,null,this.globalScope),e=new a.TypeCollectionContext(e,this);a.getAstWalkerFactory().walk(b,a.preCollectTypes,a.postCollectTypes,null,e)};h.prototype.makeArrayType=function(b){null==b.arrayCache&&(b.arrayCache=new e,b.arrayCache.arrayType=new a.Type,b.arrayCache.arrayType.elementType=b,b.arrayCache.arrayType.symbol=b.symbol);return b.arrayCache.arrayType};h.prototype.getParameterList=function(b,e){var c=null,c=null,i=b.members.length,f=0,k=[];if(0<i)for(var c=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,
new a.StringHashTable)),c=new a.SymbolScopeBuilder(c,null,null,null,null,e),g=0;g<i;g++){var n=b.members[g],h=new a.ValueLocation,j=new a.ParameterSymbol(n.id.text,n.minChar,this.locationInfo.unitIndex,h);j.declAST=n;n.id.sym=j;n.sym=j;h.symbol=j;h.typeLink=a.getTypeLink(n.typeExpr,this,!1);c.enter(null,n,j,this.errorReporter,!0,!1,!1);k[k.length]=j;n.isOptionalArg()||f++}return{parameters:k,nonOptionalParameterCount:f}};h.prototype.createFunctionSignature=function(b,e,c,i,f){var k=a.hasFlag(b.fncFlags,
a.FncFlags.Exported|a.FncFlags.ClassPropertyMethodExported)||e==this.gloMod,g=a.hasFlag(b.fncFlags,a.FncFlags.Static),n=a.hasFlag(b.fncFlags,a.FncFlags.Private),h=a.hasFlag(b.fncFlags,a.FncFlags.Definition),j=a.hasFlag(b.fncFlags,a.FncFlags.Ambient),q=b.isConstructMember()||b.isConstructor,p=e==this.gloMod,r=new a.Signature,s=b.fncFlags&a.FncFlags.IsFunctionExpression;b.returnTypeAnnotation||h?r.returnType=a.getTypeLink(b.returnTypeAnnotation,this,!1):(r.returnType=new a.TypeLink,r.returnType.type=
this.anyType);r.hasVariableArgList=b.variableArgList;h=this.getParameterList(b.args,e);r.parameters=h.parameters;r.nonOptionalParameterCount=h.nonOptionalParameterCount;b.signature=r;r.declAST=b;var t=i&&i.getType()&&!i.isAccessor()&&(b.isSignature()||j==a.hasFlag(i.flags,a.SymbolFlags.Ambient));t&&n!=a.hasFlag(i.flags,a.SymbolFlags.Private)&&this.errorReporter.simpleError(b,"Public/Private visibility of overloads does not agree");h=t?i.getType():new a.Type;q?(null==h.construct&&(h.construct=new a.SignatureGroup),
...
var v=h.instanceType;v&&!g&&(null==v.call?v.call=h.call:h.call&&v.call.signatures.concat(h.call.signatures));var v=null,A=!1;b.name&&!b.name.isMissing()?v=b.name.text:b.hint&&(v=b.hint,A=!0);null==h.symbol&&(h.symbol=new a.TypeSymbol(v?v:this.anon,b.minChar,this.locationInfo.unitIndex,h),t||(h.symbol.declAST=b));g&&(h.symbol.flags|=a.SymbolFlags.Static);j&&(h.symbol.flags|=a.SymbolFlags.Ambient);n&&(h.symbol.flags|=a.SymbolFlags.Private);h.symbol.isMethod=b.isMethod();h.symbol.isMethod&&(h.symbol.flags|=
a.SymbolFlags.Property);b.type=h;if(!q)if(v&&!s&&!b.isAccessor()&&!A)if(f)if(b.isMethod()&&g)e.type.members.publicMembers.add(v,h.symbol)||this.errorReporter.duplicateIdentifier(b,v),h.symbol.container=e;else{if(null==i||i.declAST&&!i.declAST.isOverload&&e.isType())c.enter(e,b,h.symbol,this.errorReporter,!n&&(k||g||p),!1,j)}else b.isSpecialFn()||(h.symbol.container=e);else b.isSpecialFn()||(h.symbol.container=e);if(t&&(b=i?i.getType():null,h!=b&&(null==h.construct?h.construct=b&&b.construct?b.construct:
new a.SignatureGroup:b&&b.construct&&h.construct.signatures.concat(b.construct.signatures),b))){null==h.call?h.call=b.call:b.call&&h.call.signatures.concat(b.call.signatures);if(!g&&(null==h.instanceType&&(h.instanceType=b.instanceType),v=h.instanceType))null==v.call?v.call=b.call:b.call&&v.call.signatures.concat(b.call.signatures);null==h.index?h.index=b.index:b.index&&h.index.signatures.concat(b.index.signatures)}return r};h.prototype.createAccessorSymbol=function(b,e,c,i,f,k,g){var h=null,j=b.signature,
u=b.name.text,q=a.hasFlag(b.fncFlags,a.FncFlags.Static),p=a.hasFlag(b.fncFlags,a.FncFlags.Private);null==e?(e=new a.ValueLocation,h=new a.FieldSymbol(u,b.minChar,this.locationInfo.unitIndex,!1,e),e.symbol=h,h.declAST=b,a.hasFlag(b.fncFlags,a.FncFlags.GetAccessor)?(h.getter&&this.errorReporter.simpleError(b,"Redeclaration of property getter"),h.getter=j.declAST.type.symbol):(h.setter&&this.errorReporter.simpleError(b,"Redeclaration of property setter"),h.setter=j.declAST.type.symbol),e.typeLink=a.getTypeLink(null,
this,!1),i?c?(c.members.publicMembers.add(u,h)||this.errorReporter.duplicateIdentifier(b,h.name),h.container=c.symbol):this.errorReporter.simpleError(b,"Accessor property may not be added in this context"):k.enter(g,b,h,this.errorReporter,!p||q,!1,!1),f&&(h.flags|=a.SymbolFlags.Property),q&&(h.flags|=a.SymbolFlags.Static),h.flags=p?h.flags|a.SymbolFlags.Private:h.flags|a.SymbolFlags.Public):(h=e,p!=a.hasFlag(h.flags,a.SymbolFlags.Private)&&this.errorReporter.simpleError(b,"Getter and setter accessors do not agree in visibility"),
a.hasFlag(b.fncFlags,a.FncFlags.GetAccessor)?(h.getter&&this.errorReporter.simpleError(b,"Redeclaration of property getter"),h.getter=b.type.symbol):(h.setter&&this.errorReporter.simpleError(b,"Redeclaration of property setter"),h.setter=b.type.symbol));return h};h.prototype.addBases=function(b,e,c){b.addParentScope(new a.SymbolTableScope(e.members,e.ambientMembers,e.getAllEnclosedTypes(),e.getAllAmbientEnclosedTypes(),e.symbol));var i=0,f;if(e.extendsList)for(var k=e.extendsList.length;i<k;i++){f=
e.extendsList[i];if(c.baseId==f.typeID){this.errorReporter.reportErrorFromSym(f.symbol,"Type '"+c.base+"' is recursively referenced as a base class of itself");f.symbol.flags|=a.SymbolFlags.RecursivelyReferenced;break}this.addBases(b,f,c)}};h.prototype.scopeOf=function(b){var e=new a.SymbolAggregateScope(b.symbol);this.addBases(e,b,{base:b.symbol&&b.symbol.name?b.symbol.name:"{}",baseId:b.typeID});return e};h.prototype.lookupMemberType=function(a,b){var c=null;a.containedScope?c=a.containedScope.find(b,
...
".d.ts",f=c(b)),f||(b=a.stripQuotes(i)+".d.str",f=c(b)),!f&&!a.isRelative(i))){i=a.stripQuotes(i);for(e=a.getRootFilePath(a.switchToForwardSlashes(e));null==f&&""!=e&&"/"!=e;)b=a.normalizePath(e+i+".ts"),f=c(b),null==f&&(b=a.changePathToSTR(b),f=c(b)),null==f&&(b=a.changePathToDTS(b),f=c(b)),null==f&&(b=a.changePathToDSTR(b),f=c(b)),null==f&&(e=(e=a.normalizePath(e+".."))&&"/"!=e?e+"/":e)}return f};h.prototype.resolveTypeMember=function(b,e){var c=e.operand1,i=e.operand2,f=this.anyType,k=this.anyType;
if(c&&i&&i.nodeType==a.NodeType.Name){if(c.nodeType==a.NodeType.Dot)k=this.resolveTypeMember(b,c);else if(c.nodeType==a.NodeType.Name){var g=b.find(c.text,!1,!0);if(null==g)this.errorReporter.unresolvedSymbol(c,c.text);else if(g.isType()){if(g.aliasLink&&(!g.type&&g.aliasLink.alias.nodeType==a.NodeType.Name)&&(k=this.findSymbolForDynamicModule(g.aliasLink.alias.text,this.locationInfo.filename,function(a){return b.find(a,!1,!0)})))g.type=k.getType();if(a.optimizeModuleCodeGen&&g&&(k=g.getType())&&
g.aliasLink&&g.onlyReferencedAsTypeRef)if((k=k.symbol.declAST)&&a.hasFlag(k.modFlags,a.ModuleFlags.IsDynamic))g.onlyReferencedAsTypeRef=!this.resolvingBases;g.visible(b,this)||this.errorReporter.simpleError(c,"The symbol '"+c.text+"' is not visible at this point");k=g.getType();c.sym=g}else this.errorReporter.simpleError(c,"Expected type")}k||(k=this.anyType);k!=this.anyType&&(f=this.lookupMemberType(k,i.text),null==f?(f=this.anyType,this.errorReporter.simpleError(e,"Expected type")):f.symbol.visible(b,
this)||this.errorReporter.simpleError(c,"The symbol '"+i.text+"' is not visible at this point"),i.sym=f.symbol)}f.isClass()&&(f=f.instanceType);return f};h.prototype.resolveFuncDecl=function(a,b,c){var c=this.createFunctionSignature(a,b.container,b,c,!1).declAST.type.symbol,i;i=a.isConstructMember()?c.type.construct.signatures:a.isIndexerMember()?c.type.getInstanceType().index.signatures:c.type.call.signatures;i=i[i.length-1];for(var f=i.parameters.length,e=0;e<f;e++)this.resolveTypeLink(b,i.parameters[e].parameter.typeLink,
!0);f&&a.variableArgList&&!i.parameters[f-1].parameter.typeLink.type.elementType&&(this.errorReporter.simpleErrorFromSym(i.parameters[f-1].parameter.symbol,"... parameter must have array type"),i.parameters[f-1].parameter.typeLink.type.elementType=this.makeArrayType(i.parameters[f-1].parameter.typeLink.type));this.resolveTypeLink(b,i.returnType,a.isSignature());return c};h.prototype.resolveVarDecl=function(b,e){var c=new a.ValueLocation,i=new a.FieldSymbol(b.id.text,b.minChar,this.locationInfo.unitIndex,
(b.varFlags&a.VarFlags.Readonly)==a.VarFlags.None,c);i.transferVarFlags(b.varFlags);c.symbol=i;i.declAST=b;c.typeLink=a.getTypeLink(b.typeExpr,this,null==b.init);this.resolveTypeLink(e,c.typeLink,!0);b.sym=i;b.type=c.typeLink.type;return i};h.prototype.resolveTypeLink=function(b,e,c){var i=0;if(null==e.type){var f=e.ast;if(f)for(;null==e.type;)switch(f.nodeType){case a.NodeType.Name:var k=f,g=b.find(k.text,!1,!0);null==g?(e.type=this.anyType,this.errorReporter.unresolvedSymbol(k,k.text)):g.isType()?
(g.visible(b,this)||this.errorReporter.simpleError(f,"The symbol '"+k.text+"' is not visible at this point"),k.sym=g,e.type=g.getType(),e.type?e.type.isClass()&&(e.type=e.type.instanceType):e.type=this.anyType):(e.type=this.anyType,this.errorReporter.simpleError(f,"Expected type"));break;case a.NodeType.Dot:e.type=this.resolveTypeMember(b,f);break;case a.NodeType.TypeRef:i=f.arrayCount;f=f.term;null==f&&(e.type=this.anyType);break;case a.NodeType.Interface:var h=f,k=new a.Type,g=new a.TypeSymbol(h.name.text,
f.minChar,this.locationInfo.unitIndex,k);k.symbol=g;k.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable));k.containedScope=new a.SymbolTableScope(k.members,null,null,null,g);k.containedScope.container=g;k.memberScope=k.containedScope;for(var h=h.members.members,j=h.length,u=0;u<j;u++){var q=h[u],p=null,r=!0,s=null;q.nodeType==a.NodeType.FuncDecl?(s=q.name,p=k.members.allMembers.lookup(q.getNameText()),r=null==p,q.isSpecialFn()?(r=!1,p=this.resolveFuncDecl(q,
b,g)):p=this.resolveFuncDecl(q,b,p),q.type=p.type):(s=q.id,p=this.resolveVarDecl(q,b));r&&(s&&a.hasFlag(s.flags,a.ASTFlags.OptionalName)&&(p.flags|=a.SymbolFlags.Optional),k.members.allMembers.add(p.name,p)||this.errorReporter.duplicateIdentifier(f,p.name))}f.type=k;e.type=k;break;case a.NodeType.FuncDecl:k=this.resolveFuncDecl(f,b,null);e.type=k.type;break;default:e.type=this.anyType,this.errorReporter.simpleError(f,"Expected type")}for(b=i;0<b;b--)e.type=this.makeArrayType(e.type);c&&null==e.type&&
(e.type=this.anyType);e.ast&&(e.ast.type=e.type)}};h.prototype.findMostApplicableSignature=function(a,b){if(1==a.length)return{sig:a[0].signature,ambiguous:!1};for(var c=a[0],i=null,f=null,e=null,g=null,f=!1,h=1;h<a.length;h++){for(var i=a[h],j=0,j=0;b&&j<b.members.length;j++)if(f=b.members[j].type,e=j<c.signature.parameters.length?c.signature.parameters[j].getType():c.signature.parameters[c.signature.parameters.length-1].getType().elementType,g=j<i.signature.parameters.length?i.signature.parameters[j].getType():
i.signature.parameters[i.signature.parameters.length-1].getType().elementType,!this.typesAreIdentical(e,g))if(this.typesAreIdentical(f,e))break;else if(this.typesAreIdentical(f,g)){c=i;break}else if(this.sourceIsSubtypeOfTarget(e,g))break;else if(this.sourceIsSubtypeOfTarget(g,e)){c=i;break}else if(i.hadProvisionalErrors)break;else if(c.hadProvisionalErrors){c=i;break}f=!b||j==b.members.length?!this.findBestCommonType(c.signature.returnType.type,null,{getLength:function(){return 2},setTypeAtIndex:function(){},
getTypeAtIndex:function(a){return a?i.signature.returnType.type:c.signature.returnType.type}}):!1}return{sig:c.signature,ambiguous:f}};h.prototype.getApplicableSignatures=function(b,e,c){for(var i=[],f=null,k=!1,g=!1,h=0;h<b.length;h++){for(var k=!1,j=0;j<e.members.length;j++)if(!(j>=b[h].parameters.length)&&(f=b[h].parameters[j].getType(),b[h].declAST.variableArgList&&(j>=b[h].nonOptionalParameterCount-1&&f.isArray())&&(f=f.elementType),f!=this.anyType))if(e.members[j].nodeType==a.NodeType.FuncDecl){if(!(this.typeFlow.functionInterfaceType&&
f==this.typeFlow.functionInterfaceType))if(this.canContextuallyTypeFunction(f,e.members[j],!0)){if(this.typeCheckWithContextualType(f,!0,!0,e.members[j]),this.cleanStartedPTO(),g=this.hadProvisionalErrors(),this.sourceIsAssignableToTarget(e.members[j].type,f,c)||(c&&c.setMessage("Could not apply type '"+f.getTypeName()+"' to argument "+(j+1)+", which is of type '"+e.members[j].type.getTypeName()+"'"),k=!0),g&&(this.typeCheckWithContextualType(null,!0,!0,e.members[j]),this.sourceIsAssignableToTarget(e.members[j].type,
f)||(k=!0),this.cleanStartedPTO()),this.resetProvisionalErrors(),k)break}else if(this.canContextuallyTypeFunction(f,e.members[j],!1)){if(this.typeFlow.typeCheck(e.members[j]),!this.sourceIsAssignableToTarget(e.members[j].type,f,c))break}else break}else if(e.members[j].nodeType==a.NodeType.ObjectLit){if(!(this.typeFlow.objectInterfaceType&&f==this.typeFlow.objectInterfaceType)&&(this.typeCheckWithContextualType(f,!0,!0,e.members[j]),this.cleanStartedPTO(),g=this.hadProvisionalErrors(),this.sourceIsAssignableToTarget(e.members[j].type,
f,c)||(c&&c.setMessage("Could not apply type '"+f.getTypeName()+"' to argument "+(j+1)+", which is of type '"+e.members[j].type.getTypeName()+"'"),k=!0),g&&(this.typeCheckWithContextualType(null,!0,!0,e.members[j]),this.sourceIsAssignableToTarget(e.members[j].type,f)||(k=!0),this.cleanStartedPTO()),this.resetProvisionalErrors(),k))break}else if(e.members[j].nodeType==a.NodeType.ArrayLit&&!(this.typeFlow.arrayInterfaceType&&f==this.typeFlow.arrayInterfaceType)){this.typeCheckWithContextualType(f,!0,
!0,e.members[j]);this.cleanStartedPTO();g=this.hadProvisionalErrors();if(!this.sourceIsAssignableToTarget(e.members[j].type,f,c)){c&&c.setMessage("Could not apply type '"+f.getTypeName()+"' to argument "+(j+1)+", which is of type '"+e.members[j].type.getTypeName()+"'");break}g&&(this.typeCheckWithContextualType(null,!0,!0,e.members[j]),this.sourceIsAssignableToTarget(e.members[j].type,f)||(k=!0),this.cleanStartedPTO());this.resetProvisionalErrors();if(k)break}j==e.members.length&&(i[i.length]={signature:b[h],
hadProvisionalErrors:g});g=!1}return i};h.prototype.canContextuallyTypeFunction=function(a,b,c){if(b.isParenthesized||b.isMethod()||c&&b.returnTypeAnnotation||b.isInlineCallLiteral)return!1;c=c||this.typeFlow.functionInterfaceType==a;if(!c)return!0;b.signature||(this.createFunctionSignature(b,this.typeFlow.scope.container,this.typeFlow.scope,null,null),this.typeFlow.typeCheck(b));for(var b=b.signature,i=b.parameters.length,f=0;f<i;f++){var e=b.parameters[f].declAST;if(c&&e.typeExpr)return!1}if(a.construct&&
a.call)return!1;a=a.construct?a.construct:a.call;return!a||1<a.signatures.length?!1:!0};h.prototype.canContextuallyTypeObjectLiteral=function(b,e){if(b==this.typeFlow.objectInterfaceType)return!0;var c=e.operand;if(!c||!b.memberScope)return!1;for(var i=null,i=null,f="",k={},g=0;g<c.members.length;g++){i=c.members[g].operand1;if(i.nodeType==a.NodeType.Name)f=i.text;else if(i.nodeType==a.NodeType.QString)i=i.text,f=i.substring(1,i.length-1);else return!1;i=b.memberScope.find(f,!0,!1);if(!i)return!1;
k[f]=!0}c=b.memberScope.getAllValueSymbolNames(!0);for(g=0;g<c.length;g++)if(i=b.memberScope.find(c[g],!0,!1),!k[c[g]]&&!a.hasFlag(i.flags,a.SymbolFlags.Optional))return!1;return!0};h.prototype.widenType=function(a){return a==this.undefinedType||a==this.nullType?this.anyType:a};h.prototype.isNullOrUndefinedType=function(a){return a==this.undefinedType||a==this.nullType};h.prototype.findBestCommonType=function(a,b,c,i){var f=0,e=c.getLength(),g=0;b&&(a=a?a.mergeOrdered(b,this):b);for(var h=a;g<e;){for(f=
0;f<e;f++)if(f!=g){if(h&&(a=h.mergeOrdered(c.getTypeAtIndex(f),this,i)))h=a;if(a==this.anyType||null==a)break;else b&&c.setTypeAtIndex(f,b)}if(h&&a)break;g++;g<e&&(h=c.getTypeAtIndex(g))}return a};h.prototype.typesAreIdentical=function(b,e){if(b==e)return!0;if(!b||!e)return!1;var c=e.typeID<<16|b.typeID;if(this.identicalCache[c])return!0;if(b.typeFlags&a.TypeFlags.IsEnum||e.typeFlags&a.TypeFlags.IsEnum)return!1;if(b.isArray()||e.isArray()){if(!b.isArray()||!e.isArray())return!1;this.identicalCache[c]=
!1;var i=this.typesAreIdentical(b.elementType,e.elementType);this.subtypeCache[c]=i?!0:void 0;return i}if(b.primitiveTypeClass!=e.primitiveTypeClass)return!1;this.identicalCache[c]=!1;if(b.memberScope&&e.memberScope){var i=b.memberScope.getAllValueSymbolNames(!0).sort(),f=e.memberScope.getAllValueSymbolNames(!0).sort();if(i.length!=f.length)return this.identicalCache[c]=void 0,!1;for(var k=null,g=null,g=k=null,h=0;h<i.length;h++){if(i[h]!=f[h])return this.identicalCache[c]=void 0,!1;k=b.memberScope.find(i[h],
!1,!1);g=e.memberScope.find(f[h],!1,!1);if((k.flags&a.SymbolFlags.Optional)!=(g.flags&a.SymbolFlags.Optional))return this.identicalCache[c]=void 0,!1;k=k.getType();g=g.getType();if((!k||!(g&&void 0!=this.identicalCache[g.typeID<<16|k.typeID]))&&!this.typesAreIdentical(k,g))return this.identicalCache[c]=void 0,!1}}else if(b.memberScope||e.memberScope)return this.identicalCache[c]=void 0,!1;return!this.signatureGroupsAreIdentical(b.call,e.call)||!this.signatureGroupsAreIdentical(b.construct,e.construct)||
!this.signatureGroupsAreIdentical(b.index,e.index)?(this.identicalCache[c]=void 0,!1):this.identicalCache[c]=!0};h.prototype.signatureGroupsAreIdentical=function(a,b){if(a==b)return!0;if(!a||!b||a.signatures.length!=b.signatures.length)return!1;for(var c=null,i=null,f=!1,e=0;e<a.signatures.length;e++){for(var c=a.signatures[e],g=0;g<b.signatures.length;g++)if(i=b.signatures[g],this.signaturesAreIdentical(c,i)){f=!0;break}if(f)f=!1;else return!1}return!0};h.prototype.signaturesAreIdentical=function(a,
...
this.assignableCache,c)};h.prototype.signatureIsAssignableToTarget=function(a,b,c){return this.signatureIsRelatableToTarget(a,b,!0,this.assignableCache,c)};h.prototype.sourceIsRelatableToTarget=function(b,e,c,i,f){if(b==e||!b||!e)return!0;var g=b.typeID<<16|e.typeID;if(i[g])return!0;if(c){if(b==this.anyType||e==this.anyType)return!0}else if(e==this.anyType)return!0;if(b==this.undefinedType||b==this.nullType&&e!=this.undefinedType&&e!=this.voidType||e==this.numberType&&b.typeFlags&a.TypeFlags.IsEnum||
b==this.numberType&&e.typeFlags&a.TypeFlags.IsEnum)return!0;if(b.typeFlags&a.TypeFlags.IsEnum||e.typeFlags&a.TypeFlags.IsEnum)return!1;if(b.isArray()||e.isArray()){if(!b.isArray()||!e.isArray())return!1;i[g]=!1;f=this.sourceIsRelatableToTarget(b.elementType,e.elementType,c,i,f);i[g]=f?!0:void 0;return f}if(b.primitiveTypeClass!=e.primitiveTypeClass)if(e.primitiveTypeClass==a.Primitive.None)if(b==this.numberType&&this.typeFlow.numberInterfaceType)b=this.typeFlow.numberInterfaceType;else if(b==this.stringType&&
this.typeFlow.stringInterfaceType)b=this.typeFlow.stringInterfaceType;else if(b==this.booleanType&&this.typeFlow.booleanInterfaceType)b=this.typeFlow.booleanInterfaceType;else return!1;else return!1;i[g]=!1;if(b.hasBase(e))return i[g]=!0;if(this.typeFlow.objectInterfaceType&&e==this.typeFlow.objectInterfaceType||this.typeFlow.functionInterfaceType&&(b.call||b.construct)&&e==this.typeFlow.functionInterfaceType)return!0;if(e.isClass()||e.isClassInstance())return i[g]=void 0,!1;if(e.memberScope&&b.memberScope)for(var h=
e.memberScope.getAllValueSymbolNames(!0),j=null,m=null,u=null,q=m=null,p=0;p<h.length;p++)if(j=e.memberScope.find(h[p],!1,!1),m=b.memberScope.find(h[p],!1,!1),!(j.kind()==a.SymbolKind.Variable&&j.variable.typeLink.ast&&j.variable.typeLink.ast.nodeType==a.NodeType.Name&&"IArguments"==j.variable.typeLink.ast.text)){j.isInferenceSymbol()&&(q=j,q.typeCheckStatus==a.TypeCheckStatus.NotStarted&&this.typeFlow.typeCheck(j.declAST));u=j.getType();if(!m&&(this.typeFlow.objectInterfaceType&&(m=this.typeFlow.objectInterfaceType.memberScope.find(h[p],
!1,!1)),!m)){if(this.typeFlow.functionInterfaceType&&(u.call||u.construct))m=this.typeFlow.functionInterfaceType.memberScope.find(h[p],!1,!1);if(!m)if(j.flags&a.SymbolFlags.Optional)continue;else return i[g]=void 0,f&&(f.flags|=a.TypeRelationshipFlags.RequiredPropertyIsMissing,f.addMessageToFront("Type '"+b.getTypeName()+"' is missing property '"+h[p]+"' from type '"+e.getTypeName()+"'")),!1}m.isInferenceSymbol()&&(q=m,q.typeCheckStatus==a.TypeCheckStatus.NotStarted&&this.typeFlow.typeCheck(m.declAST));
m=m.getType();if((!u||!(m&&void 0!=i[m.typeID<<16|u.typeID]))&&!this.sourceIsRelatableToTarget(m,u,c,i,f))return i[g]=void 0,f&&(f.flags|=a.TypeRelationshipFlags.IncompatiblePropertyTypes,f.addMessageToFront("Types of property '"+j.name+"' of types '"+b.getTypeName()+"' and '"+e.getTypeName()+"' are incompatible")),!1}return(b.call||e.call)&&!this.signatureGroupIsRelatableToTarget(b.call,e.call,c,i,f)?(f&&(b.call&&e.call?f.addMessageToFront("Call signatures of types '"+b.getTypeName()+"' and '"+e.getTypeName()+
"' are incompatible"):(c=e.call?e.getTypeName():b.getTypeName(),b=!e.call?e.getTypeName():b.getTypeName(),f.setMessage("Type '"+c+"' requires a call signature, but Type '"+b+"' lacks one")),f.flags|=a.TypeRelationshipFlags.IncompatibleSignatures),i[g]=void 0,!1):(b.construct||e.construct)&&!this.signatureGroupIsRelatableToTarget(b.construct,e.construct,c,i,f)?(f&&(b.construct&&e.construct?f.addMessageToFront("Construct signatures of types '"+b.getTypeName()+"' and '"+e.getTypeName()+"' are incompatible"):
(c=e.construct?e.getTypeName():b.getTypeName(),b=!e.construct?e.getTypeName():b.getTypeName(),f.setMessage("Type '"+c+"' requires a construct signature, but Type '"+b+"' lacks one")),f.flags|=a.TypeRelationshipFlags.IncompatibleSignatures),i[g]=void 0,!1):e.index&&!this.signatureGroupIsRelatableToTarget(!b.index&&this.typeFlow.objectInterfaceType?this.typeFlow.objectInterfaceType.index:b.index,!e.index&&this.typeFlow.objectInterfaceType?this.typeFlow.objectInterfaceType.index:e.index,c,i,f)?(f&&(f.addMessageToFront("Index signatures of types '"+
b.getTypeName()+"' and '"+e.getTypeName()+"' are incompatible"),f.flags|=a.TypeRelationshipFlags.IncompatibleSignatures),i[g]=void 0,!1):i[g]=!0};h.prototype.signatureGroupIsRelatableToTarget=function(a,b,c,i,f){if(a==b)return!0;if(!a||!b)return!1;for(var e=null,g=null,h=!1,j=0;j<b.signatures.length;j++){for(var e=b.signatures[j],u=0;u<a.signatures.length;u++)if(g=a.signatures[u],this.signatureIsRelatableToTarget(g,e,c,i,f)){h=!0;break}if(h)h=!1;else return!1}return!0};h.prototype.signatureIsRelatableToTarget=
function(b,e,c,i,f){if(!b.parameters||!e.parameters)return!1;var g=e.hasVariableArgList?e.nonOptionalParameterCount-1:e.nonOptionalParameterCount,h=b.hasVariableArgList?b.nonOptionalParameterCount-1:b.nonOptionalParameterCount;if(h>g&&!e.hasVariableArgList)return f&&(f.flags|=a.TypeRelationshipFlags.SourceSignatureHasTooManyParameters,f.addMessageToFront("Call signature expects "+g+" or fewer parameters")),!1;var j=b.returnType.type,m=e.returnType.type;if(m!=this.voidType&&!this.sourceIsRelatableToTarget(j,
m,c,i,f))return f&&(f.flags|=a.TypeRelationshipFlags.IncompatibleReturnTypes),!1;for(var j=h<g&&b.hasVariableArgList?g:h,u=m=null,q=0,p=0;q<j;q++,p++)if(!b.hasVariableArgList||q<h?m=b.parameters[q].parameter.typeLink.type:q==h&&(m=b.parameters[q].parameter.typeLink.type,m.elementType&&(m=m.elementType)),p<e.parameters.length&&p<g?u=e.parameters[p].parameter.typeLink.type:e.hasVariableArgList&&p==g&&(u=e.parameters[p].parameter.typeLink.type,u.elementType&&(u=u.elementType)),!this.sourceIsRelatableToTarget(m,
u,c,i,f)&&!this.sourceIsRelatableToTarget(u,m,c,i,f))return f&&(f.flags|=a.TypeRelationshipFlags.IncompatibleParameterTypes),!1;return!0};a.TypeChecker=h})(TypeScript||(TypeScript={}));
(function(a){function e(c,b){if(c){var f=c.members.length;null==b&&(b=[]);for(var i=0;i<f;i++){var d=c.members[i];d.nodeType==a.NodeType.Call&&(d=d.target);var e=new a.TypeLink;e.ast=d;b[b.length]=e}}return b}function h(a,c){a.extendsTypeLinks=e(c.extendsList,a.extendsTypeLinks);a.implementsTypeLinks=e(c.implementsList,a.implementsTypeLinks)}function b(c){var b=new a.Signature;b.returnType=new a.TypeLink;b.returnType.type=c.instanceType;b.parameters=[];c.construct=new a.SignatureGroup;c.construct.addSignature(b)}
function j(a,c){var b=c.scope.find(a,!1,!0);null==b&&c.previous&&(b=j(a,c.previous));return b}function g(c,b){var f=null;switch(c.nodeType){case a.NodeType.Name:var i=c.text,f=function(){return b.members?b.members.lookup(i):j(i,b.topLevelScope)},f=a.isQuoted(i)?b.tcContext.checker.findSymbolForDynamicModule(i,b.tcContext.script.locationInfo.filename,f):f(i);break;case a.NodeType.Dot:var d=g(c.operand1,b);d&&d.getType()&&(f=g(c.operand2,b))}if(f)if(d=f.getType()){if(d=d.members)b.members=d.publicMembers}else b.tcContext.checker.errorReporter.simpleError(c,
"Potentially circular alias reference - could not obtain type of alias");return f}function d(c,b,f){var b=f.scopeChain,i=null,i=null,d=a.hasFlag(c.varFlags,a.VarFlags.Exported),e=g(c.alias,{topLevelScope:b,members:null,tcContext:f}),k=f.scopeChain.container==f.checker.gloMod;e&&(e=e.getType())&&(i=e);i=new a.TypeSymbol(c.id.text,c.minChar,f.checker.locationInfo.unitIndex,i);i.aliasLink=c;f.scopeChain.moduleDecl&&(i.declModule=f.scopeChain.moduleDecl);i.declAST=c;c.id.sym=i;b.scope.enter(b.container,
c,i,f.checker.errorReporter,d||k,!0,!1);b.scope.enter(b.container,c,i,f.checker.errorReporter,d||k,!1,!1);return!0}function l(c,b,f){var i=f.scopeChain,d=a.hasFlag(c.modFlags,a.ModuleFlags.Ambient),b=a.hasFlag(c.modFlags,a.ModuleFlags.IsEnum),e=f.scopeChain.container==f.checker.gloMod,g=a.hasFlag(c.modFlags,a.ModuleFlags.Exported),k=c.name.text;a.isQuoted(k);var h=i.scope.findLocal(k,!1,!1),l=null,j=null;null==h||h.kind()!=a.SymbolKind.Type?(null==j&&(j=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,
new a.StringHashTable)),h=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),j=new a.ModuleType(j,h),b&&(j.typeFlags|=a.TypeFlags.IsEnum),j.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),j.ambientMembers=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),j.setHasImplementation()),l=new a.TypeSymbol(k,c.minChar,f.checker.locationInfo.unitIndex,j),f.scopeChain.moduleDecl&&
(l.declModule=f.scopeChain.moduleDecl),l.declAST=c,l.prettyName=c.prettyName,i.scope.enter(i.container,c,l,f.checker.errorReporter,g||e,!0,d),i.scope.enter(i.container,c,l,f.checker.errorReporter,g||e,!1,d),j.symbol=l):(h&&(h.declAST&&h.declAST.nodeType!=a.NodeType.Module)&&f.checker.errorReporter.simpleError(c,"Conflicting symbol name for module '"+k+"'"),l=h,j=l.type.getAllEnclosedTypes().publicMembers,j=null==j?new a.StringHashTable:j,j=new a.ScopedMembers(new a.DualStringHashTable(j,new a.StringHashTable)),
h=l.type.getAllAmbientEnclosedTypes().publicMembers,h=null==h?new a.StringHashTable:h,h=new a.ScopedMembers(new a.DualStringHashTable(h,new a.StringHashTable)),i=l.type.members.publicMembers,i=null==i?new a.StringHashTable:i,i=new a.ScopedMembers(new a.DualStringHashTable(i,new a.StringHashTable)),d=l.type.ambientMembers.publicMembers,d=null==d?new a.StringHashTable:d,d=new a.ScopedMembers(new a.DualStringHashTable(d,new a.StringHashTable)),j=new a.ModuleType(j,h),b&&(j.typeFlags|=a.TypeFlags.IsEnum),
j.members=i,j.ambientMembers=d,j.setHasImplementation(),j.symbol=l,l.addLocation(c.minChar),l.expansions.push(j));f.scopeChain.moduleDecl&&f.scopeChain.moduleDecl.recordNonInterface();g&&(l.flags|=a.SymbolFlags.Exported);if(f.scopeChain.moduleDecl||f.scopeChain.container==f.checker.gloMod)l.flags|=a.SymbolFlags.ModuleMember;c.mod=j;a.pushTypeCollectionScope(l,j.members,j.ambientMembers,j.enclosedTypes,j.ambientEnclosedTypes,f,null,null,c);return!0}function c(c,f,i){var d=i.scopeChain,e,g=null,f=c.name.text,
k=a.hasFlag(c.varFlags,a.VarFlags.Ambient),l=a.hasFlag(c.varFlags,a.VarFlags.Exported),j=i.scopeChain.container==i.checker.gloMod;e=!1;g=d.scope.findLocal(f,!1,!0);if(!g){var w=d.scope.findLocal(f,!1,!1);w&&(w.isType()&&w.declAST&&w.declAST.nodeType==a.NodeType.FuncDecl&&w.declAST.isSignature())&&(g=w,e=!0,l&&(g.flags|=a.SymbolFlags.Exported),k&&(g.flags|=a.SymbolFlags.Ambient),i.scopeChain.scope.enter(i.scopeChain.container,c,g,i.checker.errorReporter,l||j,!0,k))}g&&(!e&&g.declAST!=c&&!g.declAST.isOverload)&&
(g=null);if(null==g){w=d.scope.findLocal(f,!1,!1);d=new a.Type;d.setHasImplementation();e=new a.Type;e.setHasImplementation();d.instanceType=e;d.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable));d.ambientMembers=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable));var g=d,C=new a.ValueLocation;C.typeLink=new a.TypeLink;C.typeLink.ast=c;C.typeLink.type=g.instanceType;var x=new a.FieldSymbol("prototype",c.minChar,
i.checker.locationInfo.unitIndex,!0,C);x.flags|=a.SymbolFlags.Property|a.SymbolFlags.BuiltIn;C.symbol=x;x.declAST=c;g.members.addPublicMember("prototype",x);e.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable));e.ambientMembers=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable));g=new a.TypeSymbol(f,c.minChar,i.checker.locationInfo.unitIndex,d);g.declAST=c;g.instanceType=e;d.symbol=g;e.symbol=g;i.scopeChain.moduleDecl&&
(i.scopeChain.moduleDecl.recordNonInterface(),g.declModule=i.scopeChain.moduleDecl,g.flags|=a.SymbolFlags.ModuleMember);l&&(g.flags|=a.SymbolFlags.Exported);k&&(g.flags|=a.SymbolFlags.Ambient);c.type=d;i.scopeChain.scope.enter(i.scopeChain.container,c,g,i.checker.errorReporter,l||j,!0,k);null==w&&i.scopeChain.scope.enter(i.scopeChain.container,c,g,i.checker.errorReporter,l||j,!1,k)}else d=g.type,null==d.instanceType&&(d.instanceType=new a.Type,d.instanceType.setHasImplementation(),d.instanceType.members=
new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),d.instanceType.symbol=d.symbol,d.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),d.ambientMembers=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable))),e=d.instanceType,c.type=d;c.constructorDecl||(g&&(g.declAST&&g.declAST.type&&g.declAST.type.call&&!g.declAST.isOverload)&&i.checker.errorReporter.duplicateIdentifier(g.declAST,
g.name),b(c.type));d.typeFlags|=a.TypeFlags.IsClass;e.typeFlags|=a.TypeFlags.IsClass;h(e,c);a.pushTypeCollectionScope(g,e.members,e.ambientMembers,null,null,i,e,d,null);return!0}function i(c,b,f){var b=f.scopeChain,i=null,d=null,e=a.hasFlag(c.varFlags,a.VarFlags.Exported),g=f.scopeChain.container==f.checker.gloMod,k=!0,k=!1,l=c.name.text,i=b.scope.findLocal(l,!1,!0);null==i?(d=new a.Type,i=new a.TypeSymbol(l,c.minChar,f.checker.locationInfo.unitIndex,d),d.symbol=i,d.members=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,
new a.StringHashTable)),d.ambientMembers=new a.ScopedMembers(new a.DualStringHashTable(new a.StringHashTable,new a.StringHashTable)),i.declAST=c,i.declModule=f.scopeChain.moduleDecl):(k=!0,d=i.type);d||(d=f.checker.anyType);c.type=d;h(d,c);e&&(i.flags|=a.SymbolFlags.Exported);f.scopeChain.moduleDecl&&(i.flags|=a.SymbolFlags.ModuleMember);k||f.scopeChain.scope.enter(f.scopeChain.container,c,i,f.checker.errorReporter,g||e,!0,!1);a.pushTypeCollectionScope(i,d.members,d.ambientMembers,null,null,f,d,null,
...
c.init);c.sym=d}return!1}function k(c,b,f){var i=f.scopeChain,b=a.hasFlag(c.varFlags,a.VarFlags.Ambient),d=a.hasFlag(c.varFlags,a.VarFlags.Exported),e=f.scopeChain.container==f.checker.gloMod,g=a.hasFlag(c.varFlags,a.VarFlags.Property),k=a.hasFlag(c.varFlags,a.VarFlags.Static),h=a.hasFlag(c.varFlags,a.VarFlags.Private),l=a.hasFlag(c.id.flags,a.ASTFlags.OptionalName);f.scopeChain.moduleDecl&&f.scopeChain.moduleDecl.recordNonInterface();if(g||d||f.scopeChain.container==f.checker.gloMod||f.scopeChain.moduleDecl){if(b&&
(i=i.scope.findLocal(c.id.text,!1,!1)))return c.sym=i,!1;if(null==c.id)return f.checker.errorReporter.simpleError(c,"Expected variable identifier at this location"),!1;var i=new a.ValueLocation,j=new a.FieldSymbol(c.id.text,c.minChar,f.checker.locationInfo.unitIndex,(c.varFlags&a.VarFlags.Readonly)==a.VarFlags.None,i);j.transferVarFlags(c.varFlags);l&&(j.flags|=a.SymbolFlags.Optional);i.symbol=j;j.declAST=c;if(f.scopeChain.moduleDecl||f.scopeChain.container==f.checker.gloMod)j.flags|=a.SymbolFlags.ModuleMember,
j.declModule=f.scopeChain.moduleDecl;a.hasFlag(c.varFlags,a.VarFlags.Property)&&k&&f.scopeChain.classType?(f.scopeChain.classType.members.publicMembers.add(c.id.text,j)||f.checker.errorReporter.duplicateIdentifier(c,j.name),j.container=f.scopeChain.classType.symbol):f.scopeChain.scope.enter(f.scopeChain.container,c,j,f.checker.errorReporter,!h&&(g||d||e||k),!1,b);a.hasFlag(c.varFlags,a.VarFlags.Exported)&&(j.flags|=a.SymbolFlags.Exported);i.typeLink=a.getTypeLink(c.typeExpr,f.checker,null==c.init);
c.sym=j}return!1}function w(c,b,f){var i=f.scopeChain;f.scopeChain.moduleDecl&&f.scopeChain.moduleDecl.recordNonInterface();var b=null,d=c.getNameText(),e=a.hasFlag(c.fncFlags,a.FncFlags.Exported|a.FncFlags.ClassPropertyMethodExported),g=a.hasFlag(c.fncFlags,a.FncFlags.Static);a.hasFlag(c.fncFlags,a.FncFlags.Private);var k=c.isConstructMember()||c.isConstructor,h=(c.isMethod()&&g||c.isAccessor())&&f.scopeChain.classType?f.scopeChain.classType.symbol:f.scopeChain.container,l=f.scopeChain.scope,j=c.name&&
a.hasFlag(c.name.flags,a.ASTFlags.OptionalName),w=!1,D=!1;k&&a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod)&&(h=h.container,l=i.previous.scope);c.unitIndex=f.checker.locationInfo.unitIndex;if(!c.isConstructor&&h&&h.declAST&&h.declAST.nodeType==a.NodeType.FuncDecl&&h.declAST.isConstructor&&!c.isMethod())return w;if(a.hasFlag(c.fncFlags,a.FncFlags.Signature)){i=f.scopeChain.thisType;d&&"__missing"!=d&&(g?b=h.type.members.allMembers.lookup(d):(b=l.findLocal(d,!1,!1),null==b&&(b=l.findLocal(d,!1,!0))),
...
"' already declared as a property");c.type=c.isSpecialFn()&&!g?i?i:b.type:b.type}else{d&&(g?b=h.type.members.allMembers.lookup(d):(c.isConstructor&&f.scopeChain.previous&&(b=f.scopeChain.previous.scope.findLocal(d,!1,!1)),null==b&&(b=l.findLocal(d,!1,!1))),b&&(D=!0,!k&&(b.declAST.nodeType==a.NodeType.FuncDecl&&!b.declAST.isAccessor()&&!b.declAST.isSignature())&&(b=null,D=!1)));b&&(!b.isAccessor()&&b.type&&b.type.construct&&b.type.construct.signatures!=[]&&(null==b.type.construct.signatures[0].declAST||
...
b&&b.isAccessor())c.accessorSymbol=f.checker.createAccessorSymbol(c,b,h.type,c.isMethod()&&g,!0,l,h);c.type.symbol.declAST=c;c.isConstructor&&(w=!0)}e&&(c.type.call&&(c.type.symbol.flags|=a.SymbolFlags.Exported),b&&(!b.isAccessor()&&b.type.call)&&(b.flags|=a.SymbolFlags.Exported));f.scopeChain.moduleDecl&&!c.isSpecialFn()&&(c.type.symbol.flags|=a.SymbolFlags.ModuleMember,c.type.symbol.declModule=f.scopeChain.moduleDecl);b&&j&&(b.flags|=a.SymbolFlags.Optional);return w}a.Continuation=function(a){this.normalBlock=
...
i.returnType.type=c.instanceType,c.construct.addSignature(i)};a.globalId="__GLO";a.preCollectImportTypes=d;a.preCollectModuleTypes=l;a.preCollectClassTypes=c;a.preCollectInterfaceTypes=i;a.preCollectArgDeclTypes=f;a.preCollectVarDeclTypes=k;a.preCollectFuncDeclTypes=w;a.preCollectTypes=function(b,e,g){var h=g.state,j=!1;b.nodeType==a.NodeType.Script?(h.script=b,j=!0):b.nodeType==a.NodeType.List?j=!0:b.nodeType==a.NodeType.Import?j=d(b,e,h):b.nodeType==a.NodeType.With?j=!1:b.nodeType==a.NodeType.Module?
j=l(b,e,h):b.nodeType==a.NodeType.Class?j=c(b,e,h):b.nodeType==a.NodeType.Block?j=!0:b.nodeType==a.NodeType.Interface?j=i(b,e,h):b.nodeType==a.NodeType.ArgDecl?j=f(b,e,h):b.nodeType==a.NodeType.VarDecl?j=k(b,e,h):b.nodeType==a.NodeType.FuncDecl?j=w(b,e,h):b.isStatementOrExpression()&&h.scopeChain.moduleDecl&&h.scopeChain.moduleDecl.recordNonInterface();g.options.goChildren=j;return b};a.postCollectTypes=function(c,b,f){b=f.state;c.nodeType==a.NodeType.Module?a.popTypeCollectionScope(b):c.nodeType==
...
(function(a){var e;e=function(a,b,f){this.container=a;this.previous=b;this.scope=f};a.ScopeChain=e;var h=function(a){this.bb=a;this.defsBySymbol=[];this.useIndexBySymbol=[]};h.prototype.updateTop=function(){for(var a=new j(this.top.bitCount),b=0,f=this.bb.successors.length;b<f;b++){var d=this.bb.successors[b];d.useDef&&a.union(d.useDef.top)}a.difference(this.kill);a.union(this.gen);b=a.notEq(this.top);this.top=a;return b};h.prototype.initialize=function(c){var b=this,f=function(a,c){if(c.isLocalSym(a)){var f=
c.getSymbolIndex(a);b.useIndexBySymbol[f]=[];b.defsBySymbol[f]=!0}},d=new a.AstWalkOptions;d.reverseSiblings=!0;a.getAstWalkerFactory().walk(this.bb.content,function(c,d,e){var g=e.state;null==c&&(c=null);if(c.nodeType==a.NodeType.VarDecl)d=c,(d.init||a.hasFlag(d.varFlags,a.VarFlags.AutoInit))&&f(d.sym,g);else if(c.nodeType==a.NodeType.Name){if(d)if(d.nodeType==a.NodeType.Asg){if(d.operand1==c)return c}else if(d.nodeType==a.NodeType.VarDecl&&d.id==c)return c;e=c.sym;d=c;if(g.isLocalSym(e)){e=g.getSymbolIndex(e);
void 0==b.useIndexBySymbol[e]&&(b.useIndexBySymbol[e]=[]);var k=b.useIndexBySymbol[e],d=g.getUseIndex(d);g.addUse(e,d);k.push(d)}}else c.nodeType>=a.NodeType.Asg&&c.nodeType<=a.NodeType.LastAsg?(d=c,d.operand1&&d.operand1.nodeType==a.NodeType.Name&&(d=d.operand1,f(d.sym,g))):c.nodeType==a.NodeType.FuncDecl&&(e.options.goChildren=!1);return c},null,d,c)};h.prototype.initializeGen=function(a){var b=this.useIndexBySymbol.length;this.gen=new j(a.uses.length);for(a=0;a<b;a++){var f=this.useIndexBySymbol[a];
if(void 0!=f&&0<f.length)for(var d=0,e=f.length;d<e;d++)this.gen.set(f[d],!0)}this.top=this.gen};h.prototype.initializeKill=function(a){this.kill=new j(this.gen.bitCount);for(var b=0,f=this.defsBySymbol.length;b<f;b++)if(this.defsBySymbol[b]){var d=a.useIndexBySymbol[b];if(d)for(var e=0,g=d.length;e<g;e++)this.kill.set(d[e],!0)}};a.BBUseDefInfo=h;var b=function(){this.useIndexBySymbol=[];this.uses=[];this.symbols=[];this.symbolMap=new a.StringHashTable;this.symbolCount=0};b.prototype.getSymbolIndex=
...
"unreachable code")}};d.prototype.printAST=function(c,b){var f=new a.PrintContext(b,null);f.increaseIndent();a.getAstWalkerFactory().walk(c,a.prePrintAST,a.postPrintAST,null,f);f.decreaseIndent()};d.prototype.printBlockContent=function(a,b){for(var f=a.content,d=0,e=f.members.length;d<e;d++)this.printAST(f.members[d],b)};d.prototype.bfs=function(a,b,f,d){var e=this.markBase++,g=[];for(g[g.length]=this.entry;0<g.length;){var h=g.pop();if(!h.marked(e)){h.mark();a&&a(h);var l=h.successors.length;if(0<
l){f&&f();for(l-=1;0<=l;l--){var j=h.successors[l];j.marked(this.markBase)||(b&&b(h,j),g[g.length]=j)}d&&d()}}}};d.prototype.useDef=function(a,d){var f=this,e=new b;e.func=d;this.bfs(function(a){a.useDef=new h(a);a.useDef.initialize(e);f.linearBBs[f.linearBBs.length]=a},null,null,null);var g,l;g=0;for(l=this.linearBBs.length;g<l;g++)this.linearBBs[g].useDef.initializeGen(e),this.linearBBs[g].useDef.initializeKill(e);for(var j=!0;j;){j=!1;for(g=0;g<l;g++)j=this.linearBBs[g].useDef.updateTop()||j}this.entry.useDef.top.map(function(b){b=
...
c.type;if((c=this.globalScope.find("RegExp",!1,!0))&&c.kind()==a.SymbolKind.Type)this.regexType=c.type};d.prototype.cast=function(a,b){return this.castWithCoercion(a,b,!0,!1)};d.prototype.castWithCoercion=function(c,b,f,d){var e=new a.TypeComparisonInfo;this.checker.sourceIsAssignableToTarget(c.type,b,e)||d&&this.checker.sourceIsAssignableToTarget(b,c.type,e)?f&&(c.type=null==b?this.anyType:b.isClass()?b.instanceType:b):this.checker.errorReporter.incompatibleTypes(c,c.type,b,null,this.scope,e);return c};
d.prototype.inScopeTypeCheck=function(c,b){var f=this.scope;this.scope=b;for(var d=this.thisFnc,e=this.thisType,g=this.thisClassNode,h=this.checker.currentModDecl,l=this.enclosingFncIsMethod,j=this.scope.container,p=null;j;){if(j.kind()==a.SymbolKind.Type){var r=j,s=r.type;s.call&&null==p&&(this.enclosingFncIsMethod=r.isMethod,p=j.declAST);if(s.isClass()){this.thisType=s.instanceType;r.declAST&&r.declAST.nodeType==a.NodeType.Class&&(this.thisClassNode=r.declAST);break}if(s.isModuleType()){this.checker.currentModDecl=
r.declAST;break}}j=j.container}this.thisFnc=p;j=this.typeCheck(c);this.thisFnc=d;this.thisType=e;this.thisClassNode=g;this.checker.currentModDecl=h;this.enclosingFncIsMethod=l;this.scope=f;return j};d.prototype.typeCheck=function(a){return a?a.typeCheck(this):null};d.prototype.inScopeTypeCheckDecl=function(c){c.nodeType==a.NodeType.VarDecl||c.nodeType==a.NodeType.ArgDecl?this.inScopeTypeCheckBoundDecl(c):c.nodeType==a.NodeType.FuncDecl&&c.isAccessor()&&this.typeCheckFunction(c)};d.prototype.inScopeTypeCheckBoundDecl=
...
b.unitIndex<this.checker.units.length?this.checker.units[b.unitIndex]:a.unknownLocationInfo;h;){if(h.kind()==a.SymbolKind.Type){var b=h,j=b.type;j.call&&(this.enclosingFncIsMethod=b.isMethod);if(j.isClass()){this.thisType=j.instanceType;break}}h=h.container}this.typeCheckBoundDecl(c);this.scope=l}}this.thisFnc=f;this.thisType=d;this.checker.locationInfo=g;this.enclosingFncIsMethod=e};d.prototype.resolveBoundDecl=function(a){a.typeExpr?((null==a.typeExpr.type||a.typeExpr.type&&a.typeExpr.type==this.anyType&&
...
this.checker.numberType)&&this.checker.sourceIsSubtypeOfTarget(d,this.checker.numberType)?c.type=this.checker.numberType:f==this.checker.anyType||d==this.checker.anyType?c.type=this.checker.numberType:(c.type=this.anyType,this.checker.errorReporter.incompatibleTypes(c,f,d,c.printLabel(),this.scope));return c};d.prototype.typeCheckDotOperator=function(a){a.operand1=this.typeCheck(a.operand1);var b=a.operand1.type,f=null;if(b){if(b==this.anyType)return a.type=this.anyType,a;if(b==this.stringType)if(this.stringInterfaceType)f=
this.stringInterfaceType.memberScope;else return a.type=this.anyType,a;else if(b==this.doubleType)if(this.numberInterfaceType)f=this.numberInterfaceType.memberScope;else return a.type=this.anyType,a;else if(b==this.booleanType)if(this.booleanInterfaceType)f=this.booleanInterfaceType.memberScope;else return a.type=this.anyType,a;else if((b.call||b.construct)&&null==b.members)if(this.functionInterfaceType)f=this.functionInterfaceType.memberScope;else return a.type=this.anyType,a;else if(b.elementType)if(this.arrayInterfaceType)f=
b.elementType.getArrayBase(this.arrayInterfaceType,this.checker).memberScope;else return a.type=this.anyType,a;else f=b.memberScope}if(null==f)this.checker.errorReporter.expectedClassOrInterface(a),a.type=this.anyType;else{var d=a.operand2,e=f.find(d.text,!(this.thisClassNode&&a.operand1.type==this.thisClassNode.type.instanceType),!1);if(!e&&(this.objectInterfaceType&&b)&&(b.isReferenceType()&&(e=this.objectInterfaceType.memberScope.find(d.text,!1,!1)),!e&&this.functionInterfaceType&&(b.call||b.construct)))e=
this.functionInterfaceType.memberScope.find(d.text,!1,!1);!e||!e.visible(f,this.checker)?(a.type=this.anyType,null==e?this.checker.errorReporter.simpleError(d,"The property '"+d.text+"' does not exist on value of type '"+b.getScopedTypeName(this.scope)+"'"):this.checker.errorReporter.simpleError(a,"The property '"+d.text+" on type '"+b.getScopedTypeName(this.scope)+"' is not visible")):(e.isVariable()&&e.isInferenceSymbol()&&(b=e,b.declAST&&!this.checker.typeStatusIsFinished(b.typeCheckStatus)&&this.inScopeTypeCheckDecl(b.declAST)),
d.sym=e,a.type=e.getType())}null==a.type&&(a.type=this.anyType);return a};d.prototype.typeCheckBooleanOperator=function(a){a.operand1=this.typeCheck(a.operand1);a.operand2=this.typeCheck(a.operand2);var b=a.operand1.type,f=a.operand2.type;!this.checker.sourceIsAssignableToTarget(b,f)&&!this.checker.sourceIsAssignableToTarget(f,b)&&this.checker.errorReporter.incompatibleTypes(a,b,f,a.printLabel(),this.scope);a.type=this.booleanType;return a};d.prototype.typeCheckAsgOperator=function(a){var b=!a.operand2.isParenthesized;
a.operand1=this.typeCheck(a.operand1);this.checker.typeCheckWithContextualType(a.operand1.type,this.checker.inProvisionalTypecheckMode(),b,a.operand2);var f=a.operand1.type,d=a.operand2.type;this.astIsWriteable(a.operand1)||this.checker.errorReporter.valueCannotBeModified(a);var e=!1,g=null;a.operand2.type&&(g=a.operand2.type.containedScope,e=!0);a.operand2=this.castWithCoercion(a.operand2,f,b,!1);e&&null==a.operand2.type.containedScope&&(a.operand2.type.containedScope=g);a.type=d;return a};d.prototype.typeCheckIndex=
function(c){c.operand1=this.typeCheck(c.operand1);c.operand2=this.typeCheck(c.operand2);this.checker.styleSettings.literalSubscript||c.operand2.nodeType==a.NodeType.QString&&this.checker.errorReporter.styleError(c,"use literal subscript ('.') notation instead)");var b=c.operand1.type,f=c.operand2.type;b.elementType?f==this.checker.anyType||f==this.checker.numberType||a.hasFlag(f.typeFlags,a.TypeFlags.IsEnum)?c.type=b.elementType:(f!=this.checker.stringType&&this.checker.errorReporter.simpleError(c,
"Illegal property access"),c.type=this.checker.anyType):b.index?f==this.checker.anyType||!(b.index.flags&a.SignatureFlags.IsStringIndexer||b.index.flags&a.SignatureFlags.IsNumberIndexer)||b.index.flags&a.SignatureFlags.IsStringIndexer&&f==this.checker.stringType||b.index.flags&a.SignatureFlags.IsNumberIndexer&&(f==this.checker.numberType||a.hasFlag(f.typeFlags,a.TypeFlags.IsEnum))?(b=this.resolveOverload(c,b.index),c.type=b?b.returnType.type:this.checker.anyType):(f!=this.checker.stringType&&this.checker.errorReporter.simpleError(c,
"Illegal property access"),c.type=this.checker.anyType):((!(b==this.checker.anyType||b==this.checker.stringType||b==this.checker.numberType||b==this.checker.booleanType||b.isReferenceType())||!(f==this.checker.anyType||f==this.checker.stringType||f==this.checker.numberType||a.hasFlag(f.typeFlags,a.TypeFlags.IsEnum)))&&this.checker.errorReporter.simpleError(c,"Illegal property access"),c.type=this.checker.anyType);return c};d.prototype.typeCheckInOperator=function(a){a.operand1=this.cast(this.typeCheck(a.operand1),
...
function(a,b){a.operand1=this.cast(this.typeCheck(a.operand1),this.doubleType);a.operand2=this.cast(this.typeCheck(a.operand2),this.doubleType);b&&!this.astIsWriteable(a.operand1)&&this.checker.errorReporter.valueCannotBeModified(a);a.type=this.doubleType;return a};d.prototype.typeCheckQMark=function(a){a.operand1=this.typeCheck(a.operand1);a.operand2=this.typeCheck(a.operand2);a.operand3=this.typeCheck(a.operand3);var b=a.operand2.type,f=a.operand3.type;b==f?a.type=b:this.checker.sourceIsSubtypeOfTarget(b,
f)?a.type=f:this.checker.sourceIsSubtypeOfTarget(f,b)?a.type=b:(a.type=this.anyType,this.checker.errorReporter.incompatibleTypes(a,b,f,a.printLabel(),this.scope));return a};d.prototype.addFormals=function(a,b,f){for(var d=b.parameters.length,e=0;e<d;e++){var g=b.parameters[e];g.container=a;f.add(g.name,g)}};d.prototype.addLocalsFromScope=function(c,b,f,d,e){for(var g=f.members.length,h=!1,l=0;l<g;l++){var j=f.members[l];if(null==j.sym||j.sym.kind()!=a.SymbolKind.Field){var p=null;if(null==(p=d.lookup(j.id.text))){p=
new a.ValueLocation;p.typeLink=new a.TypeLink;var r=null;a.hasFlag(j.varFlags,a.VarFlags.Static)?(j.varFlags|=a.VarFlags.LocalStatic,r=new a.FieldSymbol(j.id.text,j.minChar,this.checker.locationInfo.unitIndex,!0,p)):r=new a.VariableSymbol(j.id.text,j.minChar,this.checker.locationInfo.unitIndex,p);r.transferVarFlags(j.varFlags);p.symbol=r;r.declAST=j;p.typeLink.ast=j.typeExpr;this.checker.resolveTypeLink(c,p.typeLink,!1);null==j.type&&null==j.init&&(j.type=this.anyType);p.typeLink.type=j.type;p.symbol.container=
b;j.sym=p.symbol;d.add(j.id.text,r);"arguments"==j.id.text&&(h=!0)}else j.type=p.getType(),j.sym=p}}!e&&!h&&(b=new a.ValueLocation,b.typeLink=new a.TypeLink,f=new a.VariableSymbol("arguments",f.minChar,this.checker.locationInfo.unitIndex,b),b.typeLink.ast=new a.Identifier("IArguments"),this.checker.resolveTypeLink(c,b.typeLink,!1),d.add("arguments",f))};d.prototype.addConstructorLocalArgs=function(c,b,f,d){if(b)for(var e=b.members.length,g=0;g<e;g++){var h=b.members[g];if(null==h.sym||d||h.sym.kind()!=
a.SymbolKind.Field){var l=null;if(null==(l=f.lookup(h.id.text))){this.resolveBoundDecl(h);l=new a.ValueLocation;l.typeLink=new a.TypeLink;var j=new a.ParameterSymbol(h.id.text,h.minChar,this.checker.locationInfo.unitIndex,l);j.declAST=h;l.symbol=j;l.typeLink.type=h.type;l.symbol.container=c;h.sym=l.symbol;f.add(h.id.text,j)}else h.type=l.getType(),h.sym=l}}};d.prototype.checkInitSelf=function(a){if(!a.isMethod())for(var b=a.freeVariables,f=0,d=b.length;f<d;f++)if(b[f].isInstanceProperty())return!0;
a=a.scopes;b=a.members.length;for(f=0;f<b;f++)if(this.checkInitSelf(a.members[f]))return!0;return!1};d.prototype.checkPromoteFreeVars=function(c,b){for(var f=c.freeVariables,d=0,e=f.length;d<e;d++){var g=f[d];!g.isInstanceProperty()&&g.container==b&&(a.instanceFilter.reset(),this.scope.search(a.instanceFilter,g.name,!1,!1)&&this.checker.errorReporter.simpleError(c,"Constructor-local variable shadows class property '"+g.name+"'. To access the class property, use 'self."+g.name+"'"),this.checker.errorReporter.simpleError(c,
"Constructor-local variables may not be accessed from instance method bodies. Consider changing local variable '"+g.name+"' to a class property"))}};d.prototype.allReturnsAreVoid=function(c){var b=!0;null==c.signature.returnType.type&&a.getAstWalkerFactory().walk(c.bod,function(c,d,e){d=!0;switch(c.nodeType){case a.NodeType.FuncDecl:d=!1;break;case a.NodeType.Return:c.returnExpression&&(d=b=!1)}e.options.goChildren=d;e.options.goNextSibling=d;return c});return b};d.prototype.classConstructorHasSuperCall=
function(c){var b=!1;a.getAstWalkerFactory().walk(c.bod,function(c,d,e){d=!0;switch(c.nodeType){case a.NodeType.FuncDecl:d=!1;break;case a.NodeType.Call:c.target.nodeType==a.NodeType.Super&&(d=!1,b=!0)}e.options.goChildren=d;return c});return b};d.prototype.typeCheckFunction=function(c){this.nestingLevel=0;var b=c.type,f=b.symbol,d=c.signature;if(this.checker.typeStatusIsFinished(d.typeCheckStatus))return c;if(d.typeCheckStatus==a.TypeCheckStatus.Started)return!c.returnTypeAnnotation&&c.bod&&!c.isSignature()&&
!c.isConstructor&&this.allReturnsAreVoid(c)?d.returnType.type=this.voidType:null==c.returnTypeAnnotation&&(this.checker.styleSettings.implicitAny&&this.checker.errorReporter.styleError(c,"type implicitly set to 'any'"),d.returnType.type=this.anyType,f.flags|=a.SymbolFlags.RecursivelyReferenced),c;d.typeCheckStatus=a.TypeCheckStatus.Started;this.checker.addStartedPTO(d);var e=this.scope,g=this.thisFnc,h=this.enclosingFncIsMethod,l=this.thisClassNode;this.enclosingFncIsMethod=c.isMethod()||c.isConstructor;
this.thisFnc=c;var j=c.type.symbol,p=this.thisType,r=this.checker.locationInfo,s=null,t=!1,v=null,A=null,C=c.isAccessor()&&a.hasFlag(c.fncFlags,a.FncFlags.GetAccessor),x=c.isAccessor()&&a.hasFlag(c.fncFlags,a.FncFlags.SetAccessor),D=(C||x)&&c.accessorSymbol?c.accessorSymbol.getType():null,C=this.checker.currentModDecl;if(c.isConstructor&&!c.isOverload){if(null==b.instanceType)return this.checker.errorReporter.simpleError(c,"Malformed function body (is this a class named the same as an existing interface?)"),
...
b.enclosingType:p;y=d.parameters.length;if(!c.isConstructor&&c.bod&&!c.isSignature()){E=H=this.scope;if(!c.isMethod()&&null==c.returnTypeAnnotation){if(e&&c.name&&!c.name.isMissing()&&(B=e.findAmbient(c.name.text,!1,!1))&&B.declAST&&B.declAST.type)this.checker.setContextualType(B.declAST.type,!1),t=!0;if(this.checker.hasTargetType()){var B=this.checker.getTargetTypeContext(),z=B.contextualType;this.checker.canContextuallyTypeFunction(z,c,!0)?(B.targetSig=(z.construct?z.construct:z.call).signatures[0],
v=B.targetSig.parameters,A=B.targetSig.returnType.type,B.targetSig.declAST&&(B.targetSig.declAST.isConstructor?c.isTargetTypedAsMethod=!0:B.targetSig.declAST.isMethod()&&(c.isTargetTypedAsMethod=!0)),f.type=B.contextualType):z&&c.isAccessor()?(D=z,B.targetAccessorType=D):this.checker.killTargetType()}}E=E.valueMembers;this.scope=new a.SymbolScopeBuilder(E,null,null,null,e,j);for(z=0;z<y;z++){var G=d.parameters[z],F=G.declAST;this.checker.hasTargetType()&&v&&(this.checker.getTargetTypeContext().targetSig.hasVariableArgList||
z<v.length)?(B=this.checker.getTargetTypeContext(),F.type=B.targetSig.hasVariableArgList&&z>=v.length-1?v[v.length-1].getType().elementType:v[z].getType(),F.sym.setType(F.type),F.sym.typeCheckStatus=this.checker.getTypeCheckFinishedStatus()):this.typeCheck(F);x&&D&&(F=this.cast(F,D));G.container=j;E.publicMembers.add(G.name,G)}this.scope=H}else{this.typeCheck(c.args);for(z=0;z<y;z++)d.parameters[z].parameter.typeLink.type=c.args.members[z].type,c.args.members[z].parameterPropertySym&&c.args.members[z].parameterPropertySym.setType(c.args.members[z].type);
...
c.args,s,a.hasFlag(c.fncFlags,a.FncFlags.ClassMethod)),this.thisClassNode&&this.thisClassNode.extendsList&&(j=this.scope,s=new a.ScopedMembers(s),this.scope=new a.FilteredSymbolScopeBuilder(s,e,c.type.symbol,function(c){return c.kind()==a.SymbolKind.Parameter}),this.typeCheckBaseCalls(this.thisClassNode.extendsList),this.scope=j)):this.addFormals(j,d,s),s=this.checker.currentModDecl,c.type&&(c.type.symbol&&!c.isMethod()&&c.type.symbol.declModule)&&(this.checker.currentModDecl=c.type.symbol.declModule),
this.typeCheck(c.bod),this.checker.currentModDecl=s,this.checker.checkControlFlow&&(s=c.buildControlFlow(),this.checker.printControlFlowGraph&&s.print(this.checker.errorReporter.outfile),s.reportUnreachable(this.checker.errorReporter),this.checker.checkControlFlowUseDef&&s.useDef(this.checker.errorReporter,c.type.symbol)),c.isConstructor)){s=c.scopes;j=s.members.length;for(v=0;v<j;v++)x=s.members[v],x.isSignature()||a.hasFlag(x.fncFlags,a.FncFlags.Method)&&!a.hasFlag(x.fncFlags,a.FncFlags.Static)&&
this.checkPromoteFreeVars(x,c.type.symbol)}this.scope=e;this.thisFnc=g;this.thisClassNode=l;this.enclosingFncIsMethod=h;this.thisType=p;this.checker.locationInfo=r;this.checker.currentModDecl=C;d.typeCheckStatus=this.checker.getTypeCheckFinishedStatus();c.returnTypeAnnotation?(this.checkForVoidConstructor(c.returnTypeAnnotation.type,c.returnTypeAnnotation),null==d.returnType.type&&this.checker.resolveTypeLink(this.scope,d.returnType,!1)):A&&(d.returnType.type=A);if(!(f.flags&a.SymbolFlags.RecursivelyReferenced)&&
0<c.returnStatementsWithExpressions.length)if(f=c.returnStatementsWithExpressions[0].type,f=this.checker.findBestCommonType(f,null,{getLength:function(){return c.returnStatementsWithExpressions.length},setTypeAtIndex:function(a,b){c.returnStatementsWithExpressions[a].type=b},getTypeAtIndex:function(a){return c.returnStatementsWithExpressions[a].type}}))d.returnType.type=this.checker.widenType(f);else{for(f=0;f<c.returnStatementsWithExpressions.length;f++)this.checker.errorReporter.simpleError(c.returnStatementsWithExpressions[f],
"Incompatible return type");d.returnType.type=this.anyType}null==d.returnType.type?a.hasFlag(c.fncFlags,a.FncFlags.HasReturnExpression)?(this.checker.styleSettings.implicitAny&&this.checker.errorReporter.styleError(c,"type implicitly set to 'any'"),d.returnType.type=this.anyType):d.returnType.type=this.voidType:d.returnType.type==this.nullType||d.returnType.type==this.checker.undefinedType?d.returnType.type=this.anyType:d.returnType.type!=this.voidType&&(d.returnType.type!=this.checker.undefinedType&&
d.returnType.type!=this.anyType)&&c.returnTypeAnnotation&&!c.isSignature()&&(!c.isConstructor&&!a.hasFlag(c.fncFlags,a.FncFlags.HasReturnExpression)&&!a.hasFlag(c.fncFlags,a.FncFlags.IsFatArrowFunction))&&(0<c.bod.members.length&&c.bod.members[0].nodeType==a.NodeType.Throw||this.checker.errorReporter.simpleError(c,"Function declared a non-void return type, but has no return expression"));t&&this.checker.unsetContextualType();c.accessorSymbol&&((D=c.accessorSymbol.getType())?(a.hasFlag(c.fncFlags,
a.FncFlags.GetAccessor)&&D!=d.returnType.type||0<c.args.members.length&&D!=c.args.members[0].type)&&this.checker.errorReporter.simpleError(c,"Getter and setter types do not agree"):a.hasFlag(c.fncFlags,a.FncFlags.GetAccessor)?c.accessorSymbol.setType(d.returnType.type):1!=c.args.members.length?this.checker.errorReporter.simpleError(c,"Setters may have one and only one argument"):c.accessorSymbol.setType(c.args.members[0].type));this.typeCheckOverloadSignatures(b,c);return c};d.prototype.typeCheckBases=
function(c){var b=!1,f=c.extendsList;if(f){var d=f.length;this.inNewTargetTypeCheck=!0;0<d&&(c.typeFlags|=a.TypeFlags.HasBaseType);for(var e=0;e<d;e++){var g=f[e];g.symbol&&("Object"==g.symbol.name&&g.symbol.container==this.checker.gloMod)&&(c.typeFlags|=a.TypeFlags.HasBaseTypeOfObject);if(g.isClassInstance())c.isClassInstance()&&(!this.checker.typeStatusIsFinished(g.symbol.typeCheckStatus)&&g.symbol.declAST)&&(this.checker.errorReporter.simpleErrorFromSym(g.symbol,"Base type '"+g.symbol.name+"' is referenced before its declaration"),
this.typeCheck(g.symbol.declAST)),this.currentScript&&(this.currentScript.requiresInherits=!0),c.isClassInstance()?b&&this.checker.errorReporter.simpleErrorFromSym(g.symbol,"Class may not follow interface as base type"):this.checker.errorReporter.simpleErrorFromSym(g.symbol,"Interface base type must be interface");else if(g.isModuleType())this.checker.errorReporter.simpleErrorFromSym(g.symbol,"Types may not be derived from module types");else if(g.members)b||(b=!0);else{c.isClassInstance()?this.checker.errorReporter.simpleErrorFromSym(g.symbol,
"Base type must be interface or class"):this.checker.errorReporter.simpleErrorFromSym(g.symbol,"Interface base type must be interface");break}}this.inNewTargetTypeCheck=!1}};d.prototype.checkMembersImplementInterfaces=function(c){c=c.getInstanceType();if(c.implementsList){var b=c.implementsList.length;this.inNewTargetTypeCheck=!0;for(var f=0;f<b;f++){var d=c.implementsList[f],e=new a.TypeComparisonInfo;this.checker.sourceIsSubtypeOfTarget(c,d,e)||(d="Class '"+c.getTypeName()+"' declares interface '"+
d.getTypeName()+"' but does not implement it",e.message?this.checker.errorReporter.simpleErrorFromSym(c.symbol,d+": "+e.message):this.checker.errorReporter.simpleErrorFromSym(c.symbol,d))}this.inNewTargetTypeCheck=!1}};d.prototype.typeCheckBaseCalls=function(c){if(null!=c)for(var b=c.members.length,f=0;f<b;f++){var d=c.members[f];d.nodeType==a.NodeType.Call&&this.typeCheckNew(d)}};d.prototype.assertUniqueNamesInBaseTypes=function(c,b,f,d){var e=this;if(b&&(b.members&&b.members.publicMembers.map(function(a,
g){var h=c.lookup(g.name);h?d&&e.checker.errorReporter.simpleError(f,"duplicate member name in bases for "+f.name.text+": "+b.symbol.name+" and "+h.container.name+" both contain member with name "+g.name):c.add(g.name,g)},null),b.extendsList))for(var g=b.extendsList.length,h=0;h<g;h++)b.extendsList[h].symbol.flags&a.SymbolFlags.RecursivelyReferenced||this.assertUniqueNamesInBaseTypes(c,b.extendsList[h],f,d)};d.prototype.checkBaseTypeMemberInheritance=function(c,b){var f=this,d=c.getInstanceType();
if(null!=d.extendsList){var e=d.extendsList.length;if(0<e){var g=new a.StringHashTable;if(d.isClassInstance())for(var h=0;h<e;h++)this.assertUniqueNamesInBaseTypes(g,d.extendsList[h],b,0<h);d.members&&d.members.publicMembers.map(function(c,g){for(var h=0;h<e;h++){var l=d.extendsList[h];if(null==l.memberScope)f.checker.errorReporter.simpleError(b,"Base type '"+l.symbol.name+"' lacks an implementation.");else if(l=l.memberScope.find(g.name,!1,!1)){var j=g.getType(),n=l.getType();f.checker.sourceIsSubtypeOfTarget(j,
n)?g.kind()==a.SymbolKind.Type&&l.kind()==a.SymbolKind.Field&&f.checker.errorReporter.simpleErrorFromSym(g,"Cannot override field '"+g.name+"' with method"):f.checker.errorReporter.simpleErrorFromSym(g,"Type of overridden member '"+g.name+"' is not subtype of original member defined by type '"+l.container.name+"'")}}},null)}}};d.prototype.typeCheckClass=function(c){var b=c.type.symbol;if(b.typeCheckStatus==a.TypeCheckStatus.Finished||b.typeCheckStatus==a.TypeCheckStatus.Started)return c;b.typeCheckStatus=
a.TypeCheckStatus.Started;this.checker.addStartedPTO(b);var f=this.scope,d=this.thisClassNode;this.thisClassNode=c;var e=c.type;this.typeCheckBases(e.instanceType);var g=this.thisType;this.thisType=e.instanceType;this.scope=e.instanceType.containedScope;c.constructorDecl&&(this.scope=e.instanceType.constructorScope,this.addConstructorLocalArgs(c.constructorDecl.type.symbol,c.constructorDecl.args,this.scope.valueMembers.allMembers,!0));this.typeCheck(c.members);b.typeCheckStatus=a.TypeCheckStatus.Finished;
this.checkBaseTypeMemberInheritance(e,c);this.checkMembersImplementInterfaces(e);this.typeCheckOverloadSignatures(e,c);this.typeCheckOverloadSignatures(e.instanceType,c);c.constructorDecl||c.baseClass&&(c.baseClass.members.length&&c.baseClass.members[0].type&&c.baseClass.members[0].type.symbol.type.isClass())&&a.cloneParentConstructGroupForChildType(c.type,c.baseClass.members[0].type.symbol.type);this.thisType=g;this.thisClassNode=d;this.scope=f;return c};d.prototype.typeCheckOverloadSignatures=function(a,
...
function(c){var b=c.alias.type,f=null,d=this.inImportTypeCheck;this.inImportTypeCheck=!0;this.typeCheck(c.alias);b=c.alias.type;null==b&&(this.checker.errorReporter.simpleError(c.alias,"Could not resolve module alias '"+c.id.text+"'"),b=this.checker.anyType,c.id.sym.type=b);c.id.type=b;f=b.symbol;b.isModuleType()?(f.type=b,this.checker.currentModDecl&&this.checker.currentModDecl.mod&&this.checker.currentModDecl.mod.importedModules.push(c),c.id.sym.type=b,b.symbol&&b.symbol.declAST&&(b.symbol.declAST.modFlags&=
~a.ModuleFlags.ShouldEmitModuleDecl)):this.checker.errorReporter.simpleError(c.alias,"A module cannot be aliased to a non-module type");this.inImportTypeCheck=d;return c};d.prototype.typeCheckModule=function(c){if(!c.mod)return c;this.currentScript&&(this.currentScript.requiresGlobal=!0);var b=c.mod,f=null,d=this.scope,e=this.thisType,g=this.checker.currentModDecl;this.checker.currentModDecl=c;!this.inImportTypeCheck&&(g&&a.hasFlag(c.modFlags,a.ModuleFlags.IsDynamic)&&!a.hasFlag(c.modFlags,a.ModuleFlags.Ambient))&&
this.checker.errorReporter.simpleError(c,"Dynamic modules may not be nested within other modules");this.thisType=null;this.scope=b.containedScope;this.typeCheck(c.members);f=b.symbol;this.checker.currentModDecl=g;this.thisType=e;this.scope=d;c.type=b;f&&(f.typeCheckStatus=a.TypeCheckStatus.Finished);return c};d.prototype.typeCheckFor=function(a){a.init=this.typeCheck(a.init);this.nestingLevel++;a.cond=this.typeCheck(a.cond);this.typeCheckCondExpr(a.cond);a.incr=this.typeCheck(a.incr);this.nestingLevel--;
a.body=this.typeCheck(a.body);this.typeCheckCompoundStmtBlock(a.body,"for statement");a.type=this.voidType;return a};d.prototype.typeCheckWith=function(a){this.checker.errorsOnWith&&this.checker.errorReporter.simpleError(a.expr,"All symbols within a 'with' block will be typed as 'any'");a.expr=this.typeCheck(a.expr);this.checker.inWith=!0;a.body=this.typeCheck(a.body);this.typeCheckCompoundStmtBlock(a.body,"with statement");this.checker.inWith=!1;return a};d.prototype.typeCheckForIn=function(b){b.obj=
this.typeCheck(b.obj);b.lval=this.cast(this.typeCheck(b.lval),this.checker.stringType);if(b.lval.nodeType==a.NodeType.VarDecl){var d=b.lval;d.typeExpr&&this.checker.errorReporter.simpleError(d,"Variable declarations for for/in expressions may not contain a type annotation");d.sym&&d.sym.setType(this.checker.stringType)}b.body=this.typeCheck(b.body);this.typeCheckCompoundStmtBlock(b.body,"for in statement");return b};d.prototype.typeCheckWhile=function(a){a.cond=this.typeCheck(a.cond);this.typeCheckCondExpr(a.cond);
...
new a.StringHashTable));d.memberScope=new a.SymbolTableScope(d.members,null,null,null,null);var f=new a.SymbolAggregateScope(d.symbol);f.addParentScope(d.memberScope);f.addParentScope(this.scope);d.containedScope=f;var f=b.operand,e=this.thisType,g=!1,h=null;this.checker.hasTargetType()&&((h=this.checker.getTargetTypeContext().contextualType)&&h.symbol&&!this.checker.typeStatusIsFinished(h.symbol.typeCheckStatus)&&h.symbol.declAST&&this.typeCheck(h.symbol.declAST),g=!0);if(f)for(var l=0,j=f.members.length;l<
j;l++){var q=f.members[l],p=q.operand1,r,s=null,t=null;if(p.nodeType==a.NodeType.Name)r=p.text;else if(p.nodeType==a.NodeType.QString)r=p.text,r=r.substring(1,r.length-1);else{this.checker.errorReporter.simpleError(b,"malformed object literal");d=this.anyType;break}g&&h.memberScope&&(s=h.memberScope.find(r,!1,!1));if(q.operand2.nodeType==a.NodeType.FuncDecl&&q.operand2.isAccessor()){var t=q.operand2,v=d.members.publicMembers.lookup(r),v=this.checker.createAccessorSymbol(t,v,d,!0,!1,d.memberScope,
null),t=t.accessorSymbol=v;p.nodeType==a.NodeType.Name&&(p.sym=v)}this.checker.typeCheckWithContextualType(g&&s?s.getType():null,!1,g,q.operand2);if(g&&s){if(q.operand2.type==this.anyType||this.checker.sourceIsAssignableToTarget(q.operand2.type,s.getType())||q.operand2.nodeType==a.NodeType.FuncDecl&&q.operand2.isAccessor()&&this.typeFromAccessorFuncDecl(q.operand2)==s.getType())q.operand1.type=s.getType()}else q.operand2.type=q.operand2.type==this.checker.undefinedType?this.anyType:q.operand2.type;
null==t&&(q=q.operand2.type,s=new a.ValueLocation,t=new a.FieldSymbol(r,p.minChar,this.checker.locationInfo.unitIndex,!0,s),t.flags|=a.SymbolFlags.Property,s.symbol=t,t.typeCheckStatus=this.checker.getTypeCheckFinishedStatus(),s.typeLink=new a.TypeLink,s.typeLink.type=q,d.members.publicMembers.add(r,t));t.isObjectLitField=!0}this.thisType=e;b.type=d;h&&(b.targetType=h)};d.prototype.typeCheckArrayLit=function(b){var d=b.operand,f=this.anyType,e=null,g=new a.TypeComparisonInfo;g.onlyCaptureFirstError=
!0;if(this.checker.hasTargetType()){var h=this.checker.getTargetTypeContext().contextualType;h.elementType&&(e=h.elementType)}if(d&&(h=this.inArrayElementTypeCheck,this.inArrayElementTypeCheck=!0,this.checker.typeCheckWithContextualType(e,this.checker.inProvisionalTypecheckMode(),null!=e,d),this.inArrayElementTypeCheck=h,f=d.members[0].type,f=this.checker.findBestCommonType(f,e,{getLength:function(){return d.members.length},setTypeAtIndex:function(a,b){d.members[a].type=b},getTypeAtIndex:function(a){return d.members[a].type}},
g),f==this.checker.undefinedType||!h&&f==this.nullType))f=this.anyType;f?e&&this.checker.sourceIsAssignableToTarget(f,e)&&(f=e):(g.message?this.checker.errorReporter.simpleError(b,"Incompatible types in array literal expression: "+g.message):this.checker.errorReporter.simpleError(b,"Incompatible types in array literal expression"),f=this.anyType);b.type=this.checker.makeArrayType(f)};d.prototype.checkForVoidConstructor=function(a,b){if(a&&a.construct&&0<a.construct.signatures.length)for(var d=0;d<
a.construct.signatures.length;d++)if(a.construct.signatures[d].returnType.type==this.checker.voidType){this.checker.errorReporter.simpleError(b,"Constructors may not have a return type of 'void'");break}};d.prototype.typeCheckReturn=function(b){if(this.thisFnc){var d=null;if(this.checker.hasTargetType()){var f=this.checker.getTargetTypeContext().targetAccessorType;if(f)d=f;else if((f=this.checker.getTargetTypeContext().targetSig)&&f.returnType.type!=this.voidType)d=f.returnType.type}b.returnExpression?
(this.thisFnc.fncFlags|=a.FncFlags.HasReturnExpression,null==d&&(this.thisFnc.returnTypeAnnotation&&this.thisFnc.returnTypeAnnotation.type&&this.thisFnc.returnTypeAnnotation.type!=this.voidType)&&(d=this.thisFnc.returnTypeAnnotation.type),this.checker.typeCheckWithContextualType(d,this.checker.inProvisionalTypecheckMode(),null!=d,b.returnExpression),(f=this.thisFnc.returnTypeAnnotation&&this.thisFnc.returnTypeAnnotation.type?this.thisFnc.returnTypeAnnotation.type:d)?f==this.voidType&&b.returnExpression.type!=
this.voidType?(this.checker.errorReporter.simpleError(b,"Return with value expression in void function"),b.type=b.returnExpression.type):(b.returnExpression=this.cast(b.returnExpression,f),b.type=f):(d&&(b.returnExpression.type!=this.voidType?b.returnExpression=this.cast(b.returnExpression,d):b.returnExpression.type=d),b.type=b.returnExpression.type),this.thisFnc.returnStatementsWithExpressions[this.thisFnc.returnStatementsWithExpressions.length]=b):b.type=null==d?this.checker.voidType:d}return b};
...
function(a,b,d,e,g){var h=a.nonOptionalParameterCount,l=a.parameters.length,j=h,q=!1;if(b.length>=h&&(a.hasVariableArgList||b.length<=l))j=a.hasVariableArgList?a.parameters.length:b.length,q=!0;h=null;if(q||a.hasVariableArgList){a.hasVariableArgList&&(j-=1,h=a.parameters[j].parameter.typeLink.type,h=h.elementType,q=b.length>=j);for(var l=b.length,p=q,r=0;r<l;r++){var s;s=r<j?a.parameters[r].parameter.typeLink.type:h;var t=b[r];if(!s||!t||!this.checker.typesAreIdentical(s,t))p=!1;this.checker.sourceIsAssignableToTarget(t,
s,g)||(q=!1);if(!p&&!q)break}p?d[d.length]=a:q&&0==d.length&&(e[e.length]=a)}};d.prototype.resolveOverload=function(b,d){var f=this.resolutionDataCache.getResolutionData(),e=f.actuals,g=f.exactCandidates,h=f.conversionCandidates,l=null,j=1<d.signatures.length,q=new a.TypeComparisonInfo,p=null,r=null;if(b.nodeType==a.NodeType.Call||b.nodeType==a.NodeType.New){if(p=b.args,r=b.target,b.args)for(var s=b.args.members.length,t=0;t<s;t++)e[t]=b.args.members[t].type}else b.nodeType==a.NodeType.Index&&(r=
b.operand1,p=new a.ASTList,p.members[0]=b.operand2,e[0]=b.operand2.type);t=0;for(s=d.signatures.length;t<s;t++){var v=d.signatures[t];if(!j||v!=d.definitionSignature||this.checker.canCallDefinitionSignature)!v.returnType.type&&(v.declAST&&v.typeCheckStatus!=a.TypeCheckStatus.Finished)&&this.typeCheckFunction(v.declAST),this.tryAddCandidates(v,e,g,h,q)}if(0==g.length)g=this.checker.getApplicableSignatures(h,p,q),0<g.length?(p=this.checker.findMostApplicableSignature(g,p),p.ambiguous&&this.checker.errorReporter.simpleError(r,
"Ambiguous call expression - could not choose overload"),l=p.sig):q.message?this.checker.errorReporter.simpleError(r,"Supplied parameters do not match any signature of call target:\n\t"+q.message):this.checker.errorReporter.simpleError(r,"Supplied parameters do not match any signature of call target");else if(1<g.length){l=[];for(t=0;t<g.length;t++)l[t]={signature:g[t],hadProvisionalErrors:!1};p=this.checker.findMostApplicableSignature(l,p);p.ambiguous&&this.checker.errorReporter.simpleError(r,"Ambiguous call expression - could not choose overload");
l=p.sig}else l=g[0];this.resolutionDataCache.returnResolutionData(f);return l};d.prototype.typeCheckNew=function(a){a.target=this.typeCheck(a.target);var b=a.target;b.type.construct||b.type.call?this.preTypeCheckCallArgs(a.args):a.args=this.typeCheck(a.args);b.type==this.anyType?(a.type=this.anyType,a.args=this.typeCheck(a.args)):b.type.construct?(b=this.resolveOverload(a,b.type.construct),null==b?a.type=this.anyType:(a.type=b.returnType.type==this.voidType?this.anyType:b.returnType.type,a.signature=
...
b.members.length;d++)switch(b.members[d].nodeType){case a.NodeType.FuncDecl:case a.NodeType.ObjectLit:case a.NodeType.ArrayLit:continue;default:this.typeCheck(b.members[d])}};d.prototype.postTypeCheckCallArgs=function(b){var d=!1,f=0;if(b.target&&b.target.type&&b.signature&&b.args){var e=b.signature;if(e&&b.args.members.length>=e.nonOptionalParameterCount)for(var d=!0,g=null,h=b.args.members.length<e.parameters.length?b.args.members.length:e.parameters.length,f=0;f<h;f++){if((g=e.parameters[f].getType())&&
e.hasVariableArgList&&f>=e.nonOptionalParameterCount-1)g=g.elementType;switch(b.args.members[f].nodeType){case a.NodeType.FuncDecl:case a.NodeType.ObjectLit:case a.NodeType.ArrayLit:this.checker.typeCheckWithContextualType(g,this.checker.inProvisionalTypecheckMode(),!e.parameters[f].declAST.isParenthesized,b.args.members[f])}}}if(!d&&b.args){this.checker.killTargetType();for(f=0;f<b.args.members.length;f++)switch(b.args.members[f].nodeType){case a.NodeType.FuncDecl:case a.NodeType.ObjectLit:case a.NodeType.ArrayLit:this.typeCheck(b.args.members[f])}}};
...
b.target.nodeType==a.NodeType.Super&&(this.inSuperCall=!0);b.target=this.typeCheck(b.target);this.preTypeCheckCallArgs(b.args);var f=b.target;null==f.type||f.type==this.anyType||this.functionInterfaceType&&f.type==this.functionInterfaceType?b.type=this.anyType:(f=f.type,f.call?(f=this.resolveOverload(b,f.call),null==f?b.type=this.anyType:(b.type=f.returnType.type,b.signature=f)):b.target.nodeType==a.NodeType.Super&&this.thisFnc&&this.thisFnc.isConstructor&&a.hasFlag(this.thisFnc.fncFlags,a.FncFlags.ClassMethod)?
(f=f.symbol.type.construct?this.resolveOverload(b,f.symbol.type.construct):null,null==f?b.type=this.anyType:(b.flags|=a.ASTFlags.ClassBaseConstructorCall,b.type=f.returnType.type,b.signature=f)):(b.type=this.anyType,this.checker.errorReporter.invalidCall(b,b.nodeType,this.scope)));this.postTypeCheckCallArgs(b);this.inSuperCall=d;return b};d.prototype.assignScopes=function(b){this.checker.locationInfo=b.locationInfo;var d=new e(null,null,this.globalScope),d=new a.AssignScopeContext(d,this,[this.checker.currentModDecl]);
a.getAstWalkerFactory().walk(b,a.preAssignScopes,a.postAssignScopes,null,d)};d.prototype.findMemberScope=function(b,d){var f=b.getScope(),e=b.pos-b.getScriptFragmentPosition(),g=b.getScriptFragment(),e=new a.MemberScopeContext(this,e,d);e.scope=f;if(g.nodeType==a.NodeType.Name)return g.type.getMemberScope(this);a.getAstWalkerFactory().walk(g,a.preFindMemberScope,null,null,e);e.ast&&(b.enclosingClassDecl&&e.ast.type==b.enclosingClassDecl.type.instanceType)&&(b.publicsOnly=!1);return e.type?e.type.getMemberScope(this):
null};d.prototype.findMemberScopeAt=function(b){return this.findMemberScope(b,a.ASTFlags.DotLHS)};d.prototype.findMemberScopeAtFullAst=function(b){var d=a.ASTFlags.DotLHS,f=b.pos,e=null,g=function(b,c,g){a.isValidAstNode(b)&&(a.hasFlag(b.flags,d)&&(b.minChar<f&&f<=b.limChar)&&(e=b),g.options.goChildren=b.minChar<=f&&f<=b.limChar);return b};a.getAstWalkerFactory().walk(b.script,function(b,c,g){if(a.isValidAstNode(b)){if(a.hasFlag(b.flags,d)&&(f==b.limChar||f-1==b.limChar))e=b,g.options.stopWalk();
g.options.goChildren=b.minChar<=f&&f<=b.limChar}return b});null==e&&a.getAstWalkerFactory().walk(b.script,g);e&&(b.enclosingClassDecl&&e.type==b.enclosingClassDecl.type.instanceType)&&(b.publicsOnly=!1);return e&&e.type?e.type.getMemberScope(this):null};a.TypeFlow=d})(TypeScript||(TypeScript={}));
(function(a){var e=a.Primitive||(a.Primitive={});e._map=[];e.None=0;e.Void=1;e.Double=2;e.String=4;e.Boolean=8;e.Any=16;e.Null=32;e.Undefined=64;var h=a.Primitive,b=function(){this.suffix=this.prefix=""};b.prototype.isString=function(){return!1};b.prototype.isArray=function(){return!1};b.prototype.toString=function(){return b.memberNameToString(this)};b.memberNameToString=function(a){var c=a.prefix;if(a.isString())c+=a.text;else for(var d=0;d<a.entries.length;d++)c+=b.memberNameToString(a.entries[d]),
c+=a.delim;return c+=a.suffix};b.create=function(a,b,c){if("string"==typeof a)return new j(a);var d=new g;b&&(d.prefix=b);c&&(d.suffix=c);d.entries.push(a);return d};a.MemberName=b;var j,e=function(a){b.call(this);this.text=a};__extends(e,b);e.prototype.isString=function(){return!0};j=e;a.MemberNameString=j;var g,e=function(){b.apply(this,arguments);this.delim="";this.entries=[]};__extends(e,b);e.prototype.isArray=function(){return!0};e.prototype.add=function(a){this.entries.push(a)};e.prototype.addAll=
function(a){for(var b=0;b<a.length;b++)this.entries.push(a[b])};g=e;a.MemberNameArray=g;var d=-1,l=function(){this.typeID=d++;this.index=this.call=this.construct=null;this.passTypeCreated=a.CompilerDiagnostics.analysisPass;this.primitiveTypeClass=h.None;this.typeFlags=a.TypeFlags.None};l.prototype.baseClass=function(){return this.extendsList&&0<this.extendsList.length?this.extendsList[0]:null};l.prototype.getArrayBase=function(a,b){return this.arrayCache.specialize(a,b)};l.prototype.isClass=function(){return null!=
...
(null==this.call&&null==this.construct&&null==this.index||a.hasFlag(this.typeFlags,a.TypeFlags.BuildingName)||this.members&&!this.isClass()))return d=this.symbol.scopeRelativeName(h),b.create("null"==d?"any":d);if(this.members||this.call||this.construct){if(a.hasFlag(this.typeFlags,a.TypeFlags.BuildingName))return b.create("this");this.typeFlags|=a.TypeFlags.BuildingName;var l=new g,j=e,u=e=0;this.members&&this.members.allMembers.map(function(c,d){if(!a.hasFlag(d.flags,a.SymbolFlags.BuiltIn)){var f=
d.getTypeName(h);2<=f.length&&"; "==f.substring(f.length-2)&&(f=f.substring(0,f.length-2));l.add(b.create(f));u++;d.kind()==a.SymbolKind.Type?1<d.type.callCount()&&(j=!0):j=!0}},null);var q,p=0,r=0==u&&1==this.callCount()&&d;r||(l.delim="; ");if(this.call){c=this.call.toStrings(c,r,h);q=0;for(p=c.length;q<p;q++)l.add(b.create(c[q])),e++}if(this.construct){c=this.construct.toStrings("new",r,h);q=0;for(p=c.length;q<p;q++)l.add(b.create(c[q])),e++}if(this.index){c=this.index.toStrings("",r,h);q=0;for(p=
c.length;q<p;q++)l.add(b.create(c[q])),e++}if(j||1<e&&d)l.prefix="{ ",l.suffix="}";this.typeFlags&=~a.TypeFlags.BuildingName;return 0==e&&0==u?b.create("{}"):l}return b.create("{}")};l.prototype.checkDecl=function(a){(this.isClassInstance()||this.isClass())&&this.symbol.declAST&&a.typeFlow.inScopeTypeCheckDecl(this.symbol.declAST)};l.prototype.getMemberScope=function(a){return this==a.anyType?null:this.isDouble()?a.numberInterfaceType?a.numberInterfaceType.memberScope:null:this.isBoolean()?a.booleanInterfaceType?
...
(function(a){function e(a){return a.replace('"',"").replace("'","").replace("'","").replace('"',"")}function h(a){return'"'+a+'"'}function b(a){return a.replace(/\\/g,"/")}function j(a){return 6<a.length&&".d.str"==a.substring(a.length-6,a.length)?a.substring(0,a.length-6):4<a.length&&".str"==a.substring(a.length-4,a.length)?a.substring(0,a.length-4):5<a.length&&".d.ts"==a.substring(a.length-5,a.length)?a.substring(0,a.length-5):3<a.length&&".ts"==a.substring(a.length-3,a.length)||3<a.length&&".js"==
a.substring(a.length-3,a.length)?a.substring(0,a.length-3):a}function g(a){return""==a?a:-1!=a.indexOf("/")?d(a):""}function d(a){a=b(a);a=a.split("/");return a.slice(0,a.length-1).join("/")+"/"}function l(a){for(var a=b(a),d="/"===a.charAt(0),a=a.split("/"),e=0;e<a.length;e++){if("."===a[e]||""===a[e])a.splice(e,1),e--;0<e&&(".."===a[e]&&".."!==a[e-1])&&(a.splice(e-1,2),e-=2)}return(d?"/":"")+a.join("/")}a.stripQuotes=e;a.isQuoted=function(a){return-1!=a.indexOf('"')||-1!=a.indexOf("'")||-1!=a.indexOf("'")||
-1!=a.indexOf('"')};a.quoteStr=h;a.swapQuotes=function(a){-1!=a.indexOf('"')?(a=a.replace('"',"'"),a=a.replace('"',"'")):(a=a.replace("'",'"'),a=a.replace("'",'"'));return a};a.switchToForwardSlashes=b;a.trimModName=j;a.isSTRFile=function(a){return 4<a.length&&".str"==a.substring(a.length-4,a.length)};a.isTSFile=function(a){return 3<a.length&&".ts"==a.substring(a.length-3,a.length)};a.isDSTRFile=function(a){return 6<a.length&&".d.str"==a.substring(a.length-6,a.length)};a.isDTSFile=function(a){return 5<
a.length&&".d.ts"==a.substring(a.length-5,a.length)};a.getPrettyName=function(a,d,f){"undefined"===typeof d&&(d=!0);"undefined"===typeof f&&(f=!1);f=(f?b(a):j(e(a))).split("/");return f.length?d?h(f[f.length-1]):f[f.length-1]:a};a.quoteBaseName=function(a){var b=j(e(a)),d=g(b);if(""==d)return a;a=b.split(d);return h(a[1<a.length?1:0])};a.changePathToSTR=function(a){return j(e(a))+".str"};a.changePathToDSTR=function(a){return j(e(a))+".d.str"};a.changePathToTS=function(a){return j(e(a))+".ts"};a.changePathToDTS=
function(a){return j(e(a))+".d.ts"};a.isRelative=function(a){return"."==a.charAt(0)};a.isRooted=function(a){return"\\"==a.charAt(0)||"/"==a.charAt(0)||-1!=a.indexOf(":\\")||-1!=a.indexOf(":/")};a.getRootFilePath=g;a.filePath=d;a.normalizeURL=function(a){var b=/^(https?:\/\/[\-\w\.]+(:\d+)?\/)(.*)$/i.exec(a);return b?b[1]+l(b[3]):l(a)};a.pathNormalizeRegExp=/\//g;a.normalizePath=l;a.normalizeImportPath=function(a){return l(a)}})(TypeScript||(TypeScript={}));
(function(a){var e=function(a,e){this.path=a;this.content=e};e.prototype.getText=function(a,e){return this.content.substring(a,e)};e.prototype.getLength=function(){return this.content.length};a.SourceUnit=e;a.CompilationEnvironment=function(a,e){this.compilationSettings=a;this.ioHost=e;this.residentCode=[];this.code=[]};var h=function(a){this.environment=a;this.visited={}};h.prototype.resolveCode=function(b,h,g,d){var l={content:"",path:b},c=this.environment.ioHost,i=a.isRelative(b),f=i?!1:a.isRooted(b),
k=i?c.resolvePath(h+"/"+b):f||!h||g?b:h+"/"+b;!a.isSTRFile(k)&&!a.isTSFile(k)&&(k+=".ts");var k=a.switchToForwardSlashes(a.stripQuotes(k)),w=this.environment.compilationSettings.useCaseSensitiveFileResolution?k:k.toLocaleUpperCase();if(!this.visited[w]){if(i||f||!g)try{a.CompilerDiagnostics.debugPrint("   Reading code from "+k);try{l.content=c.readFile(k)}catch(n){try{a.isSTRFile(k)?k=a.changePathToTS(k):a.isTSFile(k)&&(k=a.changePathToSTR(k)),a.CompilerDiagnostics.debugPrint("   Reading code from "+
k),l.content=c.readFile(k)}catch(m){k=a.changePathToDSTR(k);a.CompilerDiagnostics.debugPrint("   Reading code from "+k);try{l.content=c.readFile(k)}catch(u){k=a.changePathToDTS(k),a.CompilerDiagnostics.debugPrint("   Reading code from "+k),l.content=c.readFile(k)}}}a.CompilerDiagnostics.debugPrint("   Found code at "+k);l.path=k;this.visited[w]=!0}catch(q){a.CompilerDiagnostics.debugPrint("   Did not find code for "+b)}else l=c.findFile(h,k),l||(a.isSTRFile(k)?k=a.changePathToTS(k):a.isTSFile(k)&&
(k=a.changePathToSTR(k)),l=c.findFile(h,k)),l||(k=a.changePathToDTS(k),l=c.findFile(h,k),l||(k=a.changePathToDSTR(k),l=c.findFile(h,k))),l?(l.path=a.switchToForwardSlashes(a.stripQuotes(l.path)),a.CompilerDiagnostics.debugPrint(b+" resolved to: "+l.path),l.content=l.content,this.visited[w]=!0):a.CompilerDiagnostics.debugPrint("Could not find "+b);if(l&&l.content){h=c.dirName(l.path);l=new e(l.path,l.content);g=a.preProcessFile(l,this.environment.compilationSettings);for(i=0;i<g.referencedFiles.length;i++)f=
g.referencedFiles[i],k=a.isRooted(f.path)?f.path:h+"/"+f.path,k=c.resolvePath(k),b==k?d.postResolutionError(k,"File contains reference to itself",null):this.resolveCode(f.path,h,!1,d);for(i=0;i<g.importedFiles.length;i++)this.resolveCode(g.importedFiles[i].path,h,!0,d);d.postResolution(l.path,l)}}};a.CodeResolver=h})(TypeScript||(TypeScript={}));
...
this.bitwise=!1;this.emptyBlocks=!0;this.eqnull=this.assignmentInCond=this.requireSemi=this.newMustBeUsed=!1;this.literalSubscript=this.reDeclareLocal=this.funcInLoop=this.innerScopeDeclEscape=this.evalOK=!0;this.implicitAny=!1};h.prototype.setOption=function(a,b){return void 0!==this[a]?(this[a]=b,!0):!1};h.prototype.parseOptions=function(a){for(var a=a.split(";"),b=0,d=a.length;b<d;b++){var e=a[b],c=!0,i=e.lastIndexOf(":");if(0<=i){var f=e.substring(i+1),e=e.substring(0,i);"off"==f&&(c=!1)}if(!this.setOption(e,
...
function(h,g){"undefined"===typeof g&&(g=new b);var d=new a.Scanner;d.resetComments();d.setSourceText(h,a.LexMode.File);for(var l=d.scan(),c=[],i=null,c=[],f=g,k=[],w=[],n=!1;l.tokenId!=a.TokenID.EOF;){if(l.tokenId==a.TokenID.IMPORT&&(l=d.scan(),l.tokenId==a.TokenID.ID||a.convertTokToID(l,!1)))l=d.scan(),l.tokenId==a.TokenID.Asg&&(l=d.scan(),l.tokenId==a.TokenID.MODULE&&(l=d.scan(),l.tokenId==a.TokenID.LParen&&(l=d.scan(),l.tokenId==a.TokenID.QString&&(i={minChar:d.startPos,limChar:d.pos,path:a.stripQuotes(a.switchToForwardSlashes(l.getText())),
isResident:!1},w.push(i)))));l.tokenId==a.TokenID.LCurly&&c.push(l);l.tokenId==a.TokenID.RCurly&&c.pop();l=d.scan()}c=d.getComments();for(d=0;d<c.length;d++)if(i=c[d],!i.isBlock){var l=i.getText(),m=/^(\/\/\/\s*<reference\s+path=)('|")(.+?)\2\s*(static=('|")(.+?)\2\s*)*\/>/igm.exec(l);if(m){var l=a.normalizePath(m[3]),u=a.normalizePath(l);(m=7<=m.length&&"true"==m[6])&&a.CompilerDiagnostics.debugPrint(l+" is resident");l={minChar:0,limChar:0,path:a.switchToForwardSlashes(u),isResident:m}}else l=null;
l&&(l.minChar=i.startPos,l.limChar=l.minChar+i.value.length,k.push(l));e(i.getText(),f.styleSettings);(i=/^(\/\/\/\s*<reference\s+no-default-lib=)('|")(.+?)\2\s*\/>/igm.exec(i.getText()))&&(n="true"==i[3])}return{settings:f,referencedFiles:k,importedFiles:w,isLibFile:n}}})(TypeScript||(TypeScript={}));
(function(a){var e=function(e){this.logger=e;this.astLogger=new a.AstLogger(this.logger)};e.prototype.getEnclosingScopeContextIfSingleScopeEdit=function(e,b,j,g){this.logger.log('checkEditsInsideSingleScope("'+b+'")');if(null===g)throw Error("editRange should be valid");if(g.isUnknown())return this.logger.log("  Bailing out because edit range is unknown"),null;b=a.findEnclosingScopeAt(this.logger,e,j,g.minChar,!1);e=a.findEnclosingScopeAt(this.logger,e,j,g.limChar,!1);return null==b||null==e?(this.logger.log("  Bailing out because containing scopes cannot be determined"),
null):b.scopeStartAST!==e.scopeStartAST?(this.logger.log("  Bailing out because edit overlaps 2 disctint scopes"),null):0>=b.scopeStartAST.limChar-b.scopeStartAST.minChar+g.delta?(this.logger.log("  Bailing out because scope has been entirely removed from new source text"),null):b};e.prototype.attemptIncrementalUpdateUnit=function(e,b,j,g){this.logger.log('attemptIncrementalUpdateUnit("'+b+'")');if(null===g)throw Error("editRange should be valid");var d=this.getEnclosingScopeContextIfSingleScopeEdit(e,
b,j,g);if(null===d)return null;b=d.scopeStartAST.limChar-d.scopeStartAST.minChar+g.delta;if(b>=j.getLength()/2)return this.logger.log("  Bailing out because range of scope to reparse ("+b+" characters) is greater than half the size of the source text"),null;var l=[],j=a.quickParse(this.logger,d.scopeStartAST,j,d.scopeStartAST.minChar,d.scopeStartAST.minChar+b,function(b,c,d,e){l.push(new a.ErrorEntry(e,b,b+c,d))});if(j.endLexState!=a.LexState.Start)return this.logger.log("  Bailing out because scope contains unterminated comment"),
...
null):a.UpdateUnitResult.singleScopeEdits(e,j,d,c,g,l)};e.prototype.mergeTrees=function(e){var b=this;a.timeFunction(this.logger,"mergeTrees()",function(){var j=new a.ScriptEditRange(e.scope1.minChar,e.scope1.limChar,e.editRange.delta);b.applyDeltaPosition(e.script1,j.limChar,j.delta);b.applyDeltaPosition(e.script2,0,j.minChar);b.mergeLocationInfo(e.script1,e.script2,j);b.replaceAST(e.script1,e.scope1,e.scope2)})};e.prototype.replaceAST=function(e,b,j){var g=this;a.getAstWalkerFactory().walk(e,function(d,
e,c){if(d===b)return j.preComments=d.preComments,j.postComments=d.postComments,g.logger.log("replaced old AST node with new one in script AST"),c.options.stopWalk(),j;if(a.isValidAstNode(d)&&(d.limChar<b.minChar||d.minChar>b.limChar))c.options.goChildren=!1;return d})};e.prototype.mergeLocationInfo=function(a,b,e){a=a.locationInfo.lineMap;b=b.locationInfo.lineMap;this.logger.information()&&(this.logger.log("lineMap1 (before):"),this.astLogger.logLinemap(a),this.logger.log("lineMap2 (quick parse):"),
this.astLogger.logLinemap(b),this.logger.log("EditRange="+e));for(var g=2,d=2,l=a.length,c=b.length;g<l||d<c;)g<l?a[g]<=e.minChar?g++:a[g]>=e.limChar?(a[g]+=e.delta,g++):d<c?(a.splice(g,0,b[d]+e.minChar),g++,l++,d++):(a.splice(g,1),l--):(a.push(b[d]+e.minChar),d++);this.logger.information()&&(this.logger.log("lineMap1 (after merge):"),this.astLogger.logLinemap(a))};e.prototype.applyDeltaPosition=function(e,b,j){var g=function(a){-1!==a.minChar&&a.minChar>=b&&(a.minChar+=j);-1!==a.limChar&&a.limChar>=
b&&(a.limChar+=j)},d=function(a){if(a&&0<a.length)for(var b=0;b<a.length;b++)g(a[b])};a.getAstWalkerFactory().walk(e,function(a,c,e){-1!==a.limChar&&a.limChar<b&&(e.options.goChildren=!1);g(a);d(a.preComments);d(a.postComments);return a})};a.IncrementalParser=e})(TypeScript||(TypeScript={}));
(function(a){var e=a.UpdateUnitKind||(a.UpdateUnitKind={});e._map=[];e._map[0]="Unknown";e.Unknown=0;e._map[1]="NoEdits";e.NoEdits=1;e._map[2]="EditsInsideSingleScope";e.EditsInsideSingleScope=2;var h=a.UpdateUnitKind,b=function(a,b,d){this.minChar=a;this.limChar=b;this.delta=d};b.unknown=function(){return new b(-1,-1,-1)};b.prototype.isUnknown=function(){return-1===this.minChar&&-1===this.limChar&&-1===this.delta};b.prototype.containsPosition=function(a){return this.minChar<=a&&a<this.limChar||this.minChar<=
a&&a<this.limChar+this.delta};b.prototype.toString=function(){return"editRange(minChar="+this.minChar+", limChar="+this.limChar+", delta="+this.delta+")"};a.ScriptEditRange=b;var j=function(a,b,d,e){this.kind=a;this.unitIndex=b;this.script1=d;this.script2=e;this.editRange=this.scope2=this.scope1=null;this.parseErrors=[]};j.noEdits=function(a){return new j(h.NoEdits,a,null,null)};j.unknownEdits=function(a,b,d){a=new j(h.Unknown,a.locationInfo.unitIndex,a,b);a.parseErrors=d;return a};j.singleScopeEdits=
function(a,b,d,e,g,w){a=new j(h.EditsInsideSingleScope,a.locationInfo.unitIndex,a,b);a.scope1=d;a.scope2=e;a.editRange=g;a.parseErrors=w;return a};a.UpdateUnitResult=j;var g;g=function(a,b,d,e){this.unitIndex=a;this.minChar=b;this.limChar=d;this.message=e};a.ErrorEntry=g;a.defaultSettings=new a.CompilationSettings;e=function(b,c,d,e){"undefined"===typeof d&&(d=new a.NullLogger);"undefined"===typeof e&&(e=a.defaultSettings);this.outfile=b;this.errorOutput=c;this.logger=d;this.settings=e;this.parser=
...
for(var e=0,g=this.scripts.members.length;e<g;e++){var h=this.scripts.members[e];if(h.emitRequired()){var j=this.outfile;if(b){var m=this.units[e].filename,d=m.split(".");d.pop();var u=d.join(".")+".js";this.emitSettings.path=u;j=c(u);d=new a.Emitter(this.typeChecker,j,this.emitSettings);this.settings.mapSourceFiles&&d.setSourceMappings(new a.SourceMapper(m,u,j,c(u+a.SourceMapper.MapFileExtension)));this.settings.generateDeclarationFiles&&(m=a.isSTRFile(m)?a.changePathToDSTR(m):(a.isTSFile(m),a.changePathToDTS(m)),
d.setDeclarationFile(c(m)))}else null==d?(d=new a.Emitter(this.typeChecker,this.outfile,this.emitSettings),this.settings.mapSourceFiles&&d.setSourceMappings(new a.SourceMapper(h.locationInfo.filename,this.settings.outputFileName,this.outfile,c(this.settings.outputFileName+a.SourceMapper.MapFileExtension))),this.settings.generateDeclarationFiles&&(m=this.settings.outputFileName,m=a.isSTRFile(m)?a.changePathToDSTR(m):(a.isTSFile(m),a.changePathToDTS(m)),d.setDeclarationFile(c(m)))):this.settings.mapSourceFiles&&
d.setSourceMappings(new a.SourceMapper(h.locationInfo.filename,d.sourceMapper.jsFileName,this.outfile,d.sourceMapper.sourceMapOut));this.typeChecker.locationInfo=h.locationInfo;d.emitJavascript(h,a.TokenID.Comma,!1,d.canWriteDeclFile());b&&(this.settings.mapSourceFiles&&d.emitSourceMappings(),this.settings.generateDeclarationFiles&&d.declFile.Close(),j.Close())}}b||(this.settings.mapSourceFiles&&d.emitSourceMappings(),this.settings.generateDeclarationFiles&&d.declFile.Close())};e.prototype.emitToOutfile=
...
a.globalId||("_Core"==h||"_element"==h)||d.add(h,"")}e=this.compiler.typeChecker.currentModDecl;this.compiler.typeChecker.currentModDecl=b.deepestModuleDecl;b=this.getTypeNamesForNames(b,d.getAllKeys(),c);this.compiler.typeChecker.currentModDecl=e;return b};e.prototype.getTypeNamesForNames=function(b,c,e){for(var f=[],g=b.getScope(),h=0;h<c.length;h++){var j=c[h],m=b.publicsOnly&&b.isMemberCompletion,u=e.find(j,m,!1);null==u&&(u=e.find(j,m,!0));m=u&&u.flags&a.SymbolFlags.Private?u.container==e.container:
!0;u?m&&(!a.isQuoted(u.name)&&!a.isRelative(u.name))&&(m=u.getType().getScopedTypeName(g),f.push(new d(j,m,u))):("true"==j||"false"==j)&&f.push(new d(j,"bool",this.compiler.typeChecker.booleanType.symbol))}return f};a.ScopeTraversal=e})(TypeScript||(TypeScript={}));
(function(a){var e=a.CompilerDiagnostics||(a.CompilerDiagnostics={}),h=function(a){e.diagnosticWriter&&e.diagnosticWriter.Alert(a)};e.debug=!1;e.diagnosticWriter=null;e.analysisPass=0;e.Alert=h;e.debugPrint=function(a){e.debug&&h(a)};e.assert=function(a,b){e.debug&&(a||h(b))};var b=function(){};b.prototype.information=function(){return!1};b.prototype.debug=function(){return!1};b.prototype.warning=function(){return!1};b.prototype.error=function(){return!1};b.prototype.fatal=function(){return!1};b.prototype.log=
...
(function(a){function e(a,b){"undefined"==typeof b&&(b=new d);var c=new TypeScript.CompilationSettings;c.generateDeclarationFiles=!0===a.produceDeclarations;c=new TypeScript.TypeScriptCompiler(b.emittedUnits.getDefaultStream(),null,new TypeScript.NullLogger,c);c.parser.errorRecovery=!0;c.setErrorCallback(b.getErrorCallback());for(var e=0;e<a.units.length;e++){var g=a.units[e];c.addUnit(g.data,g.name)}c.typeCheck();c.emit(!0,b.emittedUnits.getEmitCallback());return b.emittedUnits.getDefJS()}function h(a,
b,c){b||(b={units:[]});b.units.push({data:a,name:""});return e(b,c)}function b(a){var b=document.createElement("script");b.setAttribute("type","text/javascript");b.innerHTML=a;document.body.appendChild(b)}function j(a,c,d){"string"==typeof a&&(a=document.getElementById(a));if(!a||!a.tagName||"script"!=a.tagName.toLowerCase())throw Error("Invalid script block.");a=h(a.innerHTML,c,d);b(a)}function g(a,c,e,g,i){e||(e=function(){});"undefined"==typeof c&&(c=!0);if("undefined"==typeof i||null===i)i=new d;
var j=new XMLHttpRequest;j.open("GET",a);j.onreadystatechange=function(){if(4==j.readyState)if(200==j.status){var a=h(j.responseText,g,i);c&&b(a);e({result:a,compileInfo:i})}else e({error:!0})};j.send(null)}a.API_VERSION=0.1;var d,l=function(){this.errors=[];this.emittedUnits=new i};l.prototype.addError=function(a,b,c,d){this.errors.push({start:a,len:b,msg:c,block:d})};l.prototype.getErrorCallback=function(){var a=this;return function(){a.addError.apply(a,arguments)}};l.prototype.getErrorCount=function(){return this.errors.length};
l.prototype.addOutputUnit=function(){};d=l;a.CompileInfo=d;var c=function(){this.data=""};c.prototype.Write=function(a){this.data+=a};c.prototype.WriteLine=function(a){this.data+=a+"\n"};c.prototype.Close=function(){};var i,l=function(){this.units={};this.units[".js"]=new c};l.prototype.getEmitCallback=function(){var a=this;return function(b){return a.emitCallback.apply(a,[b])}};l.prototype.emitCallback=function(a){"undefined"==typeof this.units[a]&&(this.units[a]=new c);return this.units[a]};l.prototype.getDefaultStream=
function(){return this.units[".js"]};l.prototype.getDefJS=function(){return this.units[".js"].data};l.prototype.getDefDecl=function(){return this.units[".d.ts"]?this.units[".d.ts"].data:""};l.prototype.getUnit=function(a){return this.units[a].data};l.prototype.getAllUnits=function(){return this.units};i=l;a.compile=e;a.compileStr=h;a.runStr=function(a,c,d){a=h(a,c,d);b(a);return a};a.insertScriptBlock=b;a.runScriptBlock=j;a.runAllScriptBlocks=function(a,b,c){if("undefined"==typeof a||null===a)a=["text/typescript",
"application/typescript"];var d=!0,e=null;if(document.querySelectorAll){for(var d=!1,e="",h=0,i=a.length;h<i;h++)e+='script[type="'+a[h]+'"]',h!=i-1&&(e+=",");e=document.querySelectorAll(e)}else e=document.getElementsByTagName("script");h=0;for(i=e.length;h<i;h++){var l=e[h];if(d){for(var r=l.getAttribute("type").toLowerCase(),s=!1,t=0,v=a.length;t<v;t++)if(r==a[t]){s=!0;break}if(!s)continue}l.src?g(l.src):j(l,b,c)}};a.compileExtern=g})(TSCompiler||(TSCompiler={}));

...
(function(a){var d=function(){this.goNextSibling=this.goChildren=!0;this.reverseSiblings=!1};d.prototype.stopWalk=function(a){"undefined"===typeof a&&(a=!0);this.goChildren=!a;this.goNextSibling=!a};a.AstWalkOptions=d;var h=function(a,e,f,j,l){this.childrenWalkers=a;this.pre=e;this.post=f;this.options=j;this.state=l};h.prototype.walk=function(a,e){var f=this.pre(a,e,this);void 0===f&&(f=a);if(this.options.goChildren){var j=this.options.goNextSibling;this.options.goNextSibling=!0;this.childrenWalkers[a.nodeType](a,
e,this);this.options.goNextSibling=j}else this.options.goChildren=!0;return this.post?(j=this.post(f,e,this),void 0===j&&(j=f),j):f};var b=function(){this.childrenWalkers=[];this.initChildrenWalkers()};b.prototype.walk=function(a,e,f,j,l){return this.getWalker(e,f,j,l).walk(a,null)};b.prototype.getWalker=function(a,e,f,j){return this.getSlowWalker(a,e,f,j)};b.prototype.getSlowWalker=function(a,e,f,j){f||(f=new d);return new h(this.childrenWalkers,a,e,f,j)};b.prototype.initChildrenWalkers=function(){this.childrenWalkers[a.NodeType.None]=
...
function(a,e,f){e=a.members.length;if(f.options.reverseSiblings)for(var j=e-1;0<=j;j--)f.options.goNextSibling&&(a.members[j]=f.walk(a.members[j],a));else for(j=0;j<e;j++)f.options.goNextSibling&&(a.members[j]=f.walk(a.members[j],a))};e.walkUnaryExpressionChildren=function(a,e,f){a.castTerm&&(a.castTerm=f.walk(a.castTerm,a));a.operand&&(a.operand=f.walk(a.operand,a))};e.walkBinaryExpressionChildren=function(a,e,f){f.options.reverseSiblings?(a.operand2&&(a.operand2=f.walk(a.operand2,a)),a.operand1&&
...
var j=function(a){if(a&&0<a.length)for(var c=0;c<a.length;c++){var f=a[c].minChar,j=a[c].limChar;a[c].isBlockComment||j++;e>=f&&e<j&&k.path.push(a[c])}},k=new g;a.getAstWalkerFactory().walk(c,function(m,g,d){if(b(m)){var h=a.hasFlag(f,l.EdgeInclusive)||m.nodeType===a.NodeType.Name||e===c.limChar,g=m.minChar,h=m.limChar+(h?1:0);if(e>=g&&e<h){var p=k.path.ast();(null==p||m.minChar>=p.minChar&&m.limChar<=p.limChar)&&k.path.push(m)}e<h&&j(m.preComments);e>=g&&j(m.postComments);a.hasFlag(f,l.DontPruneSearchBasedOnPosition)||
...
h[0];b.jsFile.WriteLine("//@ sourceMappingURL="+b.jsFileName+d.MapFileExtension);for(var k=b.sourceMapOut,g="",e=[],l=0,c=0,i=0,f=0,j=0,v=!1,m=0;m<h.length;m++)if(b=h[m],b.sourceMappings){var q=e.length;e.push(b.tsFileName);for(var u=b.sourceMappings,n=0,p=u.length;n<p;n++){var r=u[n];if(d.CanEmitMapping(u,r)){if(c!==r.emittedStartLine)for(;c<r.emittedStartLine;)l=0,g+=";",c++;else v&&(g+=",");g+=a.Base64VLQFormat.encode(r.emittedStartColumn-l);l=r.emittedStartColumn;g+=a.Base64VLQFormat.encode(q-
j);j=q;g+=a.Base64VLQFormat.encode(r.sourceStartLine-1-f);f=r.sourceStartLine-1;g+=a.Base64VLQFormat.encode(r.sourceStartColumn-i);i=r.sourceStartColumn;v=!0}}}""!=g&&(k.Write("{"),k.Write('"version":3,'),k.Write('"file":"'+b.jsFileName+'",'),k.Write('"sources":["'+e.join('","')+'"],'),k.Write('"names":[],'),k.Write('"mappings":"'+g),k.Write('"'),k.Write("}"));k.Close()};a.SourceMapper=d})(TypeScript||(TypeScript={}));
...
a.hasFlag(this.thisClassNode.varFlags,a.VarFlags.ClassSuperMustBeFirstCallInConstructor);this.emitParensAndCommentsInPlace(b,!0);this.recordSourceMappingStart(b);(!b.isAccessor()||!b.accessorSymbol.isObjectLitField)&&this.writeToOutput("function ");g&&(g=b.getNameText())&&!b.isAccessor()&&this.writeToOutput(g);this.writeToOutput("(");f&&(f=this.emitFuncSignatureIdentifier(b,!1,j));var m=0,j=0,q,u=[];if(b.args){g=this.setContainer(h.Args);m=b.args.members.length;b.variableArgList&&m--;for(j=0;j<m;j++)q=
b.args.members[j],q.init&&u.push(q),this.emitJavascript(q,a.TokenID.LParen,!1,f),j<m-1&&(this.writeToOutput(", "),f&&this.declFile.Write(", "));this.setContainer(g)}this.writeLineToOutput(") {");g=null;f&&(this.emitFuncSignatureVariableArg(b),b.hasStaticDeclarations()&&(g=this.setDeclContainingAST(b)));this.increaseIndent();for(j=0;j<u.length;j++)q=u[j],this.emitIndent(),this.recordSourceMappingStart(q),this.writeToOutput("if (typeof "+q.id.text+' === "undefined") { '),this.recordSourceMappingStart(q.id),
this.writeToOutput(q.id.text),this.recordSourceMappingEnd(q.id),this.writeToOutput(" = "),this.emitJavascript(q.init,a.TokenID.LParen,!1),this.writeLineToOutput("; }"),this.recordSourceMappingEnd(q);if(b.isConstructor&&!d){if(b.args){m=b.args.members.length;for(j=0;j<m;j++)q=b.args.members[j],(q.varFlags&a.VarFlags.Property)!=a.VarFlags.None&&(this.emitIndent(),this.recordSourceMappingStart(q),this.recordSourceMappingStart(q.id),this.writeToOutput("this."+q.id.text),this.recordSourceMappingEnd(q.id),
this.writeToOutput(" = "),this.recordSourceMappingStart(q.id),this.writeToOutput(q.id.text),this.recordSourceMappingEnd(q.id),this.writeLineToOutput(";"),this.recordSourceMappingEnd(q))}a.hasFlag(b.fncFlags,a.FncFlags.ClassMethod)||this.emitConstructorCalls(l,i)}c&&(this.emitIndent(),this.writeLineToOutput("var _this = this;"));b.variableArgList&&(m=b.args.members.length,j=b.args.members[m-1],this.emitIndent(),this.recordSourceMappingStart(j),this.writeToOutput("var "),this.recordSourceMappingStart(j.id),
...
this.emitState.line,this.sourceMapper.currentMapping=a.parent)};d.prototype.emitSourceMappings=function(){a.SourceMapper.EmitSourceMapping(this.allSourceMappers)};d.prototype.emitJavascriptList=function(b,g,e,l,c,i,f){if(null!=b)if(b.nodeType!=a.NodeType.List)this.emitJavascript(b,e,l,f);else if(0!=b.members.length){this.emitParensAndCommentsInPlace(b,!0);for(var j=b.members.length,d=0;d<j;d++){if(1==d&&i){var m=this.thisClassNode.constructorDecl;if(m&&m.args)for(var q=m.args.members.length,h=0;h<
q;h++){var n=m.args.members[h];(n.varFlags&a.VarFlags.Property)!=a.VarFlags.None&&(this.emitIndent(),this.recordSourceMappingStart(n),this.recordSourceMappingStart(n.id),this.writeToOutput("this."+n.id.text),this.recordSourceMappingEnd(n.id),this.writeToOutput(" = "),this.recordSourceMappingStart(n.id),this.writeToOutput(n.id.text),this.recordSourceMappingEnd(n.id),this.writeLineToOutput(";"),this.recordSourceMappingEnd(n))}m=this.thisClassNode.members.members.length;for(q=0;q<m;q++)this.thisClassNode.members.members[q].nodeType==
a.NodeType.VarDecl&&(h=this.thisClassNode.members.members[q],!a.hasFlag(h.varFlags,a.VarFlags.Static)&&h.init&&(this.emitIndent(),this.emitJavascriptVarDecl(h,a.TokenID.Tilde),this.writeLineToOutput("")))}m=b.members[d];q=m.nodeType==a.NodeType.FuncDecl&&a.hasFlag(m.fncFlags,a.FncFlags.Static)||m.nodeType==a.NodeType.VarDecl&&a.hasFlag(m.varFlags,a.VarFlags.Static);if(!(c?!q:q))this.emitJavascript(m,e,l,f),g&&d<j-1?l?this.writeLineToOutput(g):this.writeToOutput(g):l&&(m.nodeType!=a.NodeType.Interface&&
...
this.writeLineToOutput(" = (function () {");this.increaseIndent();if(d){m=b.extendsList.members[0];m=m.nodeType==a.NodeType.Call?m.target:m;this.emitIndent();this.writeLineToOutput("__extends("+c+", _super);");var q=j.extendsList.length;if(1<q)for(l=1;l<q;l++)this.emitAddBaseMethods(c,j.extendsList[l],b)}this.emitIndent();if(b.constructorDecl)this.emitJavascript(b.constructorDecl,a.TokenID.LParen,!1,!1),g&&this.emitMembersFromConstructorDefinition(b.constructorDecl);else{q=0;this.recordSourceMappingStart(b);
this.increaseIndent();this.writeToOutput("function "+b.name.text+"() {");d&&(this.writeLineToOutput(""),this.emitIndent(),this.writeLineToOutput("_super.apply(this, arguments);"),q++);for(var u=this.thisClassNode.members.members,l=0;l<u.length;l++)u[l].nodeType==a.NodeType.VarDecl&&(j=u[l],!a.hasFlag(j.varFlags,a.VarFlags.Static)&&j.init&&(this.writeLineToOutput(""),this.emitIndent(),this.emitJavascriptVarDecl(j,a.TokenID.Tilde),q++));q?(this.writeLineToOutput(""),this.decreaseIndent(),this.emitIndent(),
this.writeLineToOutput("}")):(this.writeLineToOutput(" }"),this.decreaseIndent());this.recordSourceMappingEnd(b)}l=b.definitionMembers.members.length;for(q=0;q<l;q++)if(j=b.definitionMembers.members[q],j.nodeType==a.NodeType.FuncDecl)a.hasFlag(j.fncFlags,a.FncFlags.Method)&&!j.isSignature()?a.hasFlag(j.fncFlags,a.FncFlags.Static)?j.isAccessor()?this.emitPropertyAccessor(j,this.thisClassNode.name.text,!1,g):(this.emitIndent(),this.recordSourceMappingStart(j),this.writeToOutput(b.name.text+"."+j.name.text+
...
(i(b.operand1),i(b.operand2)):i(b))};g.prototype.parseFormalParameterList=function(e,b,c,i,f,j,g,m){b.minChar=this.scanner.startPos;f?this.tok=this.scanner.scan():m||this.chkCurTok(a.TokenID.LParen,"Expected '('",e|a.ErrorRecoverySet.RParen);var d=!1,k=!0,n=!1,p=!1,r=!1;m&&(this.transformAnonymousArgsIntoFormals(b,m),p=!0);for(;;){var s=!1,t=a.VarFlags.None,w=this.scanner.startPos;this.inferPropertiesFromThisAssignment&&this.tok.tokenId==a.TokenID.THIS&&(c||this.reportParseError("Instance property declarations using 'this' may only be used in class constructors"),
...
null;if(!p&&this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode))A=new a.Identifier(this.tok.getText()),A.minChar=this.scanner.startPos,A.limChar=this.scanner.pos;if(p||A){var s=!0,C=null,x=null;p&&b.members.length?(x=b.members[b.members.length-1],x.isOptional&&(r=n=!0)):(x=new a.ArgDecl(A),j&&this.reportParseError("Property getters may not take any arguments"),g&&!k&&this.reportParseError("Property setters may only take one argument"),x.minChar=w,x.preComments=this.parseComments(),
...
d&&x.isOptionalArg()&&this.reportParseError("Varargs may not be optional or have default parameters");x.postComments=this.parseComments();x.typeExpr=C;x.limChar=this.scanner.lastTokenLimChar();x.varFlags|=t;p?p=!1:b.append(x)}k=!1;if(this.tok.tokenId==a.TokenID.Comma)s&&!d?this.tok=this.scanner.scan():(this.reportParseError("Unexpected ',' in argument list"),this.errorRecovery&&(this.tok=this.scanner.scan()));else break}f?this.chkCurTok(a.TokenID.RBrack,"Expected ']'",e|a.ErrorRecoverySet.LCurly|
a.ErrorRecoverySet.SColon):(!m||r)&&this.chkCurTok(a.TokenID.RParen,"Expected ')'",e|a.ErrorRecoverySet.LCurly|a.ErrorRecoverySet.SColon);b.limChar=this.scanner.lastTokenLimChar();return d};g.prototype.parseFncDecl=function(e,l,c,i,f,j,g,m,d,h){var k=this.scanner.leftCurlyCount,p=this.scanner.rightCurlyCount,r=this.parsingClassConstructorDefinition;this.parsingClassConstructorDefinition=!1;var s=null,t=this.scanner.startPos,w=this.scanner.pos,A=this.nestingLevel;this.nestingLevel=0;!this.style_funcInLoop&&
...
i.minChar=this.scanner.startPos,i.flags|=a.ASTFlags.Error,this.skip(e|a.ErrorRecoverySet.Comma),i.limChar=this.scanner.lastTokenLimChar()));d?d=!1:this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.QMark&&(i.flags|=a.ASTFlags.OptionalName,this.tok=this.scanner.scan());if(p)j=new a.ASTList,this.parseFormalParameterList(e|a.ErrorRecoverySet.RParen,j,!1,!0,!1,!m,m,null),f=this.parseFunctionStatements(e|a.ErrorRecoverySet.RCurly,i,!1,!0,j,a.AllowedElements.FunctionDecls,this.scanner.startPos,!1,
...
i?(this.reportParseError("try with neither catch nor finally"),this.errorRecovery?(f=new a.TryFinally(f,new a.Finally(new a.AST(a.NodeType.Empty))),f.flags|=a.ASTFlags.Error,f.minChar=this.scanner.startPos,f.limChar=this.scanner.pos,f):new a.TryFinally(f,new a.Finally(new a.AST(a.NodeType.Empty)))):i;i&&(f=i);b=this.parseFinally(b,l,c);g=new a.TryFinally(f,b);g.minChar=j;g.limChar=b.limChar;return g};g.prototype.parseStatement=function(e,l,c){function i(){return a.hasFlag(d,a.Modifiers.Ambient)||
a.hasFlag(c,a.Modifiers.Ambient)}function f(){a.hasFlag(d,a.Modifiers.Exported)&&this.reportError("Statement may not be exported")}var j=null,g=null,m,d=a.Modifiers.None,k=this.scanner.startPos,n=!1,p=!1;m=null;var r=this.parseComments();for(this.state=b.StartStatement;;){switch(this.tok.tokenId){case a.TokenID.EOF:j=new a.AST(a.NodeType.Error);j.minChar=k;j.limChar=this.scanner.pos;break;case a.TokenID.FUNCTION:this.inStaticFnc&&this.reportParseError("Ambient static function delarations may only contain other ambient static function declarations");
if(this.parsingDeclareFile||i()||this.ambientModule){this.tok=this.scanner.scan();m=this.parsePropertyDecl(e|a.ErrorRecoverySet.SColon,d,!0,!1);if(m.nodeType==a.NodeType.VarDecl)this.reportParseError("function keyword can only introduce function declaration");else if(m.nodeType==a.NodeType.FuncDecl&&(m.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;j=m}else j=this.parseFncDecl(e,!0,!1,!1,null,!1,!1,i(),d,null),a.hasFlag(j.fncFlags,a.FncFlags.IsFatArrowFunction)&&(p=!0),this.ambientModule&&this.reportParseError("function declaration not permitted within ambient module"),
a.hasFlag(d,a.Modifiers.Exported)&&(j.fncFlags|=a.FncFlags.Exported);break;case a.TokenID.MODULE:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None?(this.reportParseError("module not allowed in this context"),this.tok=this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar()):j=this.parseModuleDecl(e,d);break;case a.TokenID.IMPORT:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None?(this.reportParseError("module not allowed in this context"),
this.tok=this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar()):j=this.parseImportDecl(e,d);break;case a.TokenID.EXPORT:(l&a.AllowedElements.ModuleDecls)==a.AllowedElements.None&&(this.reportParseError("'export' statements are only allowed at the global and module levels"),this.tok=this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar());this.topLevel&&(this.hasTopLevelImportOrExport=!0);d|=a.Modifiers.Exported;
...
this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar()):(this.tok=this.scanner.scan(),j=new a.Identifier(this.tok.getText()),j.minChar=this.scanner.startPos,j.limChar=this.scanner.pos,this.tok=this.scanner.scan(),j=this.parseClassMemberVariableDeclaration(j,k,this.parsingClassConstructorDefinition,e,d));else if(this.tok.tokenId!=a.TokenID.INTERFACE){if(this.tok.tokenId==a.TokenID.GET){if(this.prevIDTok=this.tok,this.tok=this.scanner.scan(),a.codeGenTarget<
...
this.strictMode)))d|=a.Modifiers.Setter,this.prevIDTok=null;m=this.parsePropertyDecl(e|a.ErrorRecoverySet.SColon,d,i(),!1);if(m.nodeType==a.NodeType.VarDecl||m.nodeType==a.NodeType.FuncDecl&&a.hasFlag(m.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;j=m}break;case a.TokenID.PUBLIC:if(this.parsingClassConstructorDefinition)this.inferPropertiesFromThisAssignment||this.reportParseError("Property declarations are not permitted within constructor bodies"),this.tok=this.scanner.scan(),k=this.scanner.pos,
...
k,this.parsingClassConstructorDefinition,e,d));else if((l&a.AllowedElements.Properties)==a.AllowedElements.None)this.reportParseError("'property' statements are only allowed within classes"),this.tok=this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar();else{d|=a.Modifiers.Public;this.tok=this.scanner.scan();if(this.tok.tokenId==a.TokenID.GET){if(this.prevIDTok=this.tok,this.tok=this.scanner.scan(),a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("Property accessors are only available when targeting ES5 or greater"),
this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode))d|=a.Modifiers.Getter,this.prevIDTok=null}else if(this.tok.tokenId==a.TokenID.SET&&(this.prevIDTok=this.tok,this.tok=this.scanner.scan(),a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("Property accessors are only available when targeting ES5 or greater"),this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)))d|=a.Modifiers.Setter,this.prevIDTok=null;m=this.parsePropertyDecl(e|a.ErrorRecoverySet.SColon,
d,i(),!1);if(m.nodeType==a.NodeType.VarDecl||m.nodeType==a.NodeType.FuncDecl&&a.hasFlag(m.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;j=m}break;case a.TokenID.DECLARE:l&a.AllowedElements.AmbientDecls||this.reportParseError("Ambient declarations are only allowed at the top-level or module scopes");!this.parsingDeclareFile&&a.hasFlag(c,a.Modifiers.Ambient)&&this.reportParseError("Duplicate ambient declaration in this context. (Is the enclosing module or class already ambient?)");d|=a.Modifiers.Ambient;
this.tok=this.scanner.scan();break;case a.TokenID.CLASS:(l&a.AllowedElements.ClassDecls)==a.AllowedElements.None?(this.reportParseError("class not allowed in this context"),this.tok=this.scanner.scan(),j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar()):j=this.parseClassDecl(e,k,d);break;case a.TokenID.INTERFACE:(l&a.AllowedElements.InterfaceDecls)==a.AllowedElements.None?(this.reportParseError("interface not allowed in this context"),this.tok=this.scanner.scan(),
j=new a.AST(a.NodeType.Error),j.minChar=k,j.limChar=this.scanner.lastTokenLimChar()):j=this.parseInterfaceDecl(e,d);break;case a.TokenID.VAR:p=this.parseVarDecl(e|a.ErrorRecoverySet.StmtStart,d,!0,!1,!1);j=p.nodeType==a.NodeType.VarDecl?p:new a.Block(p,!1);p=!0;if(this.parsingDeclareFile||this.ambientModule&&j.nodeType==a.NodeType.VarDecl)j.varFlags|=a.VarFlags.Exported;break;case a.TokenID.STATIC:null==this.currentClassDecl&&this.reportParseError("Statics may only be class members");f();d|=a.Modifiers.Public;
...
this.tok.tokenId==a.TokenID.ID||a.convertTokToID(this.tok,this.strictMode)))d|=a.Modifiers.Setter;i()&&(d|=a.Modifiers.Ambient);m=this.parsePropertyDecl(e|a.ErrorRecoverySet.SColon,d,this.parsingDeclareFile||(d&a.Modifiers.Ambient)!=a.Modifiers.None,!0);(j=this.topStaticsList())&&m.nodeType==a.NodeType.VarDecl&&j.append(m);if(m.nodeType==a.NodeType.VarDecl||m.nodeType==a.NodeType.FuncDecl&&a.hasFlag(m.fncFlags,a.FncFlags.IsFatArrowFunction))p=!0;j=m;break;case a.TokenID.FOR:f();d!=a.Modifiers.None&&
this.reportParseError("syntax error: for statement does not take modifiers");k=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",e|a.ErrorRecoverySet.ExprStart|a.ErrorRecoverySet.Var);this.state=b.ForInit;n=!0;switch(this.tok.tokenId){case a.TokenID.VAR:m=this.parseVarDecl(e|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.In,a.Modifiers.None,!1,!1,!1);break;case a.TokenID.SColon:m=null;this.state=b.ForCondStart;break;default:m=this.parseExpr(e|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.In,
a.OperatorPrecedence.No,!1,h.NoTypes)}this.state=b.ForInitAfterVar;this.tok.tokenId==a.TokenID.IN?null==m||!n?(this.reportParseError("malformed for statement"),this.errorRecovery&&(this.skip(e|a.ErrorRecoverySet.StmtStart),j=new a.AST(a.NodeType.Empty),j.flags|=a.ASTFlags.Error)):(this.tok=this.scanner.scan(),j=new a.ForInStatement(m,this.parseExpr(a.ErrorRecoverySet.RParen|e,a.OperatorPrecedence.Cma,!1,h.NoTypes)),j.limChar=this.scanner.pos,this.chkCurTok(a.TokenID.RParen,"Expected ')'",a.ErrorRecoverySet.StmtStart|
e),this.pushStmt(j,g),j.body=this.parseStatement(e,l,c),this.popStmt(),j.minChar=k):(m=new a.ForStatement(m),m.minChar=k,this.chkCurTok(a.TokenID.SColon,"Expected ';'",e),this.tok.tokenId==a.TokenID.SColon?m.cond=null:(m.cond=this.parseExpr(e|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes),this.tok.tokenId!=a.TokenID.SColon&&(this.skip(e|a.ErrorRecoverySet.StmtStart),j=m,j.flags|=a.ASTFlags.Error)),this.tok=this.scanner.scan(),m.incr=this.tok.tokenId==a.TokenID.RParen?
null:this.parseExpr(e|a.ErrorRecoverySet.SColon|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes),this.chkCurTok(a.TokenID.RParen,"Expected ')'",e|a.ErrorRecoverySet.LCurly),this.pushStmt(m,g),m.body=this.parseStatement(e,l,c),this.popStmt(),m.limChar=m.body.limChar,j=m);break;case a.TokenID.WITH:a.codeGenTarget<a.CodeGenTarget.ES5&&this.reportParseError("'with' statements are only available in ES5 codegen mode or better");this.strictMode&&this.reportParseError("'with' statements are not available in strict mode");
f();d!=a.Modifiers.None&&this.reportParseError("'with' statement does not take modifiers");k=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",e|a.ErrorRecoverySet.ExprStart|a.ErrorRecoverySet.Var);j=this.parseExpr(e|a.ErrorRecoverySet.Colon,a.OperatorPrecedence.No,!0,h.NoTypes);this.chkCurTok(a.TokenID.RParen,"Expected ')'",e|a.ErrorRecoverySet.LCurly);j=new a.WithStatement(j);j.body=this.parseStatement(e,l,c);j.minChar=k;j.limChar=j.body.limChar;break;case a.TokenID.SWITCH:f();
d!=a.Modifiers.None&&this.reportParseError("'switch' statement does not take modifiers");this.chkNxtTok(a.TokenID.LParen,"Expected '('",e|a.ErrorRecoverySet.ExprStart);j=new a.SwitchStatement(this.parseExpr(e|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes));this.chkCurTok(a.TokenID.RParen,"Expected ')'",e|a.ErrorRecoverySet.LCurly);m=this.scanner.startPos;this.chkCurTok(a.TokenID.LCurly,"Expected '{'",e|a.ErrorRecoverySet.SCase);j.defaultCase=null;j.caseList=new a.ASTList;n=null;for(this.pushStmt(j,
g);;)if(this.tok.tokenId==a.TokenID.CASE||this.tok.tokenId==a.TokenID.DEFAULT){var s=this.tok.tokenId==a.TokenID.DEFAULT,n=new a.CaseStatement;n.minChar=this.scanner.startPos;this.tok=this.scanner.scan();s?j.defaultCase=n:n.expr=this.parseExpr(e|a.ErrorRecoverySet.Colon,a.OperatorPrecedence.No,!0,h.NoTypes);this.chkCurTok(a.TokenID.Colon,"Expected ':'",e|a.ErrorRecoverySet.StmtStart);n.body=new a.ASTList;this.parseStmtList(e|a.ErrorRecoverySet.RCurly,n.body,!1,!0,l,d);n.limChar=n.body.limChar;j.caseList.append(n)}else break;
j.caseList.minChar=m;j.caseList.limChar=this.scanner.pos;j.limChar=j.caseList.limChar;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",e);this.popStmt();break;case a.TokenID.WHILE:f();d!=a.Modifiers.None&&this.reportParseError("'while' statement does not take modifiers");k=this.scanner.startPos;this.chkNxtTok(a.TokenID.LParen,"Expected '('",a.ErrorRecoverySet.ExprStart|e);j=new a.WhileStatement(this.parseExpr(e|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes));j.minChar=k;this.chkCurTok(a.TokenID.RParen,
"Expected ')'",e|a.ErrorRecoverySet.StmtStart);this.pushStmt(j,g);j.body=this.parseStatement(e,l,c);j.limChar=j.body.limChar;this.popStmt();break;case a.TokenID.DO:f();d!=a.Modifiers.None&&this.reportParseError("'do' statement does not take modifiers");k=this.scanner.startPos;this.tok=this.scanner.scan();j=new a.DoWhileStatement;j.minChar=k;this.pushStmt(j,g);j.body=this.parseStatement(e|a.ErrorRecoverySet.While,l,c);this.popStmt();j.whileAST=new a.Identifier("while");j.whileAST.minChar=this.scanner.startPos;
this.chkCurTok(a.TokenID.WHILE,"Expected 'while'",e|a.ErrorRecoverySet.LParen);j.whileAST.limChar=j.whileAST.minChar+5;this.chkCurTok(a.TokenID.LParen,"Expected '('",e|a.ErrorRecoverySet.ExprStart);j.cond=this.parseExpr(e|a.ErrorRecoverySet.RParen,a.OperatorPrecedence.No,!0,h.NoTypes);j.limChar=this.scanner.pos;this.chkCurTok(a.TokenID.RParen,"Expected ')'",e);this.tok.tokenId==a.TokenID.SColon&&(this.tok=this.scanner.scan());break;case a.TokenID.IF:f();d!=a.Modifiers.None&&this.reportParseError("if statement does not take modifiers");
...
c),j.limChar=j.elseBod.limChar);this.popStmt();break;case a.TokenID.TRY:f();d!=a.Modifiers.None&&this.reportParseError("try statement does not take modifiers");k=this.scanner.startPos;j=this.parseTryCatchFinally(e,a.AllowedElements.FunctionBody,c,g);break;case a.TokenID.LCurly:f();d!=a.Modifiers.None&&this.reportParseError("block does not take modifiers");k=this.scanner.startPos;this.tok=this.scanner.scan();j=new a.Block(new a.ASTList,!0);this.pushStmt(j,g);this.parseStmtList(e|a.ErrorRecoverySet.RCurly,
j.stmts,!1,!1,a.AllowedElements.Block,d);this.popStmt();j.stmts.minChar=k;j.stmts.limChar=this.scanner.pos;j.minChar=j.stmts.minChar;j.limChar=j.stmts.limChar;this.chkCurTok(a.TokenID.RCurly,"Expected '}'",e);break;case a.TokenID.SColon:f();d!=a.Modifiers.None&&this.reportParseError("modifier can not appear here");j=new a.AST(a.NodeType.Empty);this.tok=this.scanner.scan();break;case a.TokenID.BREAK:case a.TokenID.CONTINUE:f();d!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before jump statement");
p=new a.Jump(this.tok.tokenId==a.TokenID.BREAK?a.NodeType.Break:a.NodeType.Continue);this.tok=this.scanner.scan();this.tok.tokenId==a.TokenID.ID&&!this.scanner.lastTokenHadNewline()&&(p.target=this.tok.getText(),this.tok=this.scanner.scan());this.resolveJumpTarget(p);j=p;p=!0;break;case a.TokenID.RETURN:f();d!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before return statement");this.inFnc||this.reportParseError("return statement outside of function body");k=this.scanner.startPos;
this.tok=this.scanner.scan();j=new a.ReturnStatement;j.minChar=k;this.tok.tokenId!=a.TokenID.SColon&&(this.tok.tokenId!=a.TokenID.RCurly&&!this.scanner.lastTokenHadNewline())&&(j.returnExpression=this.parseExpr(e|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.No,!0,h.NoTypes));p=!0;j.limChar=this.scanner.lastTokenLimChar();break;case a.TokenID.THROW:f();d!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before a throw statement");k=this.scanner.startPos;this.tok=this.scanner.scan();
this.tok.tokenId!=a.TokenID.SColon&&this.tok.tokenId!=a.TokenID.RCurly&&!this.scanner.lastTokenHadNewline()?m=this.parseExpr(e|a.ErrorRecoverySet.SColon,a.OperatorPrecedence.No,!0,h.NoTypes):(this.reportParseError("throw with no target"),m=null);j=new a.UnaryExpression(a.NodeType.Throw,m);j.limChar=this.scanner.lastTokenLimChar();p=!0;break;case a.TokenID.ENUM:this.tok=this.scanner.scan();j=this.parseEnumDecl(e,d);j.minChar=k;j.limChar=this.scanner.lastTokenLimChar();if(this.parsingDeclareFile||a.hasFlag(d,
a.Modifiers.Ambient))j.modFlags|=a.ModuleFlags.Ambient;a.hasFlag(d,a.Modifiers.Exported)&&(j.modFlags|=a.ModuleFlags.Exported);break;case a.TokenID.DEBUGGER:f();d!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before debugger statement");k=this.scanner.startPos;this.tok=this.scanner.scan();j=new a.DebuggerStatement;j.minChar=k;p=!0;j.limChar=this.scanner.lastTokenLimChar();break;default:d!=a.Modifiers.None&&this.reportParseError("modifiers can not appear before an expression statement or label"),
k=this.scanner.startPos,n=this.scanner.pos,m=this.parseExpr(a.ErrorRecoverySet.Colon|a.ErrorRecoverySet.StmtStart|e,a.OperatorPrecedence.No,!0,h.NoTypes),this.scanner.pos==n?(this.tok=this.scanner.scan(),j=m):this.tok.tokenId==a.TokenID.Colon&&!this.scanner.lastTokenHadNewline()&&m&&m.nodeType==a.NodeType.Name?(null==g&&(g=new a.ASTList),g.append(new a.Label(m)),this.tok=this.scanner.scan()):(j=m,p=!0)}if(j)break}if(p)switch(this.tok.tokenId){case a.TokenID.SColon:this.tok=this.scanner.scan();j.flags|=
...
j.preComments=r;this.ambientModule&&!this.okAmbientModuleMember(j)&&this.reportParseError("statement not permitted within ambient module");j.flags|=a.ASTFlags.IsStatement;return j};g.prototype.okAmbientModuleMember=function(b){var d=b.nodeType;return d==a.NodeType.Class||d==a.NodeType.Import||d==a.NodeType.Interface||d==a.NodeType.Module||d==a.NodeType.Empty||d==a.NodeType.VarDecl&&(a.hasFlag(b.varFlags,a.VarFlags.Property)||a.hasFlag(b.varFlags,a.VarFlags.Exported))||d==a.NodeType.FuncDecl&&b.isMethod()};
g.prototype.parseStmtList=function(e,d,c,i,f,j){d.minChar=this.scanner.startPos;var g=this.scanner.pos,m=(f&a.AllowedElements.ModuleDecls)==a.AllowedElements.None,k=(f&a.AllowedElements.ClassDecls)==a.AllowedElements.None,e=e|a.ErrorRecoverySet.TypeScriptS|a.ErrorRecoverySet.RCurly;this.state=b.StartStmtList;var h=this.strictMode;for(this.nestingLevel++;;){if(this.tok.tokenId==a.TokenID.RCurly||i&&(this.tok.tokenId==a.TokenID.CASE||this.tok.tokenId==a.TokenID.DEFAULT)||m&&this.tok.tokenId==a.TokenID.EXPORT||
k&&this.tok.tokenId==a.TokenID.CLASS||this.tok.tokenId==a.TokenID.EOF){this.state=b.EndStmtList;d.limChar=g;0==d.members.length?d.preComments=this.parseComments():d.postComments=this.parseComments();this.strictMode=h;this.nestingLevel--;break}var n=this.parseStatement(e&~(a.ErrorRecoverySet.Else|a.ErrorRecoverySet.RParen|a.ErrorRecoverySet.Catch|a.ErrorRecoverySet.Colon),f,j);n&&(n.postComments=this.combineComments(n.postComments,this.parseCommentsForLine(this.scanner.prevLine)),d.append(n),g=n.limChar,
c&&(n.nodeType==a.NodeType.QString?"use strict"==n.text?(d.flags|=a.ASTFlags.StrictMode,this.strictMode=!0):c=!1:c=!1))}};g.prototype.quickParse=function(b,d,c){var i=a.moduleGenTarget;try{a.moduleGenTarget=a.ModuleGenTarget.Local;var f=this.parse(b,d,c,a.AllowedElements.QuickParse);return new k(f,this.scanner.lexState)}finally{a.moduleGenTarget=i}};g.prototype.parse=function(e,d,c,i){"undefined"===typeof i&&(i=a.AllowedElements.Global);this.ambientModule=!1;this.topLevel=!0;this.hasTopLevelImportOrExport=
this.parseError=!1;this.fname=d;this.currentUnitIndex=c;this.amdDependencies=[];this.scanner.resetComments();this.scanner.setSourceText(e,a.LexMode.File);var e=this.scanner.leftCurlyCount,f=this.scanner.rightCurlyCount,j=this.scanner.pos;this.tok=this.scanner.scan();this.pushDeclLists();var g=new a.ASTList;g.minChar=j;this.state=b.StartScript;this.parsingDeclareFile=a.isDSTRFile(d)||a.isDTSFile(d);this.parseStmtList(a.ErrorRecoverySet.EOF|a.ErrorRecoverySet.Func,g,!0,!1,i,a.Modifiers.None);this.tok.tokenId!=
a.TokenID.EOF&&this.reportParseError("Unexpected statement block terminator '"+a.tokenTable[this.tok.tokenId].text+"'");this.state=b.EndScript;g.limChar=this.scanner.pos;i=null;if(a.moduleGenTarget!=a.ModuleGenTarget.Local&&this.hasTopLevelImportOrExport){var m=a.switchToForwardSlashes(d),i=new a.Identifier(m),i=new a.ModuleDecl(i,g,this.topVarList(),this.topScopeList());i.modFlags|=a.ModuleFlags.IsDynamic;i.modFlags|=a.ModuleFlags.IsWholeFile;i.modFlags|=a.ModuleFlags.Exported;this.parsingDeclareFile&&
(i.modFlags|=a.ModuleFlags.Ambient);i.minChar=j;i.limChar=this.scanner.pos;i.prettyName=a.getPrettyName(m);i.amdDependencies=this.amdDependencies;g=new a.ASTList;g.minChar=i.minChar;g.limChar=i.limChar;g.append(i)}m=new a.Script(this.topVarList(),this.topScopeList());m.bod=g;this.popDeclLists();m.minChar=j;m.limChar=this.scanner.pos;m.locationInfo=new a.LocationInfo(d,this.scanner.lineMap,c);m.leftCurlyCount=this.scanner.leftCurlyCount-e;m.rightCurlyCount=this.scanner.rightCurlyCount-f;m.isDeclareFile=
this.parsingDeclareFile;m.topLevelMod=i;return m};a.Parser=g;a.quickParse=function(b,d,c,i,f,j){d=c.getText(i,f);b.log("Quick parse range ("+i+","+f+'): "'+a.stringToLiteral(d,100)+'"');b=new g;b.setErrorRecovery(null,-1,-1);b.errorCallback=j;j=new a.TypeDecl(a.NodeType.Class,null,null,null,null,null);b.currentClassDecl=j;return b.quickParse(new a.StringSourceText(d),"",0)}})(TypeScript||(TypeScript={}));
...
a.LexMode,i=a.CommentStyle||(a.CommentStyle={});i._map=[];i._map[0]="Line";i.Line=0;i._map[1]="Block";i.Block=1;var m=function(a){this.text=a};m.prototype.getText=function(a,c){return this.text.substring(a,c)};m.prototype.getLength=function(){return this.text.length};a.StringSourceText=m;var q=function(a,c,b){this.segmentStart=a;this.segmentEnd=c;this.segment=b};q.prototype.charCodeAt=function(a){return this.segment.charCodeAt(a-this.segmentStart)};q.prototype.substring=function(a,c){return this.segment.substring(a-
this.segmentStart,c-this.segmentStart)};a.SourceTextSegment=q;var u=function(a,c){this.seg1=a;this.seg2=c};u.prototype.charCodeAt=function(a){return this.seg1.segmentStart<=a&&a<this.seg1.segmentEnd?this.seg1.segment.charCodeAt(a-this.seg1.segmentStart):this.seg2.segment.charCodeAt(a-this.seg2.segmentStart)};u.prototype.substring=function(a,c){return this.seg1.segmentStart<=a&&c<=this.seg1.segmentEnd?this.seg1.segment.substring(a-this.seg1.segmentStart,c-this.seg1.segmentStart):this.seg2.segment.substring(a-
this.seg2.segmentStart)+this.seg1.segment.substring(0,c-this.seg1.segmentStart)};a.AggerateSourceTextSegment=u;var n=function(a){this.sourceText=a;this.agg=new u(n.emptySegment,n.emptySegment);this.len=this.sourceText.getLength()};n.emptySegment=new q(0,0,"");n.prototype.max=function(a,c){return a>=c?a:c};n.prototype.min=function(a,c){return a<=c?a:c};n.prototype.fetchSegment=function(c,b){if(this.agg.seg1.segmentStart<=c&&b<=this.agg.seg1.segmentEnd)return this.agg.seg1;if(this.agg.seg2.segmentStart<=
c&&b<=this.agg.seg1.segmentEnd)return this.agg;var e=this.agg.seg1,i=e.segmentEnd,f=a.max(i+512,b),f=a.min(f,this.len),j=this.sourceText.getText(i,f),i=new q(i,f,j);this.agg.seg2=e;this.agg.seg1=i;return this.agg};n.prototype.charCodeAt=function(a){return this.fetchSegment(a,a+1).charCodeAt(a)};n.prototype.substring=function(a,c){return this.fetchSegment(a,c).substring(a,c)};a.ScannerTextStream=n;i=function(){this.prevToken=this.prevSavedToken=this.curSavedToken=this.prevToken=null;this.currentToken=
...
b.scopeChain.previous.scope.container.declAST.nodeType==a.NodeType.FuncDecl&&b.scopeChain.previous.scope.container.declAST.isConstructor?e.constructorScope:f&&b.scopeChain.classType?b.scopeChain.classType.containedScope:e.containedScope,e=e.symbol):c.isConstructor&&b.scopeChain.thisType&&(e=b.scopeChain.thisType.symbol);if(null==c.type||a.hasFlag(c.type.symbol.flags,a.SymbolFlags.TypeSetDuringScopeAssignment)){b.scopeChain.fnc&&b.scopeChain.fnc.type&&(e=b.scopeChain.fnc.type.symbol);var g=null,l=
b.scopeChain.fnc,k=c.name?c.name.text:null,h=null;f?(null==l.type.members&&e.getType().memberScope&&(l.type.members=e.type.memberScope.valueMembers),g=b.scopeChain.fnc.type.memberScope,l.innerStaticFuncs[l.innerStaticFuncs.length]=c):g=!c.isConstructor&&e&&e.declAST&&e.declAST.nodeType==a.NodeType.FuncDecl&&e.declAST.isConstructor&&!c.isMethod()?b.scopeChain.thisType.constructorScope:b.scopeChain.scope;k&&("__missing"!=k&&!c.isAccessor())&&(h=g.findLocal(k,!1,!1));b.typeFlow.checker.createFunctionSignature(c,
e,g,h,null==h);if(!c.accessorSymbol&&c.fncFlags&a.FncFlags.ClassMethod&&e&&(!h||h.declAST.nodeType!=a.NodeType.FuncDecl)&&c.isAccessor()||h&&h.isAccessor())c.accessorSymbol=b.typeFlow.checker.createAccessorSymbol(c,h,e.getType(),c.isMethod()&&f,!0,g,e);c.type.symbol.flags|=a.SymbolFlags.TypeSetDuringScopeAssignment}c.name&&c.type&&(c.name.sym=c.type.symbol);c.scopeType=c.type;if(!c.isOverload){var e=new a.StringHashTable,h=new a.ScopedMembers(new a.DualStringHashTable(e,new a.StringHashTable)),g=
new a.StringHashTable,k=new a.ScopedMembers(new a.DualStringHashTable(g,new a.StringHashTable)),g=new a.StringHashTable,l=new a.ScopedMembers(new a.DualStringHashTable(g,new a.StringHashTable)),A=new a.StringHashTable,A=new a.ScopedMembers(new a.DualStringHashTable(A,new a.StringHashTable));c.unitIndex=b.typeFlow.checker.locationInfo.unitIndex;i=new a.SymbolScopeBuilder(h,k,null,null,j,i);l=new a.SymbolScopeBuilder(l,A,null,null,j,null);c.isConstructor&&b.scopeChain.thisType&&(b.scopeChain.thisType.constructorScope=
i);c.symbols=e;if(!c.isSpecialFn()){h=c.type;j=c.signature;c.isConstructor||(h.containedScope=i,i.container=h.symbol,h.memberScope=l,l.container=h.symbol);c.enclosingFnc=b.scopeChain.fnc;h.enclosingType=f?b.scopeChain.classType:b.scopeChain.thisType;h=c.type.symbol;(c.fncFlags&a.FncFlags.Signature)==a.FncFlags.None&&c.vars&&(b.typeFlow.addLocalsFromScope(i,h,c.vars,e,!1),b.typeFlow.addLocalsFromScope(l,h,c.statics,g,!1));if(j.parameters){f=j.parameters.length;for(e=0;e<f;e++)b.typeFlow.checker.resolveTypeLink(i,
...
a.FncFlags.Exported|a.FncFlags.ClassPropertyMethodExported)||d==this.gloMod,g=a.hasFlag(b.fncFlags,a.FncFlags.Static),m=a.hasFlag(b.fncFlags,a.FncFlags.Private),h=a.hasFlag(b.fncFlags,a.FncFlags.Definition),k=a.hasFlag(b.fncFlags,a.FncFlags.Ambient),n=b.isConstructMember()||b.isConstructor,p=d==this.gloMod,r=new a.Signature,s=b.fncFlags&a.FncFlags.IsFunctionExpression;b.returnTypeAnnotation||h?r.returnType=a.getTypeLink(b.returnTypeAnnotation,this,!1):(r.returnType=new a.TypeLink,r.returnType.type=
...
d.memberScope.getAllValueSymbolNames(!0),m=null,h=null,k=null,n=h=null,p=0;p<g.length;p++)if(m=d.memberScope.find(g[p],!1,!1),h=b.memberScope.find(g[p],!1,!1),!(m.kind()==a.SymbolKind.Variable&&m.variable.typeLink.ast&&m.variable.typeLink.ast.nodeType==a.NodeType.Name&&"IArguments"==m.variable.typeLink.ast.text)){m.isInferenceSymbol()&&(n=m,n.typeCheckStatus==a.TypeCheckStatus.NotStarted&&this.typeFlow.typeCheck(m.declAST));k=m.getType();if(!h&&(this.typeFlow.objectInterfaceType&&(h=this.typeFlow.objectInterfaceType.memberScope.find(g[p],
!1,!1)),!h)){if(this.typeFlow.functionInterfaceType&&(k.call||k.construct))h=this.typeFlow.functionInterfaceType.memberScope.find(g[p],!1,!1);if(!h)if(m.flags&a.SymbolFlags.Optional)continue;else return i[j]=void 0,f&&(f.flags|=a.TypeRelationshipFlags.RequiredPropertyIsMissing,f.addMessageToFront("Type '"+b.getTypeName()+"' is missing property '"+g[p]+"' from type '"+d.getTypeName()+"'")),!1}h.isInferenceSymbol()&&(n=h,n.typeCheckStatus==a.TypeCheckStatus.NotStarted&&this.typeFlow.typeCheck(h.declAST));
h=h.getType();if((!k||!(h&&void 0!=i[h.typeID<<16|k.typeID]))&&!this.sourceIsRelatableToTarget(h,k,c,i,f))return i[j]=void 0,f&&(f.flags|=a.TypeRelationshipFlags.IncompatiblePropertyTypes,f.addMessageToFront("Types of property '"+m.name+"' of types '"+b.getTypeName()+"' and '"+d.getTypeName()+"' are incompatible")),!1}return(b.call||d.call)&&!this.signatureGroupIsRelatableToTarget(b.call,d.call,c,i,f)?(f&&(b.call&&d.call?f.addMessageToFront("Call signatures of types '"+b.getTypeName()+"' and '"+d.getTypeName()+
...
b.getTypeName()+"' and '"+d.getTypeName()+"' are incompatible"),f.flags|=a.TypeRelationshipFlags.IncompatibleSignatures),i[j]=void 0,!1):i[j]=!0};h.prototype.signatureGroupIsRelatableToTarget=function(a,b,c,i,f){if(a==b)return!0;if(!a||!b)return!1;for(var d=null,g=null,m=!1,h=0;h<b.signatures.length;h++){for(var d=b.signatures[h],k=0;k<a.signatures.length;k++)if(g=a.signatures[k],this.signatureIsRelatableToTarget(g,d,c,i,f)){m=!0;break}if(m)m=!1;else return!1}return!0};h.prototype.signatureIsRelatableToTarget=
function(b,d,c,i,f){if(!b.parameters||!d.parameters)return!1;var j=d.hasVariableArgList?d.nonOptionalParameterCount-1:d.nonOptionalParameterCount,g=b.hasVariableArgList?b.nonOptionalParameterCount-1:b.nonOptionalParameterCount;if(g>j&&!d.hasVariableArgList)return f&&(f.flags|=a.TypeRelationshipFlags.SourceSignatureHasTooManyParameters,f.addMessageToFront("Call signature expects "+j+" or fewer parameters")),!1;var m=b.returnType.type,h=d.returnType.type;if(h!=this.voidType&&!this.sourceIsRelatableToTarget(m,
h,c,i,f))return f&&(f.flags|=a.TypeRelationshipFlags.IncompatibleReturnTypes),!1;for(var m=g<j&&b.hasVariableArgList?j:g,k=h=null,n=0,p=0;n<m;n++,p++)if(!b.hasVariableArgList||n<g?h=b.parameters[n].parameter.typeLink.type:n==g&&(h=b.parameters[n].parameter.typeLink.type,h.elementType&&(h=h.elementType)),p<d.parameters.length&&p<j?k=d.parameters[p].parameter.typeLink.type:d.hasVariableArgList&&p==j&&(k=d.parameters[p].parameter.typeLink.type,k.elementType&&(k=k.elementType)),!this.sourceIsRelatableToTarget(h,
k,c,i,f)&&!this.sourceIsRelatableToTarget(k,h,c,i,f))return f&&(f.flags|=a.TypeRelationshipFlags.IncompatibleParameterTypes),!1;return!0};a.TypeChecker=h})(TypeScript||(TypeScript={}));
...
e.prototype.inScopeTypeCheck=function(c,b){var f=this.scope;this.scope=b;for(var d=this.thisFnc,e=this.thisType,g=this.thisClassNode,h=this.checker.currentModDecl,l=this.enclosingFncIsMethod,k=this.scope.container,p=null;k;){if(k.kind()==a.SymbolKind.Type){var r=k,s=r.type;s.call&&null==p&&(this.enclosingFncIsMethod=r.isMethod,p=k.declAST);if(s.isClass()){this.thisType=s.instanceType;r.declAST&&r.declAST.nodeType==a.NodeType.Class&&(this.thisClassNode=r.declAST);break}if(s.isModuleType()){this.checker.currentModDecl=
r.declAST;break}}k=k.container}this.thisFnc=p;k=this.typeCheck(c);this.thisFnc=d;this.thisType=e;this.thisClassNode=g;this.checker.currentModDecl=h;this.enclosingFncIsMethod=l;this.scope=f;return k};e.prototype.typeCheck=function(a){return a?a.typeCheck(this):null};e.prototype.inScopeTypeCheckDecl=function(c){c.nodeType==a.NodeType.VarDecl||c.nodeType==a.NodeType.ArgDecl?this.inScopeTypeCheckBoundDecl(c):c.nodeType==a.NodeType.FuncDecl&&c.isAccessor()&&this.typeCheckFunction(c)};e.prototype.inScopeTypeCheckBoundDecl=
...
this.anyType}if(!this.enclosingFncIsMethod&&this.thisFnc&&a.hasFlag(this.thisFnc.fncFlags,a.FncFlags.IsFatArrowFunction))if(this.thisFnc.boundToProperty){var d=this.thisFnc.boundToProperty.sym.container;d.declAST.nodeType==a.NodeType.FuncDecl&&d.declAST.setHasSelfReference()}else{for(var e=d=this.thisFnc.enclosingFnc,g=!1;d;){if(d.isMethod()||d.isConstructor||d.hasSelfReference()){d.setHasSelfReference();g=!0;break}d=d.enclosingFnc}!g&&e&&e.setHasSelfReference();g&&this.thisType&&(c.type=this.thisType)}b&&
...
"Illegal reference to a variable defined in more nested scope")),c.type=b.getType(),b.writeable()||(c.flags&=~a.ASTFlags.Writeable)):b.isType()?(c.type=b.getType(),c.flags&=~a.ASTFlags.Writeable):(c.type=this.anyType,this.checker.errorReporter.symbolDoesNotReferToAValue(c,b.name))};e.prototype.typeCheckName=function(c){var b=this;if(this.checker.inWith)c.type=this.anyType;else{var d=c.text,e=a.isQuoted(c.text),g=this.scope.find(d,!1,!1);null==g&&e&&(g=this.checker.findSymbolForDynamicModule(d,this.currentScript.locationInfo.filename,
function(a){return b.scope.find(a,!1,!1)}));if(g){this.inNewTargetTypeCheck&&(g.isInferenceSymbol()&&!this.checker.typeStatusIsFinished(g.typeCheckStatus))&&this.checker.errorReporter.simpleError(c,"Symbol '"+c.text+"' is referenced before its declaration");if(a.optimizeModuleCodeGen&&g&&g.isType()&&(d=g.getType())&&g.aliasLink&&g.onlyReferencedAsTypeRef)if((d=d.symbol.declAST)&&a.hasFlag(d.modFlags,a.ModuleFlags.IsDynamic))g.onlyReferencedAsTypeRef=this.inTypeRefTypeCheck;g.declAST&&(g.declAST.nodeType==
a.NodeType.FuncDecl&&!g.declAST.returnTypeAnnotation&&g.declAST.signature.typeCheckStatus==a.TypeCheckStatus.Started)&&(g.declAST.type.symbol.flags|=a.SymbolFlags.RecursivelyReferenced,g.declAST.signature.returnType.type=this.anyType);this.setTypeFromSymbol(c,g);c.sym=g;this.thisFnc&&this.thisFnc.type&&g.container!=this.thisFnc.type.symbol&&(this.thisFnc.freeVariables[this.thisFnc.freeVariables.length]=g)}else c.isMissing()||this.checker.errorReporter.unresolvedSymbol(c,c.text),c.type=this.anyType}return c};
...
"'++' and '--' may only be applied to operands of type 'number' or 'any'")):(this.checker.errorReporter.valueCannotBeModified(b),b.type=this.doubleType);return b};e.prototype.typeCheckBitwiseOperator=function(c,b){var d=null;c.operand1=this.typeCheck(c.operand1);c.operand2=this.typeCheck(c.operand2);var e=c.operand1.type,g=c.operand2.type;b&&!this.astIsWriteable(c)&&this.checker.errorReporter.valueCannotBeModified(c);this.checker.styleSettings.bitwise&&this.checker.errorReporter.styleError(c,"use of "+
a.nodeTypeTable[c.nodeType]);if(this.checker.sourceIsSubtypeOfTarget(e,this.doubleType)&&this.checker.sourceIsSubtypeOfTarget(g,this.doubleType))d=this.doubleType;else if(e==this.booleanType&&g==this.booleanType)d=this.booleanType;else if(e==this.anyType){if(g==this.anyType||g==this.doubleType||g==this.booleanType)d=this.anyType}else if(g==this.anyType&&(e==this.anyType||e==this.doubleType||e==this.booleanType))d=this.anyType;null==d&&(d=this.anyType,this.checker.errorReporter.incompatibleTypes(c,
e,g,c.printLabel(),this.scope));c.type=d;return c};e.prototype.typeCheckArithmeticOperator=function(c,b){c.operand1=this.typeCheck(c.operand1);c.operand2=this.typeCheck(c.operand2);var d=c.operand1.type,e=c.operand2.type;b&&!this.astIsWriteable(c)&&this.checker.errorReporter.valueCannotBeModified(c);this.checker.styleSettings.bitwise&&(c.nodeType==a.NodeType.And||c.nodeType==a.NodeType.Or||c.nodeType==a.NodeType.AsgAnd||c.nodeType==a.NodeType.AsgOr)&&this.checker.errorReporter.styleError(c,"use of "+
a.nodeTypeTable[c.nodeType]);if(null==d||null==e)return this.checker.errorReporter.simpleError(c,"Could not typecheck arithmetic operation.  Possible recursive typecheck error?"),c.type=this.anyType,c;var g=c.nodeType;this.checker.isNullOrUndefinedType(d)&&(d=e);this.checker.isNullOrUndefinedType(e)&&(e=d);d=this.checker.widenType(d);e=this.checker.widenType(e);g==a.NodeType.Add||g==a.NodeType.AsgAdd?d==this.checker.stringType||e==this.checker.stringType?c.type=this.checker.stringType:d==this.checker.numberType&&
...
function(a,b,d,e,g){var h=a.nonOptionalParameterCount,l=a.parameters.length,k=h,n=!1;if(b.length>=h&&(a.hasVariableArgList||b.length<=l))k=a.hasVariableArgList?a.parameters.length:b.length,n=!0;h=null;if(n||a.hasVariableArgList){a.hasVariableArgList&&(k-=1,h=a.parameters[k].parameter.typeLink.type,h=h.elementType,n=b.length>=k);for(var l=b.length,p=n,r=0;r<l;r++){var s;s=r<k?a.parameters[r].parameter.typeLink.type:h;var t=b[r];if(!s||!t||!this.checker.typesAreIdentical(s,t))p=!1;this.checker.sourceIsAssignableToTarget(t,
s,g)||(n=!1);if(!p&&!n)break}p?d[d.length]=a:n&&0==d.length&&(e[e.length]=a)}};e.prototype.resolveOverload=function(b,d){var e=this.resolutionDataCache.getResolutionData(),g=e.actuals,h=e.exactCandidates,l=e.conversionCandidates,k=null,u=1<d.signatures.length,n=new a.TypeComparisonInfo,p=null,r=null;if(b.nodeType==a.NodeType.Call||b.nodeType==a.NodeType.New){if(p=b.args,r=b.target,b.args)for(var s=b.args.members.length,t=0;t<s;t++)g[t]=b.args.members[t].type}else b.nodeType==a.NodeType.Index&&(r=
b.operand1,p=new a.ASTList,p.members[0]=b.operand2,g[0]=b.operand2.type);t=0;for(s=d.signatures.length;t<s;t++){var w=d.signatures[t];if(!u||w!=d.definitionSignature||this.checker.canCallDefinitionSignature)!w.returnType.type&&(w.declAST&&w.typeCheckStatus!=a.TypeCheckStatus.Finished)&&this.typeCheckFunction(w.declAST),this.tryAddCandidates(w,g,h,l,n)}if(0==h.length)h=this.checker.getApplicableSignatures(l,p,n),0<h.length?(p=this.checker.findMostApplicableSignature(h,p),p.ambiguous&&this.checker.errorReporter.simpleError(r,
"Ambiguous call expression - could not choose overload"),k=p.sig):n.message?this.checker.errorReporter.simpleError(r,"Supplied parameters do not match any signature of call target:\n\t"+n.message):this.checker.errorReporter.simpleError(r,"Supplied parameters do not match any signature of call target");else if(1<h.length){k=[];for(t=0;t<h.length;t++)k[t]={signature:h[t],hadProvisionalErrors:!1};p=this.checker.findMostApplicableSignature(k,p);p.ambiguous&&this.checker.errorReporter.simpleError(r,"Ambiguous call expression - could not choose overload");
...
d.getTypeName(h);2<=e.length&&"; "==e.substring(e.length-2)&&(e=e.substring(0,e.length-2));l.add(b.create(e));u++;d.kind()==a.SymbolKind.Type?1<d.type.callCount()&&(k=!0):k=!0}},null);var n,p=0,r=0==u&&1==this.callCount()&&d;r||(l.delim="; ");if(this.call){c=this.call.toStrings(c,r,h);n=0;for(p=c.length;n<p;n++)l.add(b.create(c[n])),e++}if(this.construct){c=this.construct.toStrings("new",r,h);n=0;for(p=c.length;n<p;n++)l.add(b.create(c[n])),e++}if(this.index){c=this.index.toStrings("",r,h);n=0;for(p=
c.length;n<p;n++)l.add(b.create(c[n])),e++}if(k||1<e&&d)l.prefix="{ ",l.suffix="}";this.typeFlags&=~a.TypeFlags.BuildingName;return 0==e&&0==u?b.create("{}"):l}return b.create("{}")};l.prototype.checkDecl=function(a){(this.isClassInstance()||this.isClass())&&this.symbol.declAST&&a.typeFlow.inScopeTypeCheckDecl(this.symbol.declAST)};l.prototype.getMemberScope=function(a){return this==a.anyType?null:this.isDouble()?a.numberInterfaceType?a.numberInterfaceType.memberScope:null:this.isBoolean()?a.booleanInterfaceType?
...
j),l.content=c.readFile(j)}catch(q){j=a.changePathToDSTR(j);a.CompilerDiagnostics.debugPrint("   Reading code from "+j);try{l.content=c.readFile(j)}catch(u){j=a.changePathToDTS(j),a.CompilerDiagnostics.debugPrint("   Reading code from "+j),l.content=c.readFile(j)}}}a.CompilerDiagnostics.debugPrint("   Found code at "+j);l.path=j;this.visited[v]=!0}catch(n){a.CompilerDiagnostics.debugPrint("   Did not find code for "+b)}else l=c.findFile(h,j),l||(a.isSTRFile(j)?j=a.changePathToTS(j):a.isTSFile(j)&&
...
isResident:!1},v.push(i)))));l.tokenId==a.TokenID.LCurly&&c.push(l);l.tokenId==a.TokenID.RCurly&&c.pop();l=e.scan()}c=e.getComments();for(e=0;e<c.length;e++)if(i=c[e],!i.isBlock){var l=i.getText(),q=/^(\/\/\/\s*<reference\s+path=)('|")(.+?)\2\s*(static=('|")(.+?)\2\s*)*\/>/igm.exec(l);if(q){var l=a.normalizePath(q[3]),u=a.normalizePath(l);(q=7<=q.length&&"true"==q[6])&&a.CompilerDiagnostics.debugPrint(l+" is resident");l={minChar:0,limChar:0,path:a.switchToForwardSlashes(u),isResident:q}}else l=null;
...
for(var e=0,g=this.scripts.members.length;e<g;e++){var h=this.scripts.members[e];if(h.emitRequired()){var k=this.outfile;if(b){var q=this.units[e].filename,d=q.split(".");d.pop();var u=d.join(".")+".js";this.emitSettings.path=u;k=c(u);d=new a.Emitter(this.typeChecker,k,this.emitSettings);this.settings.mapSourceFiles&&d.setSourceMappings(new a.SourceMapper(q,u,k,c(u+a.SourceMapper.MapFileExtension)));this.settings.generateDeclarationFiles&&(q=a.isSTRFile(q)?a.changePathToDSTR(q):(a.isTSFile(q),a.changePathToDTS(q)),
d.setDeclarationFile(c(q)))}else null==d?(d=new a.Emitter(this.typeChecker,this.outfile,this.emitSettings),this.settings.mapSourceFiles&&d.setSourceMappings(new a.SourceMapper(h.locationInfo.filename,this.settings.outputFileName,this.outfile,c(this.settings.outputFileName+a.SourceMapper.MapFileExtension))),this.settings.generateDeclarationFiles&&(q=this.settings.outputFileName,q=a.isSTRFile(q)?a.changePathToDSTR(q):(a.isTSFile(q),a.changePathToDTS(q)),d.setDeclarationFile(c(q)))):this.settings.mapSourceFiles&&
...
a.globalId||("_Core"==h||"_element"==h)||d.add(h,"")}e=this.compiler.typeChecker.currentModDecl;this.compiler.typeChecker.currentModDecl=b.deepestModuleDecl;b=this.getTypeNamesForNames(b,d.getAllKeys(),c);this.compiler.typeChecker.currentModDecl=e;return b};d.prototype.getTypeNamesForNames=function(b,c,d){for(var f=[],g=b.getScope(),h=0;h<c.length;h++){var k=c[h],q=b.publicsOnly&&b.isMemberCompletion,u=d.find(k,q,!1);null==u&&(u=d.find(k,q,!0));q=u&&u.flags&a.SymbolFlags.Private?u.container==d.container:
!0;u?q&&(!a.isQuoted(u.name)&&!a.isRelative(u.name))&&(q=u.getType().getScopedTypeName(g),f.push(new e(k,q,u))):("true"==k||"false"==k)&&f.push(new e(k,"bool",this.compiler.typeChecker.booleanType.symbol))}return f};a.ScopeTraversal=d})(TypeScript||(TypeScript={}));
...
b,c)})};a.compileExtern=e})(TSCompiler||(TSCompiler={}));(function(a){function d(a,b){"undefined"==typeof b&&(b=new l);var c=new TypeScript.CompilationSettings;c.generateDeclarationFiles=!0===a.produceDeclarations;c=new TypeScript.TypeScriptCompiler(b.emittedUnits.getDefaultStream(),null,new TypeScript.NullLogger,c);c.parser.errorRecovery=!0;c.setErrorCallback(b.getErrorCallback());for(var d=0;d<a.units.length;d++){var e=a.units[d];c.addUnit(e.data,e.name)}c.typeCheck();c.emit(!0,b.emittedUnits.getEmitCallback());return b.emittedUnits.getDefJS()}function h(a,
b,c){b||(b={units:[]});b.units.push({data:a,name:""});return d(b,c)}function b(a){var b=document.createElement("script");b.setAttribute("type","text/javascript");b.innerHTML=a;document.body.appendChild(b)}function k(a,c,d){"string"==typeof a&&(a=document.getElementById(a));if(!a||!a.tagName||"script"!=a.tagName.toLowerCase())throw Error("Invalid script block.");a=h(a.innerHTML,c,d);b(a)}function g(a,b){var c=!0,d=null;if(document.querySelectorAll){for(var c=!1,d="",e=0,f=a.length;e<f;e++)d+='script[type="'+
a[e]+'"]',e!=f-1&&(d+=",");d=document.querySelectorAll(d)}else d=document.getElementsByTagName("script");e=0;for(f=d.length;e<f;e++){var g=d[e];if(c){for(var h=g.getAttribute("type").toLowerCase(),i=!1,k=0,l=a.length;k<l;k++)if(h==a[k]){i=!0;break}if(!i)continue}b(g)}}function e(a,c,d,e,f){d||(d=function(){});"undefined"==typeof c&&(c=!0);if("undefined"==typeof f||null===f)f=new l;var g=new XMLHttpRequest;g.open("GET",a);g.onreadystatechange=function(){if(4==g.readyState)if(200==g.status){var a=h(g.responseText,
e,f);c&&b(a);d({result:a,compileInfo:f})}else d({error:!0})};g.send(null)}a.API_VERSION=0.1;var l,c=function(){this.errors=[];this.emittedUnits=new f};c.prototype.addError=function(a,b,c,d){this.errors.push({start:a,len:b,msg:c,block:d})};c.prototype.getErrorCallback=function(){var a=this;return function(){a.addError.apply(a,arguments)}};c.prototype.getErrorCount=function(){return this.errors.length};c.prototype.addOutputUnit=function(){};l=c;a.CompileInfo=l;var i=function(){this.data=""};i.prototype.Write=
function(a){this.data+=a};i.prototype.WriteLine=function(a){this.data+=a+"\n"};i.prototype.Close=function(){};var f,c=function(){this.units={};this.units[".js"]=new i};c.prototype.getEmitCallback=function(){var a=this;return function(b){return a.emitCallback.apply(a,[b])}};c.prototype.emitCallback=function(a){"undefined"==typeof this.units[a]&&(this.units[a]=new i);return this.units[a]};c.prototype.getDefaultStream=function(){return this.units[".js"]};c.prototype.getDefJS=function(){return this.units[".js"].data};
c.prototype.getDefDecl=function(){return this.units[".d.ts"]?this.units[".d.ts"].data:""};c.prototype.getUnit=function(a){return this.units[a].data};c.prototype.getAllUnits=function(){return this.units};f=c;a.compile=d;a.compileStr=h;a.runStr=function(a,c,d){a=h(a,c,d);b(a);return a};a.insertScriptBlock=b;a.runScriptBlock=k;a.filterScriptBlocks=g;a.runAllScriptBlocks=function(a,b,c){if("undefined"==typeof a||null===a)a=["text/typescript","application/typescript"];g(a,function(a){a.src?e(a.src):k(a,
b,c)})};a.compileExtern=e})(TSCompiler||(TSCompiler={}));(function(a){var a=a.CacheSystem||(a.CacheSystem={}),d=function(a){var b=0;if(0==a.length)return b;for(var d=0,g=a.length;d<g;d++)var e=a.charCodeAt(d),b=(b<<5)-b+e,b=b&b;return b};a.setCache=function(a,b,k){"undefined"===typeof k&&(k=sessionStorage);a=d(a);k[a]=b};a.getCache=function(a,b){"undefined"===typeof b&&(b=sessionStorage);a=d(a);return"undefined"==typeof b[a]?!1:b[a]}})(TSCompiler||(TSCompiler={}));
(function(a){var d=["text/typescript","application/typescript"];(a.DirectRunSystem||(a.DirectRunSystem={})).run=function(h){"undefined"===typeof h&&(h=!0);a.filterScriptBlocks(d,function(b){var d=b.innerHTML;h?(b=a.CacheSystem.getCache(d),!1!==b?(a.insertScriptBlock(b),console.log("from cache!")):(console.log("not from cache!"),b=a.runStr(d),a.CacheSystem.setCache(d,b))):a.runScriptBlock(b)})}})(TSCompiler||(TSCompiler={}));TSCompiler.DirectRunSystem.run();
